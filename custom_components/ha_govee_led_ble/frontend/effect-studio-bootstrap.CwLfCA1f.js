...
`;var Os=Object.defineProperty,ce=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&Os(e,t,s),s};class te extends D{constructor(){super(...arguments),this.items=[],this.ariaLabel="Items",this.itemRole="button",this.addLabel="Add item",this.addDisabled=!1,this.reorderDisabled=!1,this.pointerX=0,this.pointerY=0,this.pointerMoved=!1,this.suppressClick=!1}render(){const e=this.itemRole==="tab";return o`
  ...
  `]}}ce([h({attribute:!1})],te.prototype,"items");ce([h({attribute:!1})],te.prototype,"activeIndex");ce([h()],te.prototype,"ariaLabel");ce([h()],te.prototype,"itemRole");ce([h()],te.prototype,"addLabel");ce([h({type:Boolean})],te.prototype,"addDisabled");ce([h({type:Boolean})],te.prototype,"reorderDisabled");customElements.get("govee-reorderable-strip")||customElements.define("govee-reorderable-strip",te);var Fs=Object.defineProperty,nt=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&Fs(e,t,s),s};class Oe extends D{constructor(){super(...arguments),this.label="",this.options=[],this.value="",this.disabled=!1}render(){return o`
    ...
    `}select(e){this.disabled||e===this.value||this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}static{this.styles=[N,ee,E`
      :host {
        display: block;
      }
    `]}}nt([h()],Oe.prototype,"label");nt([h({attribute:!1})],Oe.prototype,"options");nt([h({attribute:!1})],Oe.prototype,"value");nt([h({type:Boolean})],Oe.prototype,"disabled");customElements.get("govee-segmented-control")||customElements.define("govee-segmented-control",Oe);var Us=Object.defineProperty,ue=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&Us(e,t,s),s};class ie extends D{constructor(){super(...arguments),this.label="",this.value=0,this.minimum=0,this.maximum=100,this.step=1,this.disabled=!1,this.showValue=!1}render(){const e=Hs(this.value,this.minimum,this.maximum);return o`
    ...
    `}inputChanged(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:Number(e.target.value)},bubbles:!0,composed:!0}))}static{this.styles=[N,ee,E`
      :host {
        display: block;
      }
    ...
    `}get activeLayer(){return this.content.layers[this.activeLayerIndex]}renderAppliedArea(e){const t=e.area.start_tenths>=0&&e.area.start_tenths<=9&&e.area.width_tenths>=1&&e.area.width_tenths<=10-e.area.start_tenths,i=B(e.area.start_tenths,0,9),s=i+e.area.width_tenths,r=Number.isInteger(this.segmentCount)&&this.segmentCount>0?this.segmentCount:di,a=k(e.palette[0]??[47,111,237]);return o`
    ...
    `}renderBrightness(e){if(e.brightness_patterns.length===0)return o`
      ...
      `;const t=B(this.activePatternIndex,0,e.brightness_patterns.length-1),i=e.brightness_patterns[t],s=Gs(i.order);return o`
      <section class="card wide-card">
    ...
    `}updateLayer(e){if(!this.content||this.disabled)return;const t=this.content.layers.map((i,s)=>s===this.activeLayerIndex?W({...i,...e}):W(i));this.emitContent({kind:"advanced",layers:t})}updateSelection(e){this.updateLayer({selection:{...this.activeLayer.selection,...e}})}updateBrightnessPattern(e){const t=this.activeLayer.brightness_patterns.map((i,s)=>s===this.activePatternIndex?{...i,...e}:{...i});this.updateLayer({brightness_patterns:t})}updateMovement(e,t,i){this.updateLayer({[e]:{...this.activeLayer[e],...t}}),i&&(this.movementAnnouncement=i)}addLayer(){if(!this.content||this.disabled||this.content.layers.length>=me)return;const e=[...this.content.layers.map(W),qi()];this.installContent({kind:"advanced",layers:e}),this.activeLayerIndex=e.length-1,this.activePatternIndex=0,this.layerActionsIndex=void 0,this.focusActiveTab()}copyLayer(){if(!this.content||this.disabled||this.content.layers.length>=me)return;const e=this.content.layers.map(W);e.splice(this.activeLayerIndex+1,0,W(this.activeLayer)),this.installContent({kind:"advanced",layers:e}),this.activeLayerIndex+=1,this.activePatternIndex=0,this.layerActionsIndex=this.activeLayerIndex,this.focusActiveTab()}deleteLayer(){if(!this.content||this.disabled||this.content.layers.length===1)return;const e=this.content.layers.filter((t,i)=>i!==this.activeLayerIndex).map(W);this.activeLayerIndex=Math.min(this.activeLayerIndex,e.length-1),this.activePatternIndex=0,this.layerActionsIndex=void 0,this.emitContent({kind:"advanced",layers:e}),this.focusActiveTab()}reorderLayer(e,t){if(!this.content||this.disabled||e<0||e>=this.content.layers.length||t<0||t>=this.content.layers.length||e===t)return;const i=this.content.layers.map(W),[s]=i.splice(e,1);i.splice(t,0,s),this.activeLayerIndex=Qe(this.activeLayerIndex,e,t),this.layerActionsIndex!==void 0&&(this.layerActionsIndex=Qe(this.layerActionsIndex,e,t)),this.emitContent({kind:"advanced",layers:i})}addBrightnessPattern(){if(this.disabled||this.activeLayer.brightness_patterns.length>=3)return;const e=[...this.activeLayer.brightness_patterns.map(t=>({...t})),Vi()];this.activePatternIndex=e.length-1,this.updateLayer({brightness_patterns:e})}deleteBrightnessPattern(){if(this.disabled||this.activeLayer.brightness_patterns.length===1)return;const e=this.activeLayer.brightness_patterns.filter((t,i)=>i!==this.activePatternIndex).map(t=>({...t}));this.activePatternIndex=Math.min(this.activePatternIndex,e.length-1),this.updateLayer({brightness_patterns:e})}selectLayer(e){if(e===this.activeLayerIndex){this.layerActionsIndex=this.layerActionsIndex===e?void 0:e;return}this.activeLayerIndex=e,this.activePatternIndex=0,this.layerActionsIndex=e}patternTabKeyPressed(e,t){const i=this.activeLayer.brightness_patterns.length;let s;t.key==="ArrowLeft"?s=e===0?i-1:e-1:t.key==="ArrowRight"?s=e===i-1?0:e+1:t.key==="Home"?s=0:t.key==="End"&&(s=i-1),s!==void 0&&(t.preventDefault(),this.activePatternIndex=s,this.updateComplete.then(()=>{this.shadowRoot?.querySelectorAll(".pattern-tabs button")[s]?.focus()}))}focusActiveTab(){this.updateComplete.then(()=>{this.shadowRoot?.querySelector("govee-reorderable-strip")?.focusItem(this.activeLayerIndex)})}excessChanged(e){const t=e.value.replace(/\s+/g,"").toLowerCase();if(!/^(?:[0-9a-f]{2})*$/.test(t)){e.setCustomValidity("Enter an even number of hexadecimal digits."),e.reportValidity();return}e.setCustomValidity(""),this.updateLayer({excess:t})}emitContent(e){this.dispatchEvent(new CustomEvent("content-changed",{detail:{content:e},bubbles:!0,composed:!0}))}installContent(e){this.content=e,this.emitContent(e)}static{this.styles=[N,de,Ft,ee,Ut,E`
    :host {
      display: block;
  ...
  `]}}pe([h({attribute:!1})],se.prototype,"content");pe([h({type:Boolean})],se.prototype,"disabled");pe([h({type:Number})],se.prototype,"segmentCount");pe([g()],se.prototype,"activeLayerIndex");pe([g()],se.prototype,"activePatternIndex");pe([g()],se.prototype,"movementAnnouncement");pe([g()],se.prototype,"layerActionsIndex");function ct(){return{kind:"advanced",layers:[qi()]}}function _e(n){return{kind:"advanced",layers:n.layers.map(W)}}function $e(n){return{...n,template:{...n.template},effect:{layers:_e({layers:n.effect.layers}).layers}}}function qi(){return{area:{start_tenths:0,width_tenths:10},selection:{type:0,param_1:0,param_2:1},brightness_gradient:!1,brightness_patterns:[Vi()],distribution:{method:1,backwards:!1},colour_speed:128,colour_retention:20,palette:[[255,0,0],[0,0,255]],selected_movement:ui(),overall_movement:ui(),priority:0,unknown_flags:0,excess:""}}function Vi(){return{scope_high:255,scope_low:0,order:0,change_speed:128,brightest_retention:20,darkest_retention:20}}function ui(){return{enabled:!1,enter_exit:!1,direction:0,distance:1,speed:128,unknown_flags:0}}function W(n){return{...n,area:{...n.area},selection:{...n.selection},brightness_patterns:n.brightness_patterns.map(e=>({...e})),distribution:{...n.distribution},palette:n.palette.map(e=>[...e]),selected_movement:{...n.selected_movement},overall_movement:{...n.overall_movement}}}function js(n){return Ui.includes(n)}function Gs(n){return Hi.includes(n)}function zs(n){return Math.round(B(n,0,255)/255*100)}function Ve(n){return n.toString(16).padStart(2,"0").toUpperCase()}function Ys(n){const e=n.trim().replace(/^0x/i,"");if(/^[0-9a-f]{1,2}$/i.test(e))return Number.parseInt(e,16)}function Ws(n,e,t,i){const s=n*10/e;return(n+1)*10/e>t&&s<i}function pi(n,e,t,i){if(n==="Home")return t;if(n==="End")return i;if(n==="ArrowLeft"||n==="ArrowDown")return B(e-1,t,i);if(n==="ArrowRight"||n==="ArrowUp")return B(e+1,t,i)}function B(n,e,t){return Math.min(t,Math.max(e,Math.round(n)))}customElements.get("govee-advanced-effect-editor")||customElements.define("govee-advanced-effect-editor",se);const Xs=["compiling","pending","uploading","activating","verifying","confirmed","applied","uncertain","recovering","failed","interrupted","unknown"],ut=["compiling","pending","uploading","activating","verifying","recovering"],Js=2,Ki=1,Zs=2,hi=4,L=128,Ce=65536,ji=512,Gi=256,zi=32,Yi=128,Wi=512,y=255,Qs=64,Xi=262144,mi=16,en=4096,Ji=16384,O=1024,pt=16384,Ht=Number.MAX_SAFE_INTEGER,wt=4335,tn=232,sn=253,oe=["H617A","H6199"],ht="H617A",Zi=["movie","game"],fi=["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","video","palette_diy","advanced","workshop","special_diy"],nn=["studio","home_assistant","planned"],rn=["exact_session","activation_match","settings_match","mode_match","write_completed","unknown"],an={H617A:["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","advanced","workshop","special_diy"],H6199:["native_scenes","edited_palette_scenes","layered_scenes","palette_diy","native_music","video","advanced","workshop","special_diy"]};function on(n){const e=m(n,"editor info"),t=m(e.limits,"editor limits");return{api_version:u(e.api_version,"API version",1),effect_schema_version:u(e.effect_schema_version,"effect schema version",1),compiler_version:u(e.compiler_version,"compiler version",1),limits:{effect_name:K(t.effect_name,L,"effect-name limit"),effect_document_bytes:K(t.effect_document_bytes,Ce,"effect-document limit"),devices:K(t.devices,ji,"device limit"),library_items:K(t.library_items,Gi,"library-item limit"),drafts_per_owner:K(t.drafts_per_owner,zi,"draft limit"),deployment_records:K(t.deployment_records,Yi,"deployment limit"),scene_catalogue_entries:K(t.scene_catalogue_entries,Wi,"scene catalogue limit")}}}function ln(n){const e=w(n,"devices",ji).map((t,i)=>{const s=m(t,`devices[${i}]`),r=m(s.custom_effects,`devices[${i}].custom_effects`),a=m(s.profiles,`devices[${i}].profiles`);return{config_entry_id:f(s.config_entry_id,`devices[${i}].config_entry_id`,y),model:f(s.model,`devices[${i}].model`,y),display_name:f(s.display_name,`devices[${i}].display_name`,y),segment_count:u(s.segment_count,`devices[${i}].segment_count`,0,65535),custom_effects:{painted:C(r.painted,"painted capability"),single:C(r.single,"single capability"),multi:C(r.multi,"multi capability"),palette_diy:C(r.palette_diy,"palette DIY capability"),advanced:C(r.advanced,"advanced capability"),workshop:C(r.workshop,"Workshop capability"),special_diy:C(r.special_diy,"Special DIY capability")},profiles:{music:C(a.music,"music profile capability"),video:C(a.video,"video profile capability")},readback:f(s.readback,`devices[${i}].readback`,y)}});return U(e,t=>t.config_entry_id,"device IDs"),e}function dn(n){he(n,"custom-effect catalogue",Xi,Ji);const e=m(n,"custom-effect catalogue"),t=cn(e.models),i=Et(e,"custom-effect catalogue",ht);if(JSON.stringify(i)!==JSON.stringify(t[ht]))throw new Error("Malformed Effect Studio server payload: legacy custom-effect catalogue view does not match models.H617A.");return K(e.schema_version,hi,"catalogue schema"),{...i,schema_version:hi,sku:ht,models:t}}function cn(n){const e=m(n,"custom-effect catalogue models"),i=Object.keys(e).filter(s=>!oe.includes(s));if(i.length>0)throw new Error(`Malformed Effect Studio server payload: unexpected catalogue models ${i.join(", ")}.`);for(const s of oe)if(!(s in e))throw new Error(`Malformed Effect Studio server payload: missing catalogue model ${s}.`);return{H617A:Et(e.H617A,"catalogue model H617A","H617A"),H6199:Et(e.H6199,"catalogue model H6199","H6199")}}function Et(n,e,t){const i=m(n,e),s=m(i.limits,`${e} limits`),r=m(i.supports,`${e} support capabilities`),a=m(i.apply,`${e} Apply capabilities`),l=P(i.sku,oe,`${e} SKU`);if(l!==t)throw new Error(`Malformed Effect Studio server payload: ${e} is keyed as ${t} but declares ${l}.`);const c=u(s.music_sensitivity_min,`${e} minimum music sensitivity`,0,100),p=u(s.music_sensitivity_max,`${e} maximum music sensitivity`,0,100);return c>p&&v(`${e} music sensitivity limits are inverted`),{sku:l,painted_effects:pn(i.painted_effects,`${e} painted-effect templates`),effects:hn(i.effects,`${e} custom-effect templates`),music_modes:gi(i.music_modes,`${e} music modes`),video_modes:gi(i.video_modes,`${e} video modes`,Zi),workshop_templates:mn(i.workshop_templates,`${e} Workshop templates`,t),special_diy_templates:fn(i.special_diy_templates,`${e} Special DIY templates`,t),workflows:un(i.workflows,`${e} release workflows`,t),supports:{multi:C(r.multi,`${e} Multi support`),advanced:C(r.advanced,`${e} advanced support`),workshop:C(r.workshop,`${e} Workshop support`),special_diy:C(r.special_diy,`${e} Special DIY support`)},limits:{palette_min:u(s.palette_min,`${e} minimum palette`,1,255),palette_max:u(s.palette_max,`${e} maximum palette`,1,255),multi_max:u(s.multi_max,`${e} maximum Multi effects`,1,255),music_sensitivity_min:c,music_sensitivity_max:p},apply:{painted:C(a.painted,`${e} Painted Apply capability`),single:C(a.single,`${e} Single Apply capability`),multi:C(a.multi,`${e} Multi Apply capability`),palette_diy:C(a.palette_diy,`${e} palette DIY Apply capability`),workshop:C(a.workshop,`${e} Workshop Apply capability`),special_diy:C(a.special_diy,`${e} Special DIY Apply capability`)}}}function un(n,e,t){const i=w(n,e,fi.length).map((c,p)=>{const b=m(c,`${e}[${p}]`);return{id:P(b.id,fi,`${e}[${p}] ID`),label:f(b.label,`${e}[${p}] label`,L),content_kind:f(b.content_kind,`${e}[${p}] content kind`,y),application:P(b.application,nn,`${e}[${p}] application`)}});U(i,c=>c.id,`${e} IDs`);const s=an[t],r=new Set(i.map(c=>c.id)),a=s.filter(c=>!r.has(c)),l=i.map(c=>c.id).filter(c=>!s.includes(c));if(a.length>0||l.length>0)throw new Error(`Malformed Effect Studio server payload: ${e} does not match ${t}.`);return i}function pn(n,e){const t=w(n,e,O).map((i,s)=>{const r=m(i,`${e}[${s}]`);return{id:P(r.id,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],`${e} ID`),label:f(r.label,`${e} label`,L)}});return U(t,i=>i.id,`${e} IDs`),t}function hn(n,e){const t=w(n,e,O).map((i,s)=>{const r=m(i,`${e}[${s}]`),a=w(r.variations,`${e}[${s}].variations`,O);if(a.length===0)throw new Error("Malformed Effect Studio server payload: custom-effect template has no variations.");const l={id:f(r.id,`${e}[${s}] ID`,y),label:f(r.label,`${e}[${s}] label`,L),family:u(r.family,`${e}[${s}] family`,0,255),variations:a.map((c,p)=>{const b=m(c,`${e}[${s}].variations[${p}]`);return{id:f(b.id,`${e}[${s}].variations[${p}] ID`,y),label:f(b.label,`${e}[${s}].variations[${p}] label`,L),variant:u(b.variant,`${e}[${s}].variations[${p}] variant`,0,255)}}),supports_multi:F(r.supports_multi,`${e}[${s}] Multi support`),rate:P(r.rate,["speed","sensitivity"],`${e}[${s}] rate parameter`)};return U(l.variations,c=>c.id,`${e}[${s}] variation IDs`),l});return U(t,i=>i.id,`${e} IDs`),t}function gi(n,e,t){const i=w(n,e,O).map((s,r)=>{const a=m(s,`${e}[${r}]`);return{id:t?P(a.id,t,`${e}[${r}] ID`):f(a.id,`${e}[${r}] ID`,y),label:f(a.label,`${e}[${r}] label`,L)}});return U(i,s=>s.id,`${e} IDs`),i}function mn(n,e,t){const i=w(n,e,O).map((s,r)=>{const a=m(s,`${e}[${r}]`),l=rt(a.content);return(l.kind!=="workshop"||l.model!==t)&&v(`${e}[${r}] content does not target ${t}`),{id:f(a.id,`${e}[${r}] ID`,y),label:f(a.label,`${e}[${r}] label`,L),source_fixture:f(a.source_fixture,`${e}[${r}] source fixture`,y),content:l}});return U(i,s=>s.id,`${e} IDs`),i}function fn(n,e,t){const i=w(n,e,O).map((s,r)=>{const a=m(s,`${e}[${r}]`),l=rt(a.content);return(l.kind!=="special_diy"||l.model!==t)&&v(`${e}[${r}] content does not target ${t}`),{id:f(a.id,`${e}[${r}] ID`,y),label:f(a.label,`${e}[${r}] label`,L),source_fixture:f(a.source_fixture,`${e}[${r}] source fixture`,y),content:l}});return U(i,s=>s.id,`${e} IDs`),i}function bi(n){const e=m(n,"library snapshot"),t={library_revision:Q(e.library_revision,"library revision",0),items:w(e.items,"library items",Gi).map((i,s)=>{const r=m(i,`library items[${s}]`),a=r.template===void 0?void 0:et(r.template,`library items[${s}].template`),l=r.model===void 0?void 0:Cn(r.model);return{id:f(r.id,"library item ID",y),revision:Q(r.revision,"library item revision",1),name:f(r.name,"library item name",L),kind:f(r.kind,"library item kind",y),...l?{model:l}:{},...a?{template:a}:{}}})};return U(t.items,i=>i.id,"library item IDs"),t}function Ye(n){he(n,"library item",Ce);const e=m(n,"library item"),t=e.target_hint===void 0?void 0:m(e.target_hint,"target hint");return{schema_version:K(e.schema_version,Ki,"effect schema version"),id:f(e.id,"effect ID",y),revision:Q(e.revision,"effect revision",1),name:f(e.name,"effect name",L),content:rt(e.content),provenance:St(e.provenance,"effect provenance"),extensions:St(e.extensions,"effect extensions"),...t?{target_hint:{model:t.model===null?null:f(t.model,"target model",y),segment_count:t.segment_count===null?null:u(t.segment_count,"target segment count",1,65535)}}:{}}}function gn(n){const e=w(n,"draft summaries",zi).map((t,i)=>{const s=m(t,`draft summaries[${i}]`);return{id:f(s.id,"draft ID",y),revision:Q(s.revision,"draft revision",1),name:f(s.name,"draft name",L),updated_at:Vt(s.updated_at,"draft timestamp"),selected_config_entry_id:xe(s.selected_config_entry_id,"draft config entry ID")}});return U(e,t=>t.id,"draft IDs"),e}function mt(n){const e=m(n,"effect draft");return{id:f(e.id,"draft ID",y),owner_id:f(e.owner_id,"draft owner",y),revision:Q(e.revision,"draft revision",1),item:Ye(e.item),updated_at:Vt(e.updated_at,"draft timestamp"),selected_config_entry_id:xe(e.selected_config_entry_id,"draft config entry ID"),base_item_id:xe(e.base_item_id,"draft base item ID"),base_item_revision:e.base_item_revision===null?null:Q(e.base_item_revision,"draft base item revision",1)}}function Ct(n){const e=m(n,"deployment"),t=P(e.phase,Xs,"deployment phase"),i={operation_id:f(e.operation_id,"deployment operation ID",y),config_entry_id:f(e.config_entry_id,"deployment config entry ID",y),diy_code:e.diy_code===null?null:u(e.diy_code,"deployment DIY code",0,65535),content_kind:f(e.content_kind,"deployment content kind",y),target_mode:P(e.target_mode,["custom","scene","music","video"],"deployment target mode"),target_effect:xe(e.target_effect,"deployment target effect"),phase:t,updated_at:Vt(e.updated_at,"deployment timestamp"),item_id:xe(e.item_id,"deployment item ID"),item_revision:e.item_revision===null?null:Q(e.item_revision,"deployment item revision",1),error_code:xe(e.error_code,"deployment error code"),progress_current:u(e.progress_current,"deployment progress",0,1024),progress_total:u(e.progress_total,"deployment progress total",0,1024),verification_confidence:P(e.verification_confidence,rn,"deployment verification confidence")};return i.progress_current>i.progress_total&&v("deployment progress exceeds its total"),i}function bn(n){const e=m(n,"deployment snapshot"),t={revision:Q(e.revision,"deployment revision",0),deployments:w(e.deployments,"deployments",Yi).map(Ct)};return U(t.deployments,i=>i.operation_id,"deployment operation IDs"),t}function vn(n){he(n,"scene catalogue",Xi,Ji);const e=m(n,"scene catalogue");return{schema_version:u(e.schema_version,"scene catalogue schema",1),sku:f(e.sku,"scene catalogue SKU",y),enabled:F(e.enabled,"scene catalogue enabled"),categories:w(e.categories,"scene categories",O).map((t,i)=>{const s=m(t,`scene categories[${i}]`);return{id:u(s.id,"scene category ID",0,65535),name:f(s.name,"scene category name",L)}}),scenes:w(e.scenes,"scenes",Wi).map(qt)}}function yn(n){const e=m(n,"scene detail");he({scene:e.scene,content:e.content},"scene detail",Ce);const t=rt(e.content);return t.kind!=="scene_builtin"&&t.kind!=="scene_palette"&&t.kind!=="scene_layered"&&v("scene detail content is unsupported"),{scene:qt(e.scene),content:t}}function rt(n){he(n,"effect content",Ce);const e=m(n,"effect content"),t=f(e.kind,"effect content kind",y);switch(t){case"h617a_painted":return{kind:t,effect:P(e.effect,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],"painted effect"),speed:u(e.speed,"painted speed",0,100),brightness:u(e.brightness,"painted brightness",0,100),background:Ee(e.background,"painted background"),groups:w(e.groups,"paint groups",15).map((i,s)=>{const r=m(i,`paint groups[${s}]`);return{fill:Ee(r.fill,"paint-group fill"),segments:w(r.segments,"painted segments",15).map(a=>u(a,"painted segment",0,14))}})};case"h617a_single":return{kind:t,family:u(e.family,"Single family",0,254),variant:u(e.variant,"Single variant",0,255),speed:u(e.speed,"Single speed",0,100),palette:ye(e.palette,"Single palette",8)};case"h617a_multi":return{kind:t,effects:w(e.effects,"Multi effects",4).map((i,s)=>{const r=m(i,`Multi effects[${s}]`);return{family:u(r.family,"Multi family",0,254),variant:u(r.variant,"Multi variant",0,255)}}),speed:u(e.speed,"Multi speed",0,100),palette:ye(e.palette,"Multi palette",8)};case"palette_diy":return{kind:t,model:P(e.model,oe,"palette DIY model"),family:u(e.family,"palette DIY family",0,255),variant:u(e.variant,"palette DIY variant",0,255),speed:u(e.speed,"palette DIY speed",0,100),palette:ye(e.palette,"palette DIY palette",8)};case"music_profile":return{kind:t,model:P(e.model,oe,"music profile model"),mode:f(e.mode,"music profile mode",y),sensitivity:u(e.sensitivity,"music profile sensitivity",0,100),colour:xn(e.colour,"music profile colour"),calm:kn(e.calm,"music profile calm"),parameters:St(e.parameters,"music profile parameters")};case"video_profile":return{kind:t,model:P(e.model,["H6199"],"video profile model"),mode:P(e.mode,Zi,"video profile mode"),full_screen:F(e.full_screen,"video profile full-screen flag"),saturation:u(e.saturation,"video profile saturation",0,100),sound_effects:F(e.sound_effects,"video profile sound-effects flag"),sound_effects_softness:u(e.sound_effects_softness,"video profile sound-effects softness",1,100),white_balance_position:u(e.white_balance_position,"video profile white-balance position",1,20),relative_brightness:wn(e.relative_brightness,"video profile relative brightness"),blank_screen:F(e.blank_screen,"video profile blank-screen flag")};case"advanced":return{kind:t,layers:ft(e.layers,"Advanced layers")};case"workshop":{const i=m(e.effect,"Workshop effect");return{kind:t,model:P(e.model,oe,"Workshop model"),template:f(e.template,"Workshop template",y),effect:{layers:ft(i.layers,"Workshop layers")},raw_param:We(e.raw_param,"Workshop source parameter"),trailing_padding:u(e.trailing_padding,"Workshop trailing padding",0,wt)}}case"special_diy":return{kind:t,model:P(e.model,["H6199"],"Special DIY model"),template:f(e.template,"Special DIY template",y),family:u(e.family,"Special DIY family",0,255),variant:u(e.variant,"Special DIY variant",0,255),speed:u(e.speed,"Special DIY speed",0,100),palette:ye(e.palette,"Special DIY palette",8),raw_payload:We(e.raw_payload,"Special DIY source payload"),trailing_padding:u(e.trailing_padding,"Special DIY trailing padding",0,wt)};case"scene_builtin":return{kind:t,template:et(e.template,"scene template"),speed_index:At(e.speed_index,"scene speed index",0,255)};case"scene_palette":return _n(e);case"scene_layered":{const i=m(e.effect,"layered scene effect"),s=Qi(e.trailing_padding,"layered scene trailing padding");return{kind:t,template:et(e.template,"layered scene template"),effect:{layers:ft(i.layers,"layered scene layers")},speed_index:At(e.speed_index,"layered scene speed index",0,255),raw_param:We(e.raw_param,"layered scene raw parameter"),...s===void 0?{}:{trailing_padding:s}}}default:{const{kind:i,...s}=e;return{kind:"opaque",source_kind:t,body:s}}}}function Qi(n,e){if(n!==void 0)return u(n,e,0,wt)}function _n(n){const t=u(n.layout,"palette scene layout",0,1)===0?0:1,i=w(n.steps,"palette scene steps",255).map((l,c)=>{const p=m(l,`palette scene steps[${c}]`),b=t===0?(p.inline_colour!==null&&v(`palette scene steps[${c}].inline_colour must be null for layout 0`),null):Ee(p.inline_colour,`palette scene steps[${c}].inline_colour`);return{value:u(p.value,`palette scene steps[${c}].value`,0,65535),colour:Ee(p.colour,`palette scene steps[${c}].colour`),inline_colour:b}}),s=ye(n.palette,"palette scene shared palette",255,!0);t===1&&s.length!==0&&v("palette scene layout 1 must not have a shared palette");let r;n.config_flags!==void 0&&(r=u(n.config_flags,"palette scene config flags",0,255),r&-9&&v("palette scene config flags must only set reserved config bits"));const a=Qi(n.trailing_padding,"palette scene trailing padding");return{kind:"scene_palette",template:et(n.template,"palette scene template"),layout:t,brightness_flag:F(n.brightness_flag,"palette scene brightness flag"),steps:i,palette:s,speed_index:At(n.speed_index,"palette scene speed index",0,255),...r===void 0?{}:{config_flags:r},...a===void 0?{}:{trailing_padding:a}}}function Ae(n){return n.kind!=="opaque"?n:(he(n.body,"opaque content",Ce),{...n.body,kind:f(n.source_kind,"opaque source kind",y)})}function qt(n){const e=m(n,"scene"),t=Fe(e.parameter_kind,"scene parameter kind");t!=="none"&&t!=="palette"&&t!=="layers"&&t!=="opaque"&&v("scene parameter kind is invalid");const i=e.speed===null?null:(()=>{const s=m(e.speed,"scene speed");return{option_count:u(s.option_count,"scene speed option count",1,256),default_index:u(s.default_index,"scene default speed",0,255)}})();return{scene_id:u(e.scene_id,"scene ID",0,65535),effect_id:u(e.effect_id,"scene effect ID",0,65535),category_id:u(e.category_id,"scene category ID",0,65535),category:f(e.category,"scene category",L),name:f(e.name,"scene name",L),variant:En(e.variant,"scene variant",y),display_name:f(e.display_name,"scene display name",L),scene_type:u(e.scene_type,"scene type",0,255),parameter_kind:t,speed:i}}function ft(n,e){return w(n,e,255).map((t,i)=>$n(t,`${e}[${i}]`))}function $n(n,e){const t=m(n,e),i=m(t.area,`${e}.area`),s=m(t.selection,`${e}.selection`),r=m(t.distribution,`${e}.distribution`);return{area:{start_tenths:u(i.start_tenths,`${e}.area.start_tenths`,0,15),width_tenths:u(i.width_tenths,`${e}.area.width_tenths`,0,15)},selection:{type:T(s.type,`${e}.selection.type`),param_1:T(s.param_1,`${e}.selection.param_1`),param_2:T(s.param_2,`${e}.selection.param_2`)},brightness_gradient:F(t.brightness_gradient,`${e}.brightness_gradient`),brightness_patterns:w(t.brightness_patterns,`${e}.brightness_patterns`,255).map((a,l)=>{const c=m(a,`${e}.brightness_patterns[${l}]`);return{scope_high:T(c.scope_high,"brightness scope high"),scope_low:T(c.scope_low,"brightness scope low"),order:T(c.order,"brightness order"),change_speed:T(c.change_speed,"brightness change speed"),brightest_retention:T(c.brightest_retention,"brightest retention"),darkest_retention:T(c.darkest_retention,"darkest retention")}}),distribution:{method:u(r.method,`${e}.distribution.method`,0,127),backwards:F(r.backwards,`${e}.distribution.backwards`)},colour_speed:T(t.colour_speed,`${e}.colour_speed`),colour_retention:T(t.colour_retention,`${e}.colour_retention`),palette:ye(t.palette,`${e}.palette`,255,!0),selected_movement:vi(t.selected_movement,`${e}.selected_movement`),overall_movement:vi(t.overall_movement,`${e}.overall_movement`),priority:T(t.priority,`${e}.priority`),unknown_flags:es(t.unknown_flags,sn,`${e}.unknown_flags`),excess:We(t.excess,`${e}.excess`)}}function vi(n,e){const t=m(n,e);return{enabled:F(t.enabled,`${e}.enabled`),enter_exit:F(t.enter_exit,`${e}.enter_exit`),direction:u(t.direction,`${e}.direction`,0,3),distance:T(t.distance,`${e}.distance`),speed:T(t.speed,`${e}.speed`),unknown_flags:es(t.unknown_flags,tn,`${e}.unknown_flags`)}}function et(n,e){const t=m(n,e);return{sku:f(t.sku,`${e}.sku`,y),scene_id:u(t.scene_id,`${e}.scene_id`,0,65535),effect_id:u(t.effect_id,`${e}.effect_id`,0,65535),catalogue_schema_version:u(t.catalogue_schema_version,`${e}.catalogue_schema_version`,1,Ht)}}function ye(n,e,t,i=!1){const s=w(n,e,t);return!i&&s.length===0&&v(`${e} must not be empty`),s.map((r,a)=>Ee(r,`${e}[${a}]`))}function Ee(n,e){const t=w(n,e,3);return t.length!==3&&v(`${e} must contain three channels`),t.map(i=>u(i,`${e} channel`,0,255))}function xn(n,e){return n===null?null:Ee(n,e)}function kn(n,e){return n===null?null:F(n,e)}function wn(n,e){const t=m(n,e);return{left:u(t.left,`${e}.left`,1,100),top:u(t.top,`${e}.top`,1,100),right:u(t.right,`${e}.right`,1,100),bottom:u(t.bottom,`${e}.bottom`,1,100)}}function C(n,e){return n!=="supported"&&n!=="unsupported"&&n!=="evidence_gap"&&v(`${e} is invalid`),n}function St(n,e){return he(n,e,Ce),m(n,e)}function xe(n,e){return n===null?null:f(n,e,y)}function Vt(n,e){const t=f(n,e,Qs);return(!/T.*(?:Z|[+-]\d{2}:\d{2})$/.test(t)||Number.isNaN(Date.parse(t)))&&v(`${e} must be an ISO 8601 timestamp with a UTC offset`),t}function f(n,e,t){const i=Fe(n,e);return(i.length===0||i.length>t)&&v(`${e} must contain 1 to ${t} characters`),i}function En(n,e,t){const i=Fe(n,e);return i.length>t&&v(`${e} must not exceed ${t} characters`),i}function We(n,e){const t=Fe(n,e);return(t.length%2!==0||!/^[0-9a-f]*$/i.test(t))&&v(`${e} must be hexadecimal`),t}function Fe(n,e){return typeof n!="string"&&v(`${e} must be a string`),n}function Cn(n){return typeof n=="string"&&oe.includes(n)?n:void 0}function F(n,e){return typeof n!="boolean"&&v(`${e} must be a boolean`),n}function u(n,e,t,i=Ht){return(typeof n!="number"||!Number.isSafeInteger(n)||n<t||n>i)&&v(`${e} must be an integer from ${t} to ${i}`),n}function Q(n,e,t){return u(n,e,t,Ht)}function K(n,e,t){const i=u(n,t,1);return i!==e&&v(`${t} is incompatible with this editor`),i}function At(n,e,t,i){return n===null?null:u(n,e,t,i)}function T(n,e){return u(n,e,0,255)}function es(n,e,t){const i=T(n,t);return i&~e&&v(`${t} must only set reserved bits, not bits explicit fields carry`),i}function P(n,e,t){const i=Fe(n,t);return e.includes(i)||v(`${t} is invalid`),i}function m(n,e){return(typeof n!="object"||n===null||Array.isArray(n))&&v(`${e} must be an object`),n}function w(n,e,t){return Array.isArray(n)||v(`${e} must be an array`),n.length>t&&v(`${e} must not exceed ${t} items`),n}function U(n,e,t){const i=n.map(e);new Set(i).size!==i.length&&v(`${t} must be unique`)}function he(n,e,t,i=en){let s=0;const r=(l,c,p)=>{if(s+=1,s>i&&v(`${e} must not exceed ${i} JSON values`),p>mi&&v(`${e} must not exceed ${mi} nested levels`),!(l===null||typeof l=="boolean")){if(typeof l=="number"){(!Number.isFinite(l)||Number.isInteger(l)&&!Number.isSafeInteger(l))&&v(`${c} must be a finite JSON number`);return}if(typeof l=="string"){l.length>pt&&v(`${c} must not exceed ${pt} characters`);return}if(Array.isArray(l)){l.length>O&&v(`${c} must not exceed ${O} items`),l.forEach((b,_)=>r(b,`${c}[${_}]`,p+1));return}if(typeof l=="object"&&l!==null){const b=Object.entries(l);b.length>O&&v(`${c} must not exceed ${O} fields`),b.forEach(([_,R])=>{_.length>pt&&v(`${c} contains an oversized key`),r(R,`${c}.${_}`,p+1)});return}v(`${c} contains a non-JSON value`)}};r(n,e,0);const a=JSON.stringify(n);a===void 0&&v(`${e} must contain JSON values`),new TextEncoder().encode(a).byteLength>t&&v(`${e} must not exceed ${t} bytes`)}function v(n){throw new Error(`Malformed Effect Studio server payload: ${n}.`)}function Sn(n){return n.api_version===Js&&n.effect_schema_version===Ki&&n.compiler_version===Zs}const gt="ha_govee_led_ble/editor";class An{constructor(e){this.hass=e}async info(){return on(await this.call("info"))}async devices(){const e=await this.call("devices");return ln(I(e,"devices"))}async customCatalogue(){const e=await this.call("custom/catalogue");return dn(I(e,"catalogue"))}async library(){return bi(await this.call("library/list"))}async item(e){const t=await this.call("library/get",{item_id:e});return Ye(I(t,"item"))}async createItem(e,t,i){const s=await this.call("library/create",{name:e,content:Ae(t),expected_library_revision:i});return{item:Ye(I(s,"item")),library_revision:bt(s)}}async updateItem(e,t,i,s){const r=await this.call("library/update",{item_id:e.id,name:t,content:Ae(i),expected_revision:e.revision,expected_library_revision:s});return{item:Ye(I(r,"item")),library_revision:bt(r)}}async deleteItem(e,t){const i=await this.call("library/delete",{item_id:e.id,expected_revision:e.revision,expected_library_revision:t});return bt(i)}async drafts(){const e=await this.call("draft/list");return gn(I(e,"drafts"))}async draft(e){const t=await this.call("draft/get",{draft_id:e});return mt(I(t,"draft"))}async createDraft(e,t,i,s){const r=await this.call("draft/create",{name:e,content:Ae(t),updated_at:new Date().toISOString(),selected_config_entry_id:i,...s?{base_item_id:s.id,base_item_revision:s.revision}:{}});return mt(I(r,"draft"))}async updateDraft(e,t,i,s){const r=await this.call("draft/update",{draft_id:e.id,expected_revision:e.revision,name:t,content:Ae(i),updated_at:new Date().toISOString(),selected_config_entry_id:s});return mt(I(r,"draft"))}async deleteDraft(e){await this.call("draft/delete",{draft_id:e.id,expected_revision:e.revision})}async applySaved(e,t){const i=await this.call("apply",{config_entry_id:e,item_id:t.id,revision:t.revision,updated_at:new Date().toISOString()});return Ct(I(i,"deployment"))}async applySnapshot(e,t,i){const s=await this.call("apply_snapshot",{config_entry_id:e,name:t,content:Ae(i),updated_at:new Date().toISOString()});return Ct(I(s,"deployment"))}async sceneCatalogue(e){const t=await this.call("scene/catalogue/list",{config_entry_id:e});return vn(I(t,"catalogue"))}sceneDetail(e,t,i){return this.call("scene/catalogue/get",{config_entry_id:e,scene_id:t,effect_id:i}).then(yn)}async applyScene(e,t,i){const s=await this.call("scene/apply",{config_entry_id:e,scene_id:t.scene_id,effect_id:t.effect_id,...i===null?{}:{speed_index:i}}),r=qt(I(s,"scene")),a=I(s,"readback");if(a!=="scene_identity_only")throw new Error("Malformed Effect Studio server payload: scene Apply readback is invalid.");const l=I(s,"speed_index");if(l!==null&&(typeof l!="number"||!Number.isSafeInteger(l)||l<0||l>255))throw new Error("Malformed Effect Studio server payload: scene Apply speed is invalid.");return{scene:r,speed_index:l,readback:a}}subscribeLibrary(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(bi(i))}catch(s){t?.(yi(s))}},{type:`${gt}/library/subscribe`})}subscribeDeployments(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(bn(i))}catch(s){t?.(yi(s))}},{type:`${gt}/deployment/subscribe`})}call(e,t={}){return this.hass.callWS({type:`${gt}/${e}`,...t})}}function I(n,e){if(typeof n!="object"||n===null||Array.isArray(n))throw new Error("Malformed Effect Studio server payload: response must be an object.");if(!(e in n))throw new Error(`Malformed Effect Studio server payload: response is missing ${e}.`);return n[e]}function bt(n){const e=I(n,"library_revision");if(typeof e!="number"||!Number.isSafeInteger(e)||e<0)throw new Error("Malformed Effect Studio server payload: library revision is invalid.");return e}function yi(n){return n instanceof Error?n:new Error("Malformed Effect Studio server payload.")}var In=Object.defineProperty,ts=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&In(e,t,s),s};const It=17,is="ha_govee_led_ble/effect_studio/recent_colours",Xe=[[255,69,58],[255,159,10],[255,214,10],[48,209,88],[99,230,226],[100,210,255],[10,132,255],[94,92,230],[191,90,242],[255,45,85],[172,142,104],[255,255,255],[174,174,178],[99,99,102],[28,28,30],[255,127,0],[139,0,255]];let ke=Pn();class Kt extends D{constructor(){super(...arguments),this.colour=[255,255,255],this.disabled=!1}render(){return o`
  ...
  `]}}jt([h({attribute:!1})],at.prototype,"content");jt([h({attribute:!1})],at.prototype,"catalogue");jt([h({type:Boolean})],at.prototype,"disabled");customElements.get("govee-custom-effect-editor")||customElements.define("govee-custom-effect-editor",at);const fe={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Nn=n=>(...e)=>({_$litDirective$:n,values:e});class Rn{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Bn=n=>n.strings===void 0,On={},Fn=(n,e=On)=>n._$AH=e;const $i=Nn(class extends Rn{constructor(n){if(super(n),n.type!==fe.PROPERTY&&n.type!==fe.ATTRIBUTE&&n.type!==fe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Bn(n))throw Error("`live` bindings can only contain a single expression")}render(n){return n}update(n,[e]){if(e===H||e===d)return e;const t=n.element,i=n.name;if(n.type===fe.PROPERTY){if(e===t[i])return H}else if(n.type===fe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return H}else if(n.type===fe.ATTRIBUTE&&t.getAttribute(i)===e+"")return H;return Fn(n),e}});var Un=Object.defineProperty,ot=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&Un(e,t,s),s};const Hn=new Set(["rhythm","bloom","shiny"]),qn=new Set(["point","gradient","relative_brightness","key_count","direction","segment_count","speed"]),ns=[{id:"clockwise",label:"Clockwise"},{id:"two_way",label:"Two-way"},{id:"counterclockwise",label:"Counterclockwise"}];class Ue extends D{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0,this.modeChanged=e=>{const t=e.target.value;this.updateContent(i=>(i.mode=t,i.parameters=Kn(i.parameters),i.calm=vt(t)?i.calm??!1:null,i))}}willUpdate(e){e.has("content")&&this.content?.colour!=null&&(this.lastFixedColour=re(this.content.colour))}render(){if(!this.content)return d;const e=Vn(this.content.mode,this.catalogue),t=this.catalogue?.limits.music_sensitivity_min??0,i=this.catalogue?.limits.music_sensitivity_max??100,s=rs(this.content.sensitivity,t,i),r=this.content.colour===null?"automatic":"fixed",a=this.content.colour??this.lastFixedColour??Pt(0);return o`
      <section class="card">
        <div class="parameter-stack">
    ...
    `}renderDayAndNightParameters(e){const t=Ie(e,"segment_count",1,1,7),i=Ie(e,"speed",10,1,50),s=xi(e,"gradient",!1);return o`
  ...
  `]}}A([h({attribute:!1})],S.prototype,"api");A([h({attribute:!1})],S.prototype,"device");A([h({attribute:!1})],S.prototype,"library");A([h({type:Boolean})],S.prototype,"isAdmin");A([g()],S.prototype,"catalogue");A([g()],S.prototype,"category");A([g()],S.prototype,"search");A([g()],S.prototype,"selectedScene");A([g()],S.prototype,"selectedItem");A([g()],S.prototype,"content");A([g()],S.prototype,"name");A([g()],S.prototype,"speedIndex");A([g()],S.prototype,"loading");A([g()],S.prototype,"saving");A([g()],S.prototype,"applying");A([g()],S.prototype,"editingCopy");A([g()],S.prototype,"notice");A([g()],S.prototype,"error");function ge(n){return`builtin:${n.scene_id}:${n.effect_id}`}function Wn(n,e){return Array.from({length:n},(t,i)=>({value:i,label:Xn(i,e)}))}function Xn(n,e){const t=n-e;if(t===0)return"Default";const i=Math.abs(t);return`${i} ${i===1?"step":"steps"} ${t<0?"lower":"higher"}`}function _t(n){return{...n,template:{...n.template},steps:n.steps.map(e=>({...e,colour:[...e.colour],inline_colour:e.inline_colour===null?null:[...e.inline_colour]})),palette:n.palette.map(e=>[...e])}}customElements.get("govee-scene-browser")||customElements.define("govee-scene-browser",S);var Jn=Object.defineProperty,Yt=(n,e,t,i)=>{for(var s=void 0,r=n.length-1,a;r>=0;r--)(a=n[r])&&(s=a(e,t,s)||s);return s&&Jn(e,t,s),s};const Zn=[{value:"movie",label:"Movie"},{value:"game",label:"Game"}],Qn=[{value:!0,label:"Full screen"},{value:!1,label:"Part screen"}],er=[{key:"left",label:"Left"},{key:"top",label:"Top"},{key:"right",label:"Right"},{key:"bottom",label:"Bottom"}];function X(n,e,t){return Math.min(t,Math.max(e,Math.round(n)))}function tr(n){return{...n}}function ki(n){return{...n,relative_brightness:tr(n.relative_brightness)}}function os(n){const e=[n.left,n.top,n.right,n.bottom];return e.every(t=>t===e[0])?e[0]:void 0}function ir(n){const e=os(n);return e!==void 0?e:X((n.left+n.top+n.right+n.bottom)/4,1,100)}function sr(n){const e=X(n,1,100);return{left:e,top:e,right:e,bottom:e}}class lt extends D{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0}render(){if(!this.content)return o`
        <section class="card empty-state" role="status">
      ...
      `;const e=this.content.relative_brightness,t=os(e)===void 0,i=ir(e);return o`
      <div class="editor-grid">
        <section class="card">
          <div class="parameter-stack">
            ${this.showModeSelector?this.renderSegmentedField("Mode",this.content.mode,Zn,s=>this.updateContent(r=>{r.mode=s})):d}
            ${this.renderSegmentedField("Capture area",this.content.full_screen,Qn,s=>this.updateContent(r=>{r.full_screen=s}))}
            ${this.renderCheckboxField("Sound effects",this.content.sound_effects,s=>this.updateContent(r=>{r.sound_effects=s}))}
            ${this.content.sound_effects?this.renderRangeField("Softness",this.content.sound_effects_softness,1,100,String(this.content.sound_effects_softness),s=>this.updateContent(r=>{r.sound_effects_softness=X(s,1,100)})):d}
        ...
        <section class="card">
          ...
          <div class="parameter-stack">
            ${this.renderRangeField("Saturation",this.content.saturation,0,100,`${this.content.saturation}%`,s=>this.updateContent(r=>{r.saturation=X(s,0,100)}))}
        ...
        <section class="card brightness-card">
          ...
          <div class="parameter-stack">
            ${this.renderRangeField("Uniform brightness",i,1,100,`${i}%`,s=>this.updateContent(r=>{r.relative_brightness=sr(s)}),t?"relative-brightness-note":void 0)}
            ${t?o`
    ...
    `}updateRelativeBrightnessEdge(e,t){this.updateContent(i=>{i.relative_brightness[e]=X(t,1,100)})}updateContent(e){if(!this.content)return;const t=ki(this.content);e(t),this.emitContent(t)}emitContent(e){this.dispatchEvent(new CustomEvent("content-changed",{detail:{content:ki(e)},bubbles:!0,composed:!0}))}static{this.styles=[N,de,ee,E`
      :host {
        display: block;
        color: var(--primary-text-color);
      }
    ...
    `}renderCurrentCustomEditor(){return Pe(this.content)?this.content.kind==="h617a_painted"?this.renderPaintedEditor():this.renderPaletteEffectEditor():this.content.kind==="palette_diy"||this.content.kind==="special_diy"?this.renderPaletteEffectEditor():this.content.kind==="music_profile"?this.renderMusicProfileEditor():Ge(this.content)?this.renderAdvancedEditor():this.content.kind==="opaque"?this.renderOpaqueEditor(this.content):d}renderVideo(){const e=this.modelCatalogue;if(!e||!this.videoAvailable)return d;const t=this.library.items.filter(i=>i.kind==="video_profile"&&this.libraryItemAvailable(i)).sort((i,s)=>Te(i.name,s.name));return o`
    ...
    `}selectCustomEffectEntry(e){if(e.kind==="saved"){this.selectItem(e.item.id);return}if(e.kind==="advanced"){this.newEffect("advanced",void 0,{name:e.label,content:ct(),selectionIdentity:e.key,templateLabel:e.label}),this.customTemplateSelection=e.key;return}if(e.kind==="workshop"||e.kind==="special_diy"){this.openEditableTemplate(e.label,e.content,e.key);return}const t=this.modelCatalogue;if(t){if(e.kind==="music"){if(e.mode){this.openMusicTemplate(e.mode,e.label);return}if(e.family===void 0||e.variant===void 0)return;const i=this.selectedModel==="H617A"?{...z("h617a_single",t),family:e.family,variant:e.variant}:Ke(t,this.selectedModel,e.family,e.variant);this.openEditableTemplate(e.label,i,e.key);return}if(e.kind==="paint"){this.newEffect("h617a_painted",void 0,{name:e.label,content:ve(),selectionIdentity:e.key,templateLabel:e.label});return}if(e.kind==="single"){if(this.selectedModel==="H617A"){const i=z("h617a_single",t);this.newEffect("h617a_single",void 0,{name:e.label,content:{...i,family:e.family,variant:e.variant},selectionIdentity:e.key,templateLabel:e.label})}else this.openEditableTemplate(e.label,Ke(t,this.selectedModel,e.family,e.variant),e.key);return}this.newEffect("h617a_multi",void 0,{name:e.label,content:z("h617a_multi",t),selectionIdentity:e.key,templateLabel:e.label})}}openEditableTemplate(e,t,i){this.beginEditorTransition(),this.currentItem=void 0,this.templateSourceLabel=e,this.customCopyStarted=!0,this.customTemplateSelection=i,this.name=e,this.content=je(t),this.savedBaseline=void 0,this.notice=void 0}openMusicTemplate(e,t){const i=this.selectedModel;i!=="H617A"&&i!=="H6199"||this.openEditableTemplate(t,{kind:"music_profile",model:i,mode:e,sensitivity:i==="H6199"?100:99,colour:null,calm:["rhythm","bloom","shiny"].includes(e)?!1:null,parameters:{}},`template:music:${e}`)}renderAdvancedEditor(){if(!Ge(this.content))return d;const e=this.content.kind==="scene_layered",t=this.content.kind==="workshop",i=this.activeDeployment;return o`
      ${e?o`
            <button
              class="back-button"
              type="button"
      ...
      <govee-advanced-effect-editor
        ...
        @content-changed=${s=>{Ge(this.content)&&(this.content=dr(this.content,s.detail.content))}}
      ></govee-advanced-effect-editor>
  ...
  `]}}x([h({attribute:!1})],$.prototype,"hass");x([h({attribute:!1})],$.prototype,"panel");x([h({type:Boolean})],$.prototype,"showDevicePicker");x([g()],$.prototype,"loading");x([g()],$.prototype,"error");x([g()],$.prototype,"notice");x([g()],$.prototype,"devices");x([g()],$.prototype,"selectedDeviceId");x([g()],$.prototype,"section");x([g()],$.prototype,"customEffectCategory");x([g()],$.prototype,"customTemplateSelection");x([g()],$.prototype,"templateSourceLabel");x([g()],$.prototype,"customCopyStarted");x([g()],$.prototype,"library");x([g()],$.prototype,"customCatalogue");x([g()],$.prototype,"currentItem");x([g()],$.prototype,"name");x([g()],$.prototype,"content");x([g()],$.prototype,"paintBrushes");x([g()],$.prototype,"selectedPaintBrush");x([g()],$.prototype,"brushUsesBackground");x([g()],$.prototype,"saving");x([g()],$.prototype,"applying");x([g()],$.prototype,"deleteCandidate");x([g()],$.prototype,"deletingItemId");x([g()],$.prototype,"deployments");x([g()],$.prototype,"activeOperationId");function ve(){return{kind:"h617a_painted",effect:"clockwise",speed:50,brightness:100,background:[0,0,0],groups:[]}}function z(n,e){if(n==="h617a_painted")return ve();const t=n==="h617a_multi"?e.effects.find(r=>r.supports_multi):e.effects[0];if(!t)throw new Error("The custom-effect catalogue has no compatible effects.");const i=t.variations[0],s={family:t.family,variant:i.variant};return n==="h617a_single"?{kind:n,...s,speed:50,palette:Re()}:{kind:n,effects:[s],speed:50,palette:Re()}}function Ke(n,e,t,i){if(e!=="H617A"&&e!=="H6199")throw new Error(`Unsupported custom-effect model ${e}.`);const s=n.effects.find(r=>r.family===t)??n.effects[0];if(!s)throw new Error("The custom-effect catalogue has no compatible effects.");return{kind:"palette_diy",model:e,family:t??s.family,variant:i??s.variations[0].variant,speed:50,palette:Re()}}function rr(n){return{kind:"video_profile",model:"H6199",mode:n==="game"?"game":"movie",full_screen:!0,saturation:50,sound_effects:!1,sound_effects_softness:50,white_balance_position:17,relative_brightness:{left:100,top:100,right:100,bottom:100},blank_screen:!1}}function ar(n){return{...n,background:[...n.background],groups:n.groups.map(e=>({fill:[...e.fill],segments:[...e.segments]}))}}function ls(n){return n.kind==="h617a_painted"?ar(n):n.kind==="h617a_single"?{...n,palette:n.palette.map(e=>[...e])}:{...n,effects:n.effects.map(e=>({...e})),palette:n.palette.map(e=>[...e])}}function ds(n){return{...n,palette:n.palette.map(e=>[...e])}}function cs(n){return{...n,palette:n.palette.map(e=>[...e])}}function us(n){return{...n,effect:{layers:_e({layers:n.effect.layers}).layers}}}function ps(n){return{...n,colour:n.colour?[...n.colour]:null,parameters:structuredClone(n.parameters)}}function hs(n){return{...n,relative_brightness:{...n.relative_brightness}}}function je(n){return n.kind==="advanced"?_e(n):n.kind==="scene_layered"?$e(n):n.kind==="workshop"?us(n):n.kind==="palette_diy"?ds(n):n.kind==="special_diy"?cs(n):n.kind==="music_profile"?ps(n):n.kind==="video_profile"?hs(n):ls(n)}function or(n){return{...n,body:structuredClone(n.body)}}function lr(n){return n.kind==="advanced"?n:{kind:"advanced",layers:n.effect.layers}}function dr(n,e){return n.kind==="advanced"?_e(e):n.kind==="workshop"?{...us(n),effect:{layers:_e(e).layers}}:{...$e(n),effect:{layers:_e(e).layers}}}function Re(){return[[255,0,0],[255,127,0],[255,255,0],[0,255,0],[0,0,255],[0,255,255],[139,0,255]]}function cr(n){const e=[];for(const t of[...n,...Re()])if(e.some(i=>tt(i,t))||e.push([...t]),e.length===8)break;return e}function Tt(n){const e=Array.from({length:Dt},()=>[...n.background]);for(const t of n.groups)for(const i of t.segments)e[i]=[...t.fill];return e}function wi(n,e){const t=new Map;return n.forEach((i,s)=>{if(tt(i,e))return;const r=i.join(","),a=t.get(r);a?a.segments.push(s):t.set(r,{fill:[...i],segments:[s]})}),[...t.values()]}function ur(n){const e=[];for(const t of Tt(n))if(!tt(t,n.background)&&!e.some(i=>tt(i,t))&&e.push([...t]),e.length===8)break;return e}function tt(n,e){return n[0]===e[0]&&n[1]===e[1]&&n[2]===e[2]}function Y(n,e){return JSON.stringify({name:n.trim(),content:e})}function Wt(n){return n==="h617a_painted"||n==="h617a_single"||n==="h617a_multi"}function Pe(n){return typeof n=="object"&&n!==null&&"kind"in n&&Wt(n.kind)}function $t(n){return V(n)}function V(n){return Pe(n)||typeof n=="object"&&n!==null&&"kind"in n&&(He(n.kind)||n.kind==="palette_diy"||n.kind==="special_diy"||n.kind==="music_profile"||n.kind==="video_profile")}function Ei(n){return n.kind==="h617a_multi"?"multi":He(n.kind)?"advanced":n.kind==="h617a_painted"||n.kind==="h617a_single"||n.kind==="palette_diy"||n.kind==="special_diy"?"single":void 0}function He(n){return n==="advanced"||n==="scene_layered"||n==="workshop"}function Ge(n){return He(n.kind)}function pr(n){return Wt(n)||He(n)||n==="palette_diy"||n==="special_diy"||n==="music_profile"||n==="video_profile"||n==="scene_builtin"||n==="scene_palette"}function Ci(n){switch(n){case"h617a_painted":return"Paint";case"h617a_single":return"Single";case"h617a_multi":return"Multi";case"advanced":return"Layered";case"palette_diy":return"Single";case"special_diy":return"Special DIY";case"workshop":return"Workshop";default:return"Custom"}}function xt(n){return Wt(n)||He(n)||n==="palette_diy"||n==="special_diy"||n==="music_profile"||!pr(n)}function Si(n,e){const t=e==="H6199"?["special_diy","palette_diy","workshop","music_profile","advanced","scene_layered"]:["h617a_painted","h617a_single","h617a_multi","music_profile","workshop","advanced","scene_layered"],i=t.indexOf(n);return i===-1?t.length:i}function hr(n){return n==="h617a_multi"?"multi-layer":n==="music_profile"?"music":n==="h617a_painted"||n==="h617a_single"||n==="palette_diy"||n==="special_diy"?n==="special_diy"?"special-diy":"single-layer":"advanced"}function Ai(n,e){return n?.id===e?.id&&n?.revision===e?.revision}function Ii(n,e){const t=mr(e);return[...n.filter(i=>i.id!==e.id),{id:e.id,revision:e.revision,name:e.name,kind:e.content.kind==="opaque"?e.content.source_kind:e.content.kind,...t?{model:t}:{},...e.content.kind==="scene_builtin"||e.content.kind==="scene_palette"||e.content.kind==="scene_layered"?{template:e.content.template}:{}}].sort((i,s)=>i.name.localeCompare(s.name))}function mr(n){const e=n.content;return e.kind==="palette_diy"||e.kind==="special_diy"||e.kind==="workshop"||e.kind==="music_profile"||e.kind==="video_profile"?e.model:e.kind==="h617a_painted"||e.kind==="h617a_single"||e.kind==="h617a_multi"?"H617A":e.kind==="scene_builtin"||e.kind==="scene_palette"||e.kind==="scene_layered"?Pi(e.template.sku):Pi(n.target_hint?.model)}function Pi(n){return n==="H617A"||n==="H6199"?n:void 0}customElements.get("ha-govee-led-ble-editor")||customElements.define("ha-govee-led-ble-editor",$);
