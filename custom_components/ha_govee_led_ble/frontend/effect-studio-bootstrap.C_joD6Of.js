...
`;var Ds=Object.defineProperty,ce=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ds(e,t,s),s};class te extends I{constructor(){super(...arguments),this.items=[],this.ariaLabel="Items",this.itemRole="button",this.addLabel="Add item",this.addDisabled=!1,this.reorderDisabled=!1,this.pointerX=0,this.pointerY=0,this.pointerMoved=!1,this.suppressClick=!1}render(){const e=this.itemRole==="tab";return o`
  ...
  `]}}pe([h({attribute:!1})],se.prototype,"content");pe([h({type:Boolean})],se.prototype,"disabled");pe([h({type:Number})],se.prototype,"segmentCount");pe([m()],se.prototype,"activeLayerIndex");pe([m()],se.prototype,"activePatternIndex");pe([m()],se.prototype,"movementAnnouncement");pe([m()],se.prototype,"layerActionsIndex");function lt(){return{kind:"advanced",layers:[Bi()]}}function Je(r){return{kind:"advanced",layers:r.layers.map(X)}}function st(r){return{...r,template:{...r.template},effect:{layers:Je({layers:r.effect.layers}).layers}}}function Bi(){return{area:{start_tenths:0,width_tenths:10},selection:{type:0,param_1:0,param_2:1},brightness_gradient:!1,brightness_patterns:[Oi()],distribution:{method:1,backwards:!1},colour_speed:128,colour_retention:20,palette:[[255,0,0],[0,0,255]],selected_movement:ni(),overall_movement:ni(),priority:0,unknown_flags:0,excess:""}}function Oi(){return{scope_high:255,scope_low:0,order:0,change_speed:128,brightest_retention:20,darkest_retention:20}}function ni(){return{enabled:!1,enter_exit:!1,direction:0,distance:1,speed:128,unknown_flags:0}}function X(r){return{...r,area:{...r.area},selection:{...r.selection},brightness_patterns:r.brightness_patterns.map(e=>({...e})),distribution:{...r.distribution},palette:r.palette.map(e=>[...e]),selected_movement:{...r.selected_movement},overall_movement:{...r.overall_movement}}}function Us(r){return Ni.includes(r)}function Hs(r){return Ri.includes(r)}function qs(r){return Math.round(R(r,0,255)/255*100)}function qe(r){return r.toString(16).padStart(2,"0").toUpperCase()}function Vs(r){const e=r.trim().replace(/^0x/i,"");if(/^[0-9a-f]{1,2}$/i.test(e))return Number.parseInt(e,16)}function Ks(r,e,t,i){const s=r*10/e;return(r+1)*10/e>t&&s<i}function ai(r,e,t,i){if(r==="Home")return t;if(r==="End")return i;if(r==="ArrowLeft"||r==="ArrowDown")return R(e-1,t,i);if(r==="ArrowRight"||r==="ArrowUp")return R(e+1,t,i)}function R(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}customElements.get("govee-advanced-effect-editor")||customElements.define("govee-advanced-effect-editor",se);const js=["compiling","pending","uploading","activating","verifying","confirmed","uncertain","recovering","failed","interrupted","unknown"],dt=["compiling","pending","uploading","activating","verifying","recovering"],Gs=1,Fi=1,zs=1,oi=3,T=128,we=65536,Ui=512,Hi=256,qi=32,Vi=128,Ki=512,x=255,Xs=64,ji=262144,li=16,Ws=4096,Gi=16384,q=1024,ct=16384,Nt=Number.MAX_SAFE_INTEGER,Ys=4335,Js=232,Zs=253,_e=["H617A","H6199"],ut="H617A",zi=["movie","game"],di=["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","video","palette_diy","advanced","workshop","special_diy"],Qs=["studio","home_assistant","planned"],er={H617A:["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","advanced","workshop","special_diy"],H6199:["native_scenes","edited_palette_scenes","layered_scenes","palette_diy","native_music","video","advanced","workshop","special_diy"]};function tr(r){const e=f(r,"editor info"),t=f(e.limits,"editor limits");return{api_version:u(e.api_version,"API version",1),effect_schema_version:u(e.effect_schema_version,"effect schema version",1),compiler_version:u(e.compiler_version,"compiler version",1),limits:{effect_name:U(t.effect_name,T,"effect-name limit"),effect_document_bytes:U(t.effect_document_bytes,we,"effect-document limit"),devices:U(t.devices,Ui,"device limit"),library_items:U(t.library_items,Hi,"library-item limit"),drafts_per_owner:U(t.drafts_per_owner,qi,"draft limit"),deployment_records:U(t.deployment_records,Vi,"deployment limit"),scene_catalogue_entries:U(t.scene_catalogue_entries,Ki,"scene catalogue limit")}}}function ir(r){const e=E(r,"devices",Ui).map((t,i)=>{const s=f(t,`devices[${i}]`),n=f(s.custom_effects,`devices[${i}].custom_effects`);return{config_entry_id:b(s.config_entry_id,`devices[${i}].config_entry_id`,x),model:b(s.model,`devices[${i}].model`,x),display_name:b(s.display_name,`devices[${i}].display_name`,x),segment_count:u(s.segment_count,`devices[${i}].segment_count`,0,65535),custom_effects:{painted:H(n.painted,"painted capability"),single:H(n.single,"single capability"),multi:H(n.multi,"multi capability"),advanced:H(n.advanced,"advanced capability")},readback:b(s.readback,`devices[${i}].readback`,x)}});return V(e,t=>t.config_entry_id,"device IDs"),e}function sr(r){he(r,"custom-effect catalogue",ji,Gi);const e=f(r,"custom-effect catalogue"),t=rr(e.models),i=yt(e,"custom-effect catalogue",ut);if(JSON.stringify(i)!==JSON.stringify(t[ut]))throw new Error("Malformed Effect Studio server payload: legacy custom-effect catalogue view does not match models.H617A.");return U(e.schema_version,oi,"catalogue schema"),{...i,schema_version:oi,sku:ut,models:t}}function rr(r){const e=f(r,"custom-effect catalogue models"),i=Object.keys(e).filter(s=>!_e.includes(s));if(i.length>0)throw new Error(`Malformed Effect Studio server payload: unexpected catalogue models ${i.join(", ")}.`);for(const s of _e)if(!(s in e))throw new Error(`Malformed Effect Studio server payload: missing catalogue model ${s}.`);return{H617A:yt(e.H617A,"catalogue model H617A","H617A"),H6199:yt(e.H6199,"catalogue model H6199","H6199")}}function yt(r,e,t){const i=f(r,e),s=f(i.limits,`${e} limits`),n=f(i.supports,`${e} support capabilities`),a=f(i.apply,`${e} Apply capabilities`),l=D(i.sku,_e,`${e} SKU`);if(l!==t)throw new Error(`Malformed Effect Studio server payload: ${e} is keyed as ${t} but declares ${l}.`);const c=u(s.music_sensitivity_min,`${e} minimum music sensitivity`,0,100),p=u(s.music_sensitivity_max,`${e} maximum music sensitivity`,0,100);return c>p&&v(`${e} music sensitivity limits are inverted`),{sku:l,painted_effects:ar(i.painted_effects,`${e} painted-effect templates`),effects:or(i.effects,`${e} custom-effect templates`),music_modes:ci(i.music_modes,`${e} music modes`),video_modes:ci(i.video_modes,`${e} video modes`,zi),workflows:nr(i.workflows,`${e} release workflows`,t),supports:{multi:H(n.multi,`${e} Multi support`),advanced:H(n.advanced,`${e} advanced support`)},limits:{palette_min:u(s.palette_min,`${e} minimum palette`,1,255),palette_max:u(s.palette_max,`${e} maximum palette`,1,255),multi_max:u(s.multi_max,`${e} maximum Multi effects`,1,255),music_sensitivity_min:c,music_sensitivity_max:p},apply:{painted:H(a.painted,`${e} Painted Apply capability`),single:H(a.single,`${e} Single Apply capability`),multi:H(a.multi,`${e} Multi Apply capability`)}}}function nr(r,e,t){const i=E(r,e,di.length).map((c,p)=>{const g=f(c,`${e}[${p}]`);return{id:D(g.id,di,`${e}[${p}] ID`),label:b(g.label,`${e}[${p}] label`,T),content_kind:b(g.content_kind,`${e}[${p}] content kind`,x),application:D(g.application,Qs,`${e}[${p}] application`)}});V(i,c=>c.id,`${e} IDs`);const s=er[t],n=new Set(i.map(c=>c.id)),a=s.filter(c=>!n.has(c)),l=i.map(c=>c.id).filter(c=>!s.includes(c));if(a.length>0||l.length>0)throw new Error(`Malformed Effect Studio server payload: ${e} does not match ${t}.`);return i}function ar(r,e){const t=E(r,e,q).map((i,s)=>{const n=f(i,`${e}[${s}]`);return{id:D(n.id,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],`${e} ID`),label:b(n.label,`${e} label`,T)}});return V(t,i=>i.id,`${e} IDs`),t}function or(r,e){const t=E(r,e,q).map((i,s)=>{const n=f(i,`${e}[${s}]`),a=E(n.variations,`${e}[${s}].variations`,q);if(a.length===0)throw new Error("Malformed Effect Studio server payload: custom-effect template has no variations.");const l={id:b(n.id,`${e}[${s}] ID`,x),label:b(n.label,`${e}[${s}] label`,T),family:u(n.family,`${e}[${s}] family`,0,255),variations:a.map((c,p)=>{const g=f(c,`${e}[${s}].variations[${p}]`);return{id:b(g.id,`${e}[${s}].variations[${p}] ID`,x),label:b(g.label,`${e}[${s}].variations[${p}] label`,T),variant:u(g.variant,`${e}[${s}].variations[${p}] variant`,0,255)}}),supports_multi:B(n.supports_multi,`${e}[${s}] Multi support`),rate:D(n.rate,["speed","sensitivity"],`${e}[${s}] rate parameter`)};return V(l.variations,c=>c.id,`${e}[${s}] variation IDs`),l});return V(t,i=>i.id,`${e} IDs`),t}function ci(r,e,t){const i=E(r,e,q).map((s,n)=>{const a=f(s,`${e}[${n}]`);return{id:t?D(a.id,t,`${e}[${n}] ID`):b(a.id,`${e}[${n}] ID`,x),label:b(a.label,`${e}[${n}] label`,T)}});return V(i,s=>s.id,`${e} IDs`),i}function ui(r){const e=f(r,"library snapshot"),t={library_revision:Q(e.library_revision,"library revision",0),items:E(e.items,"library items",Hi).map((i,s)=>{const n=f(i,`library items[${s}]`),a=n.template===void 0?void 0:Ze(n.template,`library items[${s}].template`),l=n.model===void 0?void 0:vr(n.model);return{id:b(n.id,"library item ID",x),revision:Q(n.revision,"library item revision",1),name:b(n.name,"library item name",T),kind:b(n.kind,"library item kind",x),...l?{model:l}:{},...a?{template:a}:{}}})};return V(t.items,i=>i.id,"library item IDs"),t}function Ge(r){he(r,"library item",we);const e=f(r,"library item"),t=e.target_hint===void 0?void 0:f(e.target_hint,"target hint");return{schema_version:U(e.schema_version,Fi,"effect schema version"),id:b(e.id,"effect ID",x),revision:Q(e.revision,"effect revision",1),name:b(e.name,"effect name",T),content:Xi(e.content),provenance:_t(e.provenance,"effect provenance"),extensions:_t(e.extensions,"effect extensions"),...t?{target_hint:{model:t.model===null?null:b(t.model,"target model",x),segment_count:t.segment_count===null?null:u(t.segment_count,"target segment count",1,65535)}}:{}}}function lr(r){const e=E(r,"draft summaries",qi).map((t,i)=>{const s=f(t,`draft summaries[${i}]`);return{id:b(s.id,"draft ID",x),revision:Q(s.revision,"draft revision",1),name:b(s.name,"draft name",T),updated_at:Bt(s.updated_at,"draft timestamp"),selected_config_entry_id:Me(s.selected_config_entry_id,"draft config entry ID")}});return V(e,t=>t.id,"draft IDs"),e}function pt(r){const e=f(r,"effect draft");return{id:b(e.id,"draft ID",x),owner_id:b(e.owner_id,"draft owner",x),revision:Q(e.revision,"draft revision",1),item:Ge(e.item),updated_at:Bt(e.updated_at,"draft timestamp"),selected_config_entry_id:Me(e.selected_config_entry_id,"draft config entry ID"),base_item_id:Me(e.base_item_id,"draft base item ID"),base_item_revision:e.base_item_revision===null?null:Q(e.base_item_revision,"draft base item revision",1)}}function $t(r){const e=f(r,"deployment"),t=D(e.phase,js,"deployment phase"),i={operation_id:b(e.operation_id,"deployment operation ID",x),config_entry_id:b(e.config_entry_id,"deployment config entry ID",x),diy_code:u(e.diy_code,"deployment DIY code",0,65535),phase:t,updated_at:Bt(e.updated_at,"deployment timestamp"),item_id:Me(e.item_id,"deployment item ID"),item_revision:e.item_revision===null?null:Q(e.item_revision,"deployment item revision",1),error_code:Me(e.error_code,"deployment error code"),progress_current:u(e.progress_current,"deployment progress",0,1024),progress_total:u(e.progress_total,"deployment progress total",0,1024)};return i.progress_current>i.progress_total&&v("deployment progress exceeds its total"),i}function dr(r){const e=f(r,"deployment snapshot"),t={revision:Q(e.revision,"deployment revision",0),deployments:E(e.deployments,"deployments",Vi).map($t)};return V(t.deployments,i=>i.operation_id,"deployment operation IDs"),t}function cr(r){he(r,"scene catalogue",ji,Gi);const e=f(r,"scene catalogue");return{schema_version:u(e.schema_version,"scene catalogue schema",1),sku:b(e.sku,"scene catalogue SKU",x),enabled:B(e.enabled,"scene catalogue enabled"),categories:E(e.categories,"scene categories",q).map((t,i)=>{const s=f(t,`scene categories[${i}]`);return{id:u(s.id,"scene category ID",0,65535),name:b(s.name,"scene category name",T)}}),scenes:E(e.scenes,"scenes",Ki).map(Rt)}}function ur(r){const e=f(r,"scene detail");he({scene:e.scene,content:e.content},"scene detail",we);const t=Xi(e.content);return t.kind!=="scene_builtin"&&t.kind!=="scene_palette"&&t.kind!=="scene_layered"&&v("scene detail content is unsupported"),{scene:Rt(e.scene),content:t}}function Xi(r){he(r,"effect content",we);const e=f(r,"effect content"),t=b(e.kind,"effect content kind",x);switch(t){case"h617a_painted":return{kind:t,effect:D(e.effect,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],"painted effect"),speed:u(e.speed,"painted speed",0,100),brightness:u(e.brightness,"painted brightness",0,100),background:xe(e.background,"painted background"),groups:E(e.groups,"paint groups",15).map((i,s)=>{const n=f(i,`paint groups[${s}]`);return{fill:xe(n.fill,"paint-group fill"),segments:E(n.segments,"painted segments",15).map(a=>u(a,"painted segment",0,14))}})};case"h617a_single":return{kind:t,family:u(e.family,"Single family",0,254),variant:u(e.variant,"Single variant",0,255),speed:u(e.speed,"Single speed",0,100),palette:Pe(e.palette,"Single palette",8)};case"h617a_multi":return{kind:t,effects:E(e.effects,"Multi effects",4).map((i,s)=>{const n=f(i,`Multi effects[${s}]`);return{family:u(n.family,"Multi family",0,254),variant:u(n.variant,"Multi variant",0,255)}}),speed:u(e.speed,"Multi speed",0,100),palette:Pe(e.palette,"Multi palette",8)};case"palette_diy":return{kind:t,model:D(e.model,_e,"palette DIY model"),family:u(e.family,"palette DIY family",0,255),variant:u(e.variant,"palette DIY variant",0,255),speed:u(e.speed,"palette DIY speed",0,100),palette:Pe(e.palette,"palette DIY palette",8)};case"music_profile":return{kind:t,model:D(e.model,_e,"music profile model"),mode:b(e.mode,"music profile mode",x),sensitivity:u(e.sensitivity,"music profile sensitivity",0,100),colour:mr(e.colour,"music profile colour"),calm:fr(e.calm,"music profile calm"),parameters:_t(e.parameters,"music profile parameters")};case"video_profile":return{kind:t,model:D(e.model,["H6199"],"video profile model"),mode:D(e.mode,zi,"video profile mode"),full_screen:B(e.full_screen,"video profile full-screen flag"),saturation:u(e.saturation,"video profile saturation",0,100),sound_effects:B(e.sound_effects,"video profile sound-effects flag"),sound_effects_softness:u(e.sound_effects_softness,"video profile sound-effects softness",1,100),white_balance_position:u(e.white_balance_position,"video profile white-balance position",1,20),relative_brightness:gr(e.relative_brightness,"video profile relative brightness"),blank_screen:B(e.blank_screen,"video profile blank-screen flag")};case"advanced":return{kind:t,layers:pi(e.layers,"Advanced layers")};case"scene_builtin":return{kind:t,template:Ze(e.template,"scene template"),speed_index:xt(e.speed_index,"scene speed index",0,255)};case"scene_palette":return pr(e);case"scene_layered":{const i=f(e.effect,"layered scene effect"),s=Wi(e.trailing_padding,"layered scene trailing padding");return{kind:t,template:Ze(e.template,"layered scene template"),effect:{layers:pi(i.layers,"layered scene layers")},speed_index:xt(e.speed_index,"layered scene speed index",0,255),raw_param:Yi(e.raw_param,"layered scene raw parameter"),...s===void 0?{}:{trailing_padding:s}}}default:{const{kind:i,...s}=e;return{kind:"opaque",source_kind:t,body:s}}}}function Wi(r,e){if(r!==void 0)return u(r,e,0,Ys)}function pr(r){const t=u(r.layout,"palette scene layout",0,1)===0?0:1,i=E(r.steps,"palette scene steps",255).map((l,c)=>{const p=f(l,`palette scene steps[${c}]`),g=t===0?(p.inline_colour!==null&&v(`palette scene steps[${c}].inline_colour must be null for layout 0`),null):xe(p.inline_colour,`palette scene steps[${c}].inline_colour`);return{value:u(p.value,`palette scene steps[${c}].value`,0,65535),colour:xe(p.colour,`palette scene steps[${c}].colour`),inline_colour:g}}),s=Pe(r.palette,"palette scene shared palette",255,!0);t===1&&s.length!==0&&v("palette scene layout 1 must not have a shared palette");let n;r.config_flags!==void 0&&(n=u(r.config_flags,"palette scene config flags",0,255),n&-9&&v("palette scene config flags must only set reserved config bits"));const a=Wi(r.trailing_padding,"palette scene trailing padding");return{kind:"scene_palette",template:Ze(r.template,"palette scene template"),layout:t,brightness_flag:B(r.brightness_flag,"palette scene brightness flag"),steps:i,palette:s,speed_index:xt(r.speed_index,"palette scene speed index",0,255),...n===void 0?{}:{config_flags:n},...a===void 0?{}:{trailing_padding:a}}}function Ee(r){return r.kind!=="opaque"?r:(he(r.body,"opaque content",we),{...r.body,kind:b(r.source_kind,"opaque source kind",x)})}function Rt(r){const e=f(r,"scene"),t=Oe(e.parameter_kind,"scene parameter kind");t!=="none"&&t!=="palette"&&t!=="layers"&&t!=="opaque"&&v("scene parameter kind is invalid");const i=e.speed===null?null:(()=>{const s=f(e.speed,"scene speed");return{option_count:u(s.option_count,"scene speed option count",1,256),default_index:u(s.default_index,"scene default speed",0,255)}})();return{scene_id:u(e.scene_id,"scene ID",0,65535),effect_id:u(e.effect_id,"scene effect ID",0,65535),category_id:u(e.category_id,"scene category ID",0,65535),category:b(e.category,"scene category",T),name:b(e.name,"scene name",T),variant:br(e.variant,"scene variant",x),display_name:b(e.display_name,"scene display name",T),scene_type:u(e.scene_type,"scene type",0,255),parameter_kind:t,speed:i}}function pi(r,e){return E(r,e,255).map((t,i)=>hr(t,`${e}[${i}]`))}function hr(r,e){const t=f(r,e),i=f(t.area,`${e}.area`),s=f(t.selection,`${e}.selection`),n=f(t.distribution,`${e}.distribution`);return{area:{start_tenths:u(i.start_tenths,`${e}.area.start_tenths`,0,15),width_tenths:u(i.width_tenths,`${e}.area.width_tenths`,0,15)},selection:{type:P(s.type,`${e}.selection.type`),param_1:P(s.param_1,`${e}.selection.param_1`),param_2:P(s.param_2,`${e}.selection.param_2`)},brightness_gradient:B(t.brightness_gradient,`${e}.brightness_gradient`),brightness_patterns:E(t.brightness_patterns,`${e}.brightness_patterns`,255).map((a,l)=>{const c=f(a,`${e}.brightness_patterns[${l}]`);return{scope_high:P(c.scope_high,"brightness scope high"),scope_low:P(c.scope_low,"brightness scope low"),order:P(c.order,"brightness order"),change_speed:P(c.change_speed,"brightness change speed"),brightest_retention:P(c.brightest_retention,"brightest retention"),darkest_retention:P(c.darkest_retention,"darkest retention")}}),distribution:{method:u(n.method,`${e}.distribution.method`,0,127),backwards:B(n.backwards,`${e}.distribution.backwards`)},colour_speed:P(t.colour_speed,`${e}.colour_speed`),colour_retention:P(t.colour_retention,`${e}.colour_retention`),palette:Pe(t.palette,`${e}.palette`,255,!0),selected_movement:hi(t.selected_movement,`${e}.selected_movement`),overall_movement:hi(t.overall_movement,`${e}.overall_movement`),priority:P(t.priority,`${e}.priority`),unknown_flags:Ji(t.unknown_flags,Zs,`${e}.unknown_flags`),excess:Yi(t.excess,`${e}.excess`)}}function hi(r,e){const t=f(r,e);return{enabled:B(t.enabled,`${e}.enabled`),enter_exit:B(t.enter_exit,`${e}.enter_exit`),direction:u(t.direction,`${e}.direction`,0,3),distance:P(t.distance,`${e}.distance`),speed:P(t.speed,`${e}.speed`),unknown_flags:Ji(t.unknown_flags,Js,`${e}.unknown_flags`)}}function Ze(r,e){const t=f(r,e);return{sku:b(t.sku,`${e}.sku`,x),scene_id:u(t.scene_id,`${e}.scene_id`,0,65535),effect_id:u(t.effect_id,`${e}.effect_id`,0,65535),catalogue_schema_version:u(t.catalogue_schema_version,`${e}.catalogue_schema_version`,1,Nt)}}function Pe(r,e,t,i=!1){const s=E(r,e,t);return!i&&s.length===0&&v(`${e} must not be empty`),s.map((n,a)=>xe(n,`${e}[${a}]`))}function xe(r,e){const t=E(r,e,3);return t.length!==3&&v(`${e} must contain three channels`),t.map(i=>u(i,`${e} channel`,0,255))}function mr(r,e){return r===null?null:xe(r,e)}function fr(r,e){return r===null?null:B(r,e)}function gr(r,e){const t=f(r,e);return{left:u(t.left,`${e}.left`,1,100),top:u(t.top,`${e}.top`,1,100),right:u(t.right,`${e}.right`,1,100),bottom:u(t.bottom,`${e}.bottom`,1,100)}}function H(r,e){return r!=="supported"&&r!=="unsupported"&&r!=="evidence_gap"&&v(`${e} is invalid`),r}function _t(r,e){return he(r,e,we),f(r,e)}function Me(r,e){return r===null?null:b(r,e,x)}function Bt(r,e){const t=b(r,e,Xs);return(!/T.*(?:Z|[+-]\d{2}:\d{2})$/.test(t)||Number.isNaN(Date.parse(t)))&&v(`${e} must be an ISO 8601 timestamp with a UTC offset`),t}function b(r,e,t){const i=Oe(r,e);return(i.length===0||i.length>t)&&v(`${e} must contain 1 to ${t} characters`),i}function br(r,e,t){const i=Oe(r,e);return i.length>t&&v(`${e} must not exceed ${t} characters`),i}function Yi(r,e){const t=Oe(r,e);return(t.length%2!==0||!/^[0-9a-f]*$/i.test(t))&&v(`${e} must be hexadecimal`),t}function Oe(r,e){return typeof r!="string"&&v(`${e} must be a string`),r}function vr(r){return typeof r=="string"&&_e.includes(r)?r:void 0}function B(r,e){return typeof r!="boolean"&&v(`${e} must be a boolean`),r}function u(r,e,t,i=Nt){return(typeof r!="number"||!Number.isSafeInteger(r)||r<t||r>i)&&v(`${e} must be an integer from ${t} to ${i}`),r}function Q(r,e,t){return u(r,e,t,Nt)}function U(r,e,t){const i=u(r,t,1);return i!==e&&v(`${t} is incompatible with this editor`),i}function xt(r,e,t,i){return r===null?null:u(r,e,t,i)}function P(r,e){return u(r,e,0,255)}function Ji(r,e,t){const i=P(r,t);return i&~e&&v(`${t} must only set reserved bits, not bits explicit fields carry`),i}function D(r,e,t){const i=Oe(r,t);return e.includes(i)||v(`${t} is invalid`),i}function f(r,e){return(typeof r!="object"||r===null||Array.isArray(r))&&v(`${e} must be an object`),r}function E(r,e,t){return Array.isArray(r)||v(`${e} must be an array`),r.length>t&&v(`${e} must not exceed ${t} items`),r}function V(r,e,t){const i=r.map(e);new Set(i).size!==i.length&&v(`${t} must be unique`)}function he(r,e,t,i=Ws){let s=0;const n=(l,c,p)=>{if(s+=1,s>i&&v(`${e} must not exceed ${i} JSON values`),p>li&&v(`${e} must not exceed ${li} nested levels`),!(l===null||typeof l=="boolean")){if(typeof l=="number"){(!Number.isFinite(l)||Number.isInteger(l)&&!Number.isSafeInteger(l))&&v(`${c} must be a finite JSON number`);return}if(typeof l=="string"){l.length>ct&&v(`${c} must not exceed ${ct} characters`);return}if(Array.isArray(l)){l.length>q&&v(`${c} must not exceed ${q} items`),l.forEach((g,y)=>n(g,`${c}[${y}]`,p+1));return}if(typeof l=="object"&&l!==null){const g=Object.entries(l);g.length>q&&v(`${c} must not exceed ${q} fields`),g.forEach(([y,N])=>{y.length>ct&&v(`${c} contains an oversized key`),n(N,`${c}.${y}`,p+1)});return}v(`${c} contains a non-JSON value`)}};n(r,e,0);const a=JSON.stringify(r);a===void 0&&v(`${e} must contain JSON values`),new TextEncoder().encode(a).byteLength>t&&v(`${e} must not exceed ${t} bytes`)}function v(r){throw new Error(`Malformed Effect Studio server payload: ${r}.`)}function yr(r){return r.api_version===Gs&&r.effect_schema_version===Fi&&r.compiler_version===zs}const ht="ha_govee_led_ble/editor";class $r{constructor(e){this.hass=e}async info(){return tr(await this.call("info"))}async devices(){const e=await this.call("devices");return ir(A(e,"devices"))}async customCatalogue(){const e=await this.call("custom/catalogue");return sr(A(e,"catalogue"))}async library(){return ui(await this.call("library/list"))}async item(e){const t=await this.call("library/get",{item_id:e});return Ge(A(t,"item"))}async createItem(e,t,i){const s=await this.call("library/create",{name:e,content:Ee(t),expected_library_revision:i});return{item:Ge(A(s,"item")),library_revision:mt(s)}}async updateItem(e,t,i,s){const n=await this.call("library/update",{item_id:e.id,name:t,content:Ee(i),expected_revision:e.revision,expected_library_revision:s});return{item:Ge(A(n,"item")),library_revision:mt(n)}}async deleteItem(e,t){const i=await this.call("library/delete",{item_id:e.id,expected_revision:e.revision,expected_library_revision:t});return mt(i)}async drafts(){const e=await this.call("draft/list");return lr(A(e,"drafts"))}async draft(e){const t=await this.call("draft/get",{draft_id:e});return pt(A(t,"draft"))}async createDraft(e,t,i,s){const n=await this.call("draft/create",{name:e,content:Ee(t),updated_at:new Date().toISOString(),selected_config_entry_id:i,...s?{base_item_id:s.id,base_item_revision:s.revision}:{}});return pt(A(n,"draft"))}async updateDraft(e,t,i,s){const n=await this.call("draft/update",{draft_id:e.id,expected_revision:e.revision,name:t,content:Ee(i),updated_at:new Date().toISOString(),selected_config_entry_id:s});return pt(A(n,"draft"))}async deleteDraft(e){await this.call("draft/delete",{draft_id:e.id,expected_revision:e.revision})}async applySaved(e,t){const i=await this.call("apply",{config_entry_id:e,item_id:t.id,revision:t.revision,updated_at:new Date().toISOString()});return $t(A(i,"deployment"))}async applySnapshot(e,t,i){const s=await this.call("apply_snapshot",{config_entry_id:e,name:t,content:Ee(i),updated_at:new Date().toISOString()});return $t(A(s,"deployment"))}async sceneCatalogue(e){const t=await this.call("scene/catalogue/list",{config_entry_id:e});return cr(A(t,"catalogue"))}sceneDetail(e,t,i){return this.call("scene/catalogue/get",{config_entry_id:e,scene_id:t,effect_id:i}).then(ur)}async applyScene(e,t,i){const s=await this.call("scene/apply",{config_entry_id:e,scene_id:t.scene_id,effect_id:t.effect_id,...i===null?{}:{speed_index:i}}),n=Rt(A(s,"scene")),a=A(s,"readback");if(a!=="scene_identity_only")throw new Error("Malformed Effect Studio server payload: scene Apply readback is invalid.");const l=A(s,"speed_index");if(l!==null&&(typeof l!="number"||!Number.isSafeInteger(l)||l<0||l>255))throw new Error("Malformed Effect Studio server payload: scene Apply speed is invalid.");return{scene:n,speed_index:l,readback:a}}subscribeLibrary(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(ui(i))}catch(s){t?.(mi(s))}},{type:`${ht}/library/subscribe`})}subscribeDeployments(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(dr(i))}catch(s){t?.(mi(s))}},{type:`${ht}/deployment/subscribe`})}call(e,t={}){return this.hass.callWS({type:`${ht}/${e}`,...t})}}function A(r,e){if(typeof r!="object"||r===null||Array.isArray(r))throw new Error("Malformed Effect Studio server payload: response must be an object.");if(!(e in r))throw new Error(`Malformed Effect Studio server payload: response is missing ${e}.`);return r[e]}function mt(r){const e=A(r,"library_revision");if(typeof e!="number"||!Number.isSafeInteger(e)||e<0)throw new Error("Malformed Effect Studio server payload: library revision is invalid.");return e}function mi(r){return r instanceof Error?r:new Error("Malformed Effect Studio server payload.")}var _r=Object.defineProperty,Zi=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&_r(e,t,s),s};const wt=17,Qi="ha_govee_led_ble/effect_studio/recent_colours",ze=[[255,69,58],[255,159,10],[255,214,10],[48,209,88],[99,230,226],[100,210,255],[10,132,255],[94,92,230],[191,90,242],[255,45,85],[172,142,104],[255,255,255],[174,174,178],[99,99,102],[28,28,30],[255,127,0],[139,0,255]];let ye=xr();class Ot extends I{constructor(){super(...arguments),this.colour=[255,255,255],this.disabled=!1}render(){return o`
    ...
    `}commit(e){wr(e),this.emit("colour-changed",e)}emit(e,t){this.colour=[...t],this.dispatchEvent(new CustomEvent(e,{detail:{colour:[...t]},bubbles:!0,composed:!0}))}static{this.styles=[M,k`
    :host {
      display: block;
    }
  ...
  `]}}K([h({attribute:!1})],F.prototype,"palette");K([h({type:Number})],F.prototype,"minColours");K([h({type:Number})],F.prototype,"maxColours");K([h({type:Boolean})],F.prototype,"disabled");K([h({type:Boolean})],F.prototype,"persistentPicker");K([h({type:Number})],F.prototype,"selectedIndex");K([h()],F.prototype,"ariaLabel");K([h()],F.prototype,"itemName");K([m()],F.prototype,"editingIndex");function fi(r){return r.charAt(0).toUpperCase()+r.slice(1)}customElements.get("govee-palette-editor")||customElements.define("govee-palette-editor",F);var Cr=Object.defineProperty,Ft=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Cr(e,t,s),s};class rt extends I{constructor(){super(...arguments),this.disabled=!1}updated(){if(this.content){if(this.content.kind==="h617a_single"||this.content.kind==="palette_diy"){const e=this.shadowRoot?.querySelector("select[data-single-variation]");e&&(e.value=String(this.content.variant));return}this.content.effects.forEach((e,t)=>{const i=this.effectFamily(e,!0),s=this.shadowRoot?.querySelector(`select[data-effect-index="${t}"]`),n=this.shadowRoot?.querySelector(`select[data-variation-index="${t}"]`);s&&(s.value=i?.id??`unknown:${e.family}`),n&&(n.value=String(e.variant))})}}render(){if(!this.content||!this.catalogue)return d;const e=(this.content.kind==="h617a_single"||this.content.kind==="palette_diy")&&this.effectFamily(this.content)?.rate==="sensitivity"?"Sensitivity":"Speed";return o`
  ...
  `]}}Ft([h({attribute:!1})],rt.prototype,"content");Ft([h({attribute:!1})],rt.prototype,"catalogue");Ft([h({type:Boolean})],rt.prototype,"disabled");customElements.get("govee-custom-effect-editor")||customElements.define("govee-custom-effect-editor",rt);const fe={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Sr=r=>(...e)=>({_$litDirective$:r,values:e});class Ar{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Ir=r=>r.strings===void 0,Pr={},Tr=(r,e=Pr)=>r._$AH=e;const gi=Sr(class extends Ar{constructor(r){if(super(r),r.type!==fe.PROPERTY&&r.type!==fe.ATTRIBUTE&&r.type!==fe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Ir(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===O||e===d)return e;const t=r.element,i=r.name;if(r.type===fe.PROPERTY){if(e===t[i])return O}else if(r.type===fe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return O}else if(r.type===fe.ATTRIBUTE&&t.getAttribute(i)===e+"")return O;return Tr(r),e}});var Lr=Object.defineProperty,nt=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Lr(e,t,s),s};const Dr=new Set(["rhythm","bloom","shiny"]),Mr=new Set(["point","gradient","relative_brightness","key_count","direction","segment_count","speed"]),ts=[{id:"clockwise",label:"Clockwise"},{id:"two_way",label:"Two-way"},{id:"counterclockwise",label:"Counterclockwise"}];class Fe extends I{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0,this.modeChanged=e=>{const t=e.target.value;this.updateContent(i=>(i.mode=t,i.parameters=Rr(i.parameters),i.calm=ft(t)?i.calm??!1:null,i))}}willUpdate(e){e.has("content")&&this.content?.colour!=null&&(this.lastFixedColour=ae(this.content.colour))}render(){if(!this.content)return d;const e=Nr(this.content.mode,this.catalogue),t=this.catalogue?.limits.music_sensitivity_min??0,i=this.catalogue?.limits.music_sensitivity_max??100,s=is(this.content.sensitivity,t,i),n=this.content.colour===null?"automatic":"fixed",a=this.content.colour??this.lastFixedColour??kt(0);return o`
      <section class="card">
        <div class="parameter-stack">
    ...
    `}renderFountainParameters(e){const t=Br(e,"direction","clockwise");return o`
      <label class="field">
    ...
    `]}}nt([h({attribute:!1})],Fe.prototype,"content");nt([h({attribute:!1})],Fe.prototype,"catalogue");nt([h({type:Boolean})],Fe.prototype,"disabled");nt([h({type:Boolean})],Fe.prototype,"showModeSelector");function Nr(r,e){const t=e?.music_modes.map(i=>({...i}))??[];return t.some(i=>i.id===r)?t:[{id:r,label:`Unknown mode ${r}`},...t]}function Rr(r){const e=Ut(r);for(const t of Mr)delete e[t];return e}function ft(r){return Dr.has(r)}function Ce(r,e,t,i,s){const n=r[e];return typeof n!="number"||!Number.isFinite(n)?t:is(n,i,s)}function bi(r,e,t){return typeof r[e]=="boolean"?r[e]:t}function Br(r,e,t){const i=r[e];return ts.some(s=>s.id===i)?i:t}function is(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}function gt(r){return{...r,colour:Or(r.colour),parameters:Ut(r.parameters)}}function Ut(r){return structuredClone(r)}function Or(r){return r===null?null:ae(r)}function ae(r){return[...r]}customElements.get("govee-music-profile-editor")||customElements.define("govee-music-profile-editor",Fe);var Fr=Object.defineProperty,ss=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Fr(e,t,s),s};class Ht extends I{constructor(){super(...arguments),this.colours=[],this.disabled=!1}render(){return o`
        ...
        <div class="parameter-list">
          ${e?o`
                <govee-segmented-control
                  .label=${"Speed"}
                  .value=${t}
                  .options=${Hr(e.option_count,e.default_index)}
                  .disabled=${!this.isAdmin}
  ...
  `]}}S([h({attribute:!1})],C.prototype,"api");S([h({attribute:!1})],C.prototype,"device");S([h({attribute:!1})],C.prototype,"library");S([h({type:Boolean})],C.prototype,"isAdmin");S([m()],C.prototype,"catalogue");S([m()],C.prototype,"category");S([m()],C.prototype,"search");S([m()],C.prototype,"selectedScene");S([m()],C.prototype,"selectedItem");S([m()],C.prototype,"content");S([m()],C.prototype,"name");S([m()],C.prototype,"speedIndex");S([m()],C.prototype,"loading");S([m()],C.prototype,"saving");S([m()],C.prototype,"applying");S([m()],C.prototype,"editingCopy");S([m()],C.prototype,"notice");S([m()],C.prototype,"error");function ge(r){return`builtin:${r.scene_id}:${r.effect_id}`}function Hr(r,e){return Array.from({length:r},(t,i)=>({value:i,label:qr(i,e)}))}function qr(r,e){const t=r-e;if(t===0)return"Default";const i=Math.abs(t);return`${i} ${i===1?"step":"steps"} ${t<0?"lower":"higher"}`}function Vr(r){return{...r,template:{...r.template},steps:r.steps.map(e=>({...e,colour:[...e.colour],inline_colour:e.inline_colour===null?null:[...e.inline_colour]})),palette:r.palette.map(e=>[...e])}}customElements.get("govee-scene-browser")||customElements.define("govee-scene-browser",C);var Kr=Object.defineProperty,qt=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Kr(e,t,s),s};const jr=[{value:"movie",label:"Movie"},{value:"game",label:"Game"}],Gr=[{value:!0,label:"Full screen"},{value:!1,label:"Part screen"}],zr=[{key:"left",label:"Left"},{key:"top",label:"Top"},{key:"right",label:"Right"},{key:"bottom",label:"Bottom"}];function Y(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}function Xr(r){return{...r}}function vi(r){return{...r,relative_brightness:Xr(r.relative_brightness)}}function rs(r){const e=[r.left,r.top,r.right,r.bottom];return e.every(t=>t===e[0])?e[0]:void 0}function Wr(r){const e=rs(r);return e!==void 0?e:Y((r.left+r.top+r.right+r.bottom)/4,1,100)}function Yr(r){const e=Y(r,1,100);return{left:e,top:e,right:e,bottom:e}}class at extends I{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0}render(){if(!this.content)return o`
        <section class="card empty-state" role="status">
      ...
      <div class="editor-grid">
        <section class="card">
          <div class="parameter-stack">
            ${this.showModeSelector?this.renderSegmentedField("Mode",this.content.mode,jr,s=>this.updateContent(n=>{n.mode=s})):d}
            ${this.renderSegmentedField("Capture area",this.content.full_screen,Gr,s=>this.updateContent(n=>{n.full_screen=s}))}
            ${this.renderCheckboxField("Sound effects",this.content.sound_effects,s=>this.updateContent(n=>{n.sound_effects=s}))}
            ${this.content.sound_effects?this.renderRangeField("Softness",this.content.sound_effects_softness,1,100,String(this.content.sound_effects_softness),s=>this.updateContent(n=>{n.sound_effects_softness=Y(s,1,100)})):d}
        ...
        <section class="card">
          ...
          <div class="parameter-stack">
            ${this.renderRangeField("Saturation",this.content.saturation,0,100,`${this.content.saturation}%`,s=>this.updateContent(n=>{n.saturation=Y(s,0,100)}))}
        ...
        <section class="card brightness-card">
          ...
          <div class="parameter-stack">
            ${this.renderRangeField("Uniform brightness",i,1,100,`${i}%`,s=>this.updateContent(n=>{n.relative_brightness=Yr(s)}),t?"relative-brightness-note":void 0)}
            ${t?o`
      ...
      <label class="range-field white-balance-field">
        ...
        <div class="slider-with-endpoints">
          <input
            ...
            min="1"
            max="20"
            .value=${String(Y(e,1,20))}
            aria-label="White balance"
            ?disabled=${this.disabled}
            @input=${t=>this.updateContent(i=>{i.white_balance_position=Y(Number(t.target.value),1,20)})}
          />
    ...
    `}updateRelativeBrightnessEdge(e,t){this.updateContent(i=>{i.relative_brightness[e]=Y(t,1,100)})}updateContent(e){if(!this.content)return;const t=vi(this.content);e(t),this.emitContent(t)}emitContent(e){this.dispatchEvent(new CustomEvent("content-changed",{detail:{content:vi(e)},bubbles:!0,composed:!0}))}static{this.styles=[M,de,ee,k`
      :host {
        display: block;
        color: var(--primary-text-color);
      }
    ...
    `}renderCurrentCustomEditor(){return W(this.content)?this.content.kind==="h617a_painted"?this.renderPaintedEditor():this.renderPaletteEffectEditor():this.content.kind==="palette_diy"?this.renderPaletteEffectEditor():this.content.kind==="music_profile"?this.renderMusicProfileEditor():Se(this.content)?this.renderAdvancedEditor():this.content.kind==="opaque"?this.renderOpaqueEditor(this.content):d}renderVideo(){const e=this.modelCatalogue;if(!e||!this.videoAvailable)return d;const t=this.library.items.filter(i=>i.kind==="video_profile"&&this.libraryItemAvailable(i)).sort((i,s)=>Ie(i.name,s.name));return o`
    ...
    `}selectCustomEffectEntry(e){if(e.kind==="saved"){this.selectItem(e.item.id);return}if(e.kind==="advanced"){this.newEffect("advanced",void 0,{name:e.label,content:lt(),selectionIdentity:e.key,templateLabel:e.label}),this.customTemplateSelection=e.key;return}const t=this.modelCatalogue;if(t){if(e.kind==="music"){if(e.mode){this.openMusicTemplate(e.mode,e.label);return}if(e.family===void 0||e.variant===void 0)return;const i=this.selectedModel==="H617A"?{...G("h617a_single",t),family:e.family,variant:e.variant}:Ve(t,this.selectedModel,e.family,e.variant);this.openEditableTemplate(e.label,i,e.key);return}if(e.kind==="paint"){this.newEffect("h617a_painted",void 0,{name:e.label,content:ve(),selectionIdentity:e.key,templateLabel:e.label});return}if(e.kind==="single"){if(this.selectedModel==="H617A"){const i=G("h617a_single",t);this.newEffect("h617a_single",void 0,{name:e.label,content:{...i,family:e.family,variant:e.variant},selectionIdentity:e.key,templateLabel:e.label})}else this.openEditableTemplate(e.label,Ve(t,this.selectedModel,e.family,e.variant),e.key);return}this.newEffect("h617a_multi",void 0,{name:e.label,content:G("h617a_multi",t),selectionIdentity:e.key,templateLabel:e.label})}}openEditableTemplate(e,t,i){this.beginEditorTransition(),this.currentItem=void 0,this.templateSourceLabel=e,this.customCopyStarted=!0,this.customTemplateSelection=i,this.name=e,this.content=Ke(t),this.savedBaseline=void 0,this.notice=void 0}openMusicTemplate(e,t){const i=this.selectedModel;i!=="H617A"&&i!=="H6199"||this.openEditableTemplate(t,{kind:"music_profile",model:i,mode:e,sensitivity:i==="H6199"?100:99,colour:null,calm:["rhythm","bloom","shiny"].includes(e)?!1:null,parameters:{}},`template:music:${e}`)}renderAdvancedEditor(){if(!Se(this.content))return d;const e=this.content.kind==="scene_layered";return o`
      ...
      <govee-advanced-effect-editor
        ...
        @content-changed=${t=>{Se(this.content)&&(this.content=sn(this.content,t.detail.content))}}
      ></govee-advanced-effect-editor>
    ...
    `}renderDeployment(e){const t=this.devices.find(s=>s.config_entry_id===e.config_entry_id)?.display_name??"device";let i;switch(e.phase){case"compiling":case"pending":i=`Preparing to apply to ${t}.`;break;case"uploading":i=`Applying to ${t}: ${e.progress_current} of ${e.progress_total}.`;break;case"activating":i=`Activating the selected effect on ${t}.`;break;case"verifying":i=`Checking the selected effect on ${t}.`;break;case"confirmed":i=`Applied to ${t}. The selected custom-effect code was confirmed, but exact effect contents cannot be read back.`;break;case"uncertain":i=`The final state of ${t} is uncertain. The selected effect could not be confirmed.`;break;case"recovering":i=`Restoring the previous state on ${t} after the apply failed.`;break;case"unknown":i=`Applied to ${t}, but the selected effect could not be confirmed.`;break;case"interrupted":i=`Apply to ${t} was interrupted by a Home Assistant restart.`;break;case"failed":i=`Apply to ${t} failed.`;break}return o`
      <div
