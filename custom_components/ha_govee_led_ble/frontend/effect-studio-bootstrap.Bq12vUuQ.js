...
`;var Ts=Object.defineProperty,de=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ts(e,t,s),s};class te extends I{constructor(){super(...arguments),this.items=[],this.ariaLabel="Items",this.itemRole="button",this.addLabel="Add item",this.addDisabled=!1,this.reorderDisabled=!1,this.pointerX=0,this.pointerY=0,this.pointerMoved=!1,this.suppressClick=!1}render(){const e=this.itemRole==="tab";return o`
  ...
  `]}}de([h({attribute:!1})],te.prototype,"items");de([h({attribute:!1})],te.prototype,"activeIndex");de([h()],te.prototype,"ariaLabel");de([h()],te.prototype,"itemRole");de([h()],te.prototype,"addLabel");de([h({type:Boolean})],te.prototype,"addDisabled");de([h({type:Boolean})],te.prototype,"reorderDisabled");customElements.get("govee-reorderable-strip")||customElements.define("govee-reorderable-strip",te);var Ds=Object.defineProperty,it=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ds(e,t,s),s};class Oe extends I{constructor(){super(...arguments),this.label="",this.options=[],this.value="",this.disabled=!1}render(){return o`
    ...
    `]}}it([h()],Oe.prototype,"label");it([h({attribute:!1})],Oe.prototype,"options");it([h({attribute:!1})],Oe.prototype,"value");it([h({type:Boolean})],Oe.prototype,"disabled");customElements.get("govee-segmented-control")||customElements.define("govee-segmented-control",Oe);var Ls=Object.defineProperty,xe=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ls(e,t,s),s};class ce extends I{constructor(){super(...arguments),this.label="",this.value=0,this.minimum=0,this.maximum=100,this.step=1,this.disabled=!1}render(){const e=Ms(this.value,this.minimum,this.maximum);return o`
  ...
  `]}}Ot([h({attribute:!1})],rt.prototype,"content");Ot([h({attribute:!1})],rt.prototype,"catalogue");Ot([h({type:Boolean})],rt.prototype,"disabled");customElements.get("govee-custom-effect-editor")||customElements.define("govee-custom-effect-editor",rt);const me={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},_r=r=>(...e)=>({_$litDirective$:r,values:e});class xr{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const wr=r=>r.strings===void 0,kr={},Er=(r,e=kr)=>r._$AH=e;const mi=_r(class extends xr{constructor(r){if(super(r),r.type!==me.PROPERTY&&r.type!==me.ATTRIBUTE&&r.type!==me.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!wr(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===R||e===d)return e;const t=r.element,i=r.name;if(r.type===me.PROPERTY){if(e===t[i])return R}else if(r.type===me.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return R}else if(r.type===me.ATTRIBUTE&&t.getAttribute(i)===e+"")return R;return Er(r),e}});var Cr=Object.defineProperty,nt=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Cr(e,t,s),s};const Sr=new Set(["rhythm","bloom","shiny"]),Ar=new Set(["point","gradient","relative_brightness","key_count","direction","segment_count","speed"]),Qi=[{id:"clockwise",label:"Clockwise"},{id:"two_way",label:"Two-way"},{id:"counterclockwise",label:"Counterclockwise"}];class Fe extends I{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0,this.modeChanged=e=>{const t=e.target.value;this.updateContent(i=>(i.mode=t,i.parameters=Pr(i.parameters),i.calm=mt(t)?i.calm??!1:null,i))}}willUpdate(e){e.has("content")&&this.content?.colour!=null&&(this.lastFixedColour=ne(this.content.colour))}render(){if(!this.content)return d;const e=Ir(this.content.mode,this.catalogue),t=this.catalogue?.limits.music_sensitivity_min??0,i=this.catalogue?.limits.music_sensitivity_max??100,s=es(this.content.sensitivity,t,i),n=this.content.colour===null?"automatic":"fixed",a=this.content.colour??this.lastFixedColour??wt(0);return o`
      <section class="card">
        <div class="parameter-stack">
    ...
    `}renderSegmentedField(e,t,i,s){return o`
      ...
      ></govee-segmented-control>
    `}renderRangeField(e,t,i,s,n){return o`
      <govee-slider-control
        .label=${e}
        .value=${t}
        .minimum=${i}
    ...
    `}renderDayAndNightParameters(e){const t=Se(e,"segment_count",1,1,15),i=Se(e,"speed",10,0,100),s=fi(e,"gradient",!1);return o`
      ${this.renderRangeField("Segment count",t,1,15,n=>this.updateParameter("segment_count",n))}
