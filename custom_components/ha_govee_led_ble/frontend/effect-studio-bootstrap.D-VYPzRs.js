const je=globalThis,St=je.ShadowRoot&&(je.ShadyCSS===void 0||je.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,At=Symbol(),Kt=new WeakMap;let Ci=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==At)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(St&&e===void 0){const i=t!==void 0&&t.length===1;i&&(e=Kt.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&Kt.set(t,e))}return e}toString(){return this.cssText}};const ds=r=>new Ci(typeof r=="string"?r:r+"",void 0,At),k=(r,...e)=>{const t=r.length===1?r[0]:e.reduce((i,s,n)=>i+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+r[n+1],r[0]);return new Ci(t,r,At)},cs=(r,e)=>{if(St)r.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(const t of e){const i=document.createElement("style"),s=je.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=t.cssText,r.appendChild(i)}},jt=St?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let t="";for(const i of e.cssRules)t+=i.cssText;return ds(t)})(r):r;const{is:us,defineProperty:ps,getOwnPropertyDescriptor:hs,getOwnPropertyNames:ms,getOwnPropertySymbols:fs,getPrototypeOf:gs}=Object,et=globalThis,Gt=et.trustedTypes,bs=Gt?Gt.emptyScript:"",vs=et.reactiveElementPolyfillSupport,Ae=(r,e)=>r,Xe={toAttribute(r,e){switch(e){case Boolean:r=r?bs:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let t=r;switch(e){case Boolean:t=r!==null;break;case Number:t=r===null?null:Number(r);break;case Object:case Array:try{t=JSON.parse(r)}catch{t=null}}return t}},It=(r,e)=>!us(r,e),zt={attribute:!0,type:String,converter:Xe,reflect:!1,useDefault:!1,hasChanged:It};Symbol.metadata??=Symbol("metadata"),et.litPropertyMetadata??=new WeakMap;let be=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=zt){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){const i=Symbol(),s=this.getPropertyDescriptor(e,i,t);s!==void 0&&ps(this.prototype,e,s)}}static getPropertyDescriptor(e,t,i){const{get:s,set:n}=hs(this.prototype,e)??{get(){return this[t]},set(a){this[t]=a}};return{get:s,set(a){const l=s?.call(this);n?.call(this,a),this.requestUpdate(e,l,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??zt}static _$Ei(){if(this.hasOwnProperty(Ae("elementProperties")))return;const e=gs(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(Ae("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(Ae("properties"))){const t=this.properties,i=[...ms(t),...fs(t)];for(const s of i)this.createProperty(s,t[s])}const e=this[Symbol.metadata];if(e!==null){const t=litPropertyMetadata.get(e);if(t!==void 0)for(const[i,s]of t)this.elementProperties.set(i,s)}this._$Eh=new Map;for(const[t,i]of this.elementProperties){const s=this._$Eu(t,i);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const t=[];if(Array.isArray(e)){const i=new Set(e.flat(1/0).reverse());for(const s of i)t.unshift(jt(s))}else e!==void 0&&t.push(jt(e));return t}static _$Eu(e,t){const i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){const e=new Map,t=this.constructor.elementProperties;for(const i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return cs(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){const i=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,i);if(s!==void 0&&i.reflect===!0){const n=(i.converter?.toAttribute!==void 0?i.converter:Xe).toAttribute(t,i.type);this._$Em=e,n==null?this.removeAttribute(s):this.setAttribute(s,n),this._$Em=null}}_$AK(e,t){const i=this.constructor,s=i._$Eh.get(e);if(s!==void 0&&this._$Em!==s){const n=i.getPropertyOptions(s),a=typeof n.converter=="function"?{fromAttribute:n.converter}:n.converter?.fromAttribute!==void 0?n.converter:Xe;this._$Em=s;const l=a.fromAttribute(t,n.type);this[s]=l??this._$Ej?.get(s)??l,this._$Em=null}}requestUpdate(e,t,i,s=!1,n){if(e!==void 0){const a=this.constructor;if(s===!1&&(n=this[e]),i??=a.getPropertyOptions(e),!((i.hasChanged??It)(n,t)||i.useDefault&&i.reflect&&n===this._$Ej?.get(e)&&!this.hasAttribute(a._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:s,wrapped:n},a){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,a??t??this[e]),n!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(const[s,n]of this._$Ep)this[s]=n;this._$Ep=void 0}const i=this.constructor.elementProperties;if(i.size>0)for(const[s,n]of i){const{wrapped:a}=n,l=this[s];a!==!0||this._$AL.has(s)||l===void 0||this.C(s,void 0,n,l)}}let e=!1;const t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};be.elementStyles=[],be.shadowRootOptions={mode:"open"},be[Ae("elementProperties")]=new Map,be[Ae("finalized")]=new Map,vs?.({ReactiveElement:be}),(et.reactiveElementVersions??=[]).push("2.1.2");const Pt=globalThis,Xt=r=>r,Ye=Pt.trustedTypes,Yt=Ye?Ye.createPolicy("lit-html",{createHTML:r=>r}):void 0,Si="$lit$",J=`lit$${Math.random().toFixed(9).slice(2)}$`,Ai="?"+J,ys=`<${Ai}>`,le=document,Te=()=>le.createComment(""),De=r=>r===null||typeof r!="object"&&typeof r!="function",Tt=Array.isArray,$s=r=>Tt(r)||typeof r?.[Symbol.iterator]=="function",ot=`[ 	
\f\r]`,ke=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Wt=/-->/g,Jt=/>/g,re=RegExp(`>|${ot}(?:([^\\s"'>=/]+)(${ot}*=${ot}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Zt=/'/g,Qt=/"/g,Ii=/^(?:script|style|textarea|title)$/i,_s=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),o=_s(1),F=Symbol.for("lit-noChange"),d=Symbol.for("lit-nothing"),ei=new WeakMap,oe=le.createTreeWalker(le,129);function Pi(r,e){if(!Tt(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Yt!==void 0?Yt.createHTML(e):e}const xs=(r,e)=>{const t=r.length-1,i=[];let s,n=e===2?"<svg>":e===3?"<math>":"",a=ke;for(let l=0;l<t;l++){const c=r[l];let p,g,y=-1,N=0;for(;N<c.length&&(a.lastIndex=N,g=a.exec(c),g!==null);)N=a.lastIndex,a===ke?g[1]==="!--"?a=Wt:g[1]!==void 0?a=Jt:g[2]!==void 0?(Ii.test(g[2])&&(s=RegExp("</"+g[2],"g")),a=re):g[3]!==void 0&&(a=re):a===re?g[0]===">"?(a=s??ke,y=-1):g[1]===void 0?y=-2:(y=a.lastIndex-g[2].length,p=g[1],a=g[3]===void 0?re:g[3]==='"'?Qt:Zt):a===Qt||a===Zt?a=re:a===Wt||a===Jt?a=ke:(a=re,s=void 0);const j=a===re&&r[l+1].startsWith("/>")?" ":"";n+=a===ke?c+ys:y>=0?(i.push(p),c.slice(0,y)+Si+c.slice(y)+J+j):c+J+(y===-2?l:j)}return[Pi(r,n+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]};class Le{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let n=0,a=0;const l=e.length-1,c=this.parts,[p,g]=xs(e,t);if(this.el=Le.createElement(p,i),oe.currentNode=this.el.content,t===2||t===3){const y=this.el.content.firstChild;y.replaceWith(...y.childNodes)}for(;(s=oe.nextNode())!==null&&c.length<l;){if(s.nodeType===1){if(s.hasAttributes())for(const y of s.getAttributeNames())if(y.endsWith(Si)){const N=g[a++],j=s.getAttribute(y).split(J),He=/([.?@])?(.*)/.exec(N);c.push({type:1,index:n,name:He[2],strings:j,ctor:He[1]==="."?ks:He[1]==="?"?Es:He[1]==="@"?Cs:tt}),s.removeAttribute(y)}else y.startsWith(J)&&(c.push({type:6,index:n}),s.removeAttribute(y));if(Ii.test(s.tagName)){const y=s.textContent.split(J),N=y.length-1;if(N>0){s.textContent=Ye?Ye.emptyScript:"";for(let j=0;j<N;j++)s.append(y[j],Te()),oe.nextNode(),c.push({type:2,index:++n});s.append(y[N],Te())}}}else if(s.nodeType===8)if(s.data===Ai)c.push({type:2,index:n});else{let y=-1;for(;(y=s.data.indexOf(J,y+1))!==-1;)c.push({type:7,index:n}),y+=J.length-1}n++}}static createElement(e,t){const i=le.createElement("template");return i.innerHTML=e,i}}function $e(r,e,t=r,i){if(e===F)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl;const n=De(e)?void 0:e._$litDirective$;return s?.constructor!==n&&(s?._$AO?.(!1),n===void 0?s=void 0:(s=new n(r),s._$AT(r,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=$e(r,s._$AS(r,e.values),s,i)),e}class ws{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??le).importNode(t,!0);oe.currentNode=s;let n=oe.nextNode(),a=0,l=0,c=i[0];for(;c!==void 0;){if(a===c.index){let p;c.type===2?p=new Re(n,n.nextSibling,this,e):c.type===1?p=new c.ctor(n,c.name,c.strings,this,e):c.type===6&&(p=new Ss(n,this,e)),this._$AV.push(p),c=i[++l]}a!==c?.index&&(n=oe.nextNode(),a++)}return oe.currentNode=le,s}p(e){let t=0;for(const i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Re{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=d,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=$e(this,e,t),De(e)?e===d||e==null||e===""?(this._$AH!==d&&this._$AR(),this._$AH=d):e!==this._$AH&&e!==F&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):$s(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==d&&De(this._$AH)?this._$AA.nextSibling.data=e:this.T(le.createTextNode(e)),this._$AH=e}$(e){const{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=Le.createElement(Pi(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{const n=new ws(s,this),a=n.u(this.options);n.p(t),this.T(a),this._$AH=n}}_$AC(e){let t=ei.get(e.strings);return t===void 0&&ei.set(e.strings,t=new Le(e)),t}k(e){Tt(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,s=0;for(const n of e)s===t.length?t.push(i=new Re(this.O(Te()),this.O(Te()),this,this.options)):i=t[s],i._$AI(n),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){const i=Xt(e).nextSibling;Xt(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}}class tt{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,n){this.type=1,this._$AH=d,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=n,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=d}_$AI(e,t=this,i,s){const n=this.strings;let a=!1;if(n===void 0)e=$e(this,e,t,0),a=!De(e)||e!==this._$AH&&e!==F,a&&(this._$AH=e);else{const l=e;let c,p;for(e=n[0],c=0;c<n.length-1;c++)p=$e(this,l[i+c],t,c),p===F&&(p=this._$AH[c]),a||=!De(p)||p!==this._$AH[c],p===d?e=d:e!==d&&(e+=(p??"")+n[c+1]),this._$AH[c]=p}a&&!s&&this.j(e)}j(e){e===d?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ks extends tt{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===d?void 0:e}}class Es extends tt{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==d)}}class Cs extends tt{constructor(e,t,i,s,n){super(e,t,i,s,n),this.type=5}_$AI(e,t=this){if((e=$e(this,e,t,0)??d)===F)return;const i=this._$AH,s=e===d&&i!==d||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,n=e!==d&&(i===d||s);s&&this.element.removeEventListener(this.name,this,i),n&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}}class Ss{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){$e(this,e)}}const As=Pt.litHtmlPolyfillSupport;As?.(Le,Re),(Pt.litHtmlVersions??=[]).push("3.3.3");const Is=(r,e,t)=>{const i=t?.renderBefore??e;let s=i._$litPart$;if(s===void 0){const n=t?.renderBefore??null;i._$litPart$=s=new Re(e.insertBefore(Te(),n),n,void 0,t??{})}return s._$AI(r),s};const Dt=globalThis;let I=class extends be{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Is(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return F}};I._$litElement$=!0,I.finalized=!0,Dt.litElementHydrateSupport?.({LitElement:I});const Ps=Dt.litElementPolyfillSupport;Ps?.({LitElement:I});(Dt.litElementVersions??=[]).push("4.2.2");const Ts={attribute:!0,type:String,converter:Xe,reflect:!1,hasChanged:It},Ds=(r=Ts,e,t)=>{const{kind:i,metadata:s}=t;let n=globalThis.litPropertyMetadata.get(s);if(n===void 0&&globalThis.litPropertyMetadata.set(s,n=new Map),i==="setter"&&((r=Object.create(r)).wrapped=!0),n.set(t.name,r),i==="accessor"){const{name:a}=t;return{set(l){const c=e.get.call(this);e.set.call(this,l),this.requestUpdate(a,c,r,!0,l)},init(l){return l!==void 0&&this.C(a,void 0,r,l),l}}}if(i==="setter"){const{name:a}=t;return function(l){const c=this[a];e.call(this,l),this.requestUpdate(a,c,r,!0,l)}}throw Error("Unsupported decorator location: "+i)};function h(r){return(e,t)=>typeof t=="object"?Ds(r,e,t):((i,s,n)=>{const a=s.hasOwnProperty(n);return s.constructor.createProperty(n,i),a?Object.getOwnPropertyDescriptor(s,n):void 0})(r,e,t)}function m(r){return h({...r,state:!0,attribute:!1})}const M=k`
  :host {
...
`;var Ls=Object.defineProperty,ce=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ls(e,t,s),s};class te extends I{constructor(){super(...arguments),this.items=[],this.ariaLabel="Items",this.itemRole="button",this.addLabel="Add item",this.addDisabled=!1,this.reorderDisabled=!1,this.pointerX=0,this.pointerY=0,this.pointerMoved=!1,this.suppressClick=!1}render(){const e=this.itemRole==="tab";return o`
    ...
    `}focusItem(e){this.updateComplete.then(()=>{this.shadowRoot?.querySelectorAll(".item")[e]?.focus()})}itemClicked(e){if(this.suppressClick){this.suppressClick=!1;return}this.dispatchEvent(new CustomEvent("item-selected",{detail:{index:e},bubbles:!0,composed:!0}))}addClicked(){this.dispatchEvent(new CustomEvent("item-added",{bubbles:!0,composed:!0}))}dragStarted(e,t){this.reorderDisabled||(this.draggedIndex=e,t.dataTransfer?.setData("text/plain",String(e)))}dropped(e,t){t.preventDefault(),this.draggedIndex!==void 0&&(this.reorder(this.draggedIndex,e),this.draggedIndex=void 0)}keyPressed(e,t){if(t.key!=="ArrowLeft"&&t.key!=="ArrowRight")return;t.preventDefault();const i=e+(t.key==="ArrowLeft"?-1:1);if(!(i<0||i>=this.items.length)){if(this.reorderDisabled){this.itemRole==="tab"&&(this.itemClicked(i),this.focusItem(i));return}this.reorder(e,i,!0)}}pointerStarted(e,t){this.reorderDisabled||t.pointerType==="mouse"||t.target.closest(".strip-popover")||(this.pointerId=t.pointerId,this.pointerIndex=e,this.pointerX=t.clientX,this.pointerY=t.clientY,this.pointerMoved=!1,t.currentTarget.setPointerCapture(t.pointerId))}pointerMovedOver(e){if(e.pointerId!==this.pointerId||this.pointerIndex===void 0)return;const t=e.clientX-this.pointerX,i=e.clientY-this.pointerY;if(!this.pointerMoved){if(Math.abs(i)>Math.abs(t)||Math.abs(t)<10)return;this.pointerMoved=!0}e.preventDefault();const s=this.shadowRoot?.elementFromPoint(e.clientX,e.clientY)?.closest("[data-item-index]"),n=Number(s?.dataset.itemIndex);!Number.isInteger(n)||n===this.pointerIndex||(this.reorder(this.pointerIndex,n),this.pointerIndex=n)}pointerFinished(e){if(e.pointerId!==this.pointerId)return;const t=e.currentTarget;t.hasPointerCapture(e.pointerId)&&t.releasePointerCapture(e.pointerId),this.suppressClick=this.pointerMoved,this.pointerId=void 0,this.pointerIndex=void 0,this.pointerMoved=!1}reorder(e,t,i=!1){this.reorderDisabled||e===t||(this.dispatchEvent(new CustomEvent("items-reordered",{detail:{from:e,to:t},bubbles:!0,composed:!0})),i&&this.focusItem(t))}static{this.styles=[M,k`
    :host {
      display: block;
    }
  ...
  `]}}ce([h({attribute:!1})],te.prototype,"items");ce([h({attribute:!1})],te.prototype,"activeIndex");ce([h()],te.prototype,"ariaLabel");ce([h()],te.prototype,"itemRole");ce([h()],te.prototype,"addLabel");ce([h({type:Boolean})],te.prototype,"addDisabled");ce([h({type:Boolean})],te.prototype,"reorderDisabled");customElements.get("govee-reorderable-strip")||customElements.define("govee-reorderable-strip",te);var Ms=Object.defineProperty,it=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ms(e,t,s),s};class Be extends I{constructor(){super(...arguments),this.label="",this.options=[],this.value="",this.disabled=!1}render(){return o`
    ...
    `}select(e){this.disabled||e===this.value||this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:e},bubbles:!0,composed:!0}))}static{this.styles=[M,ee,k`
      :host {
        display: block;
      }
    `]}}it([h()],Be.prototype,"label");it([h({attribute:!1})],Be.prototype,"options");it([h({attribute:!1})],Be.prototype,"value");it([h({type:Boolean})],Be.prototype,"disabled");customElements.get("govee-segmented-control")||customElements.define("govee-segmented-control",Be);var Ns=Object.defineProperty,ue=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ns(e,t,s),s};class ie extends I{constructor(){super(...arguments),this.label="",this.value=0,this.minimum=0,this.maximum=100,this.step=1,this.disabled=!1,this.showValue=!1}render(){const e=Rs(this.value,this.minimum,this.maximum);return o`
    ...
    `}inputChanged(e){this.dispatchEvent(new CustomEvent("value-changed",{detail:{value:Number(e.target.value)},bubbles:!0,composed:!0}))}static{this.styles=[M,ee,k`
      :host {
        display: block;
      }
    ...
    `]}}ue([h()],ie.prototype,"label");ue([h({type:Number})],ie.prototype,"value");ue([h({type:Number})],ie.prototype,"minimum");ue([h({type:Number})],ie.prototype,"maximum");ue([h({type:Number})],ie.prototype,"step");ue([h({type:Boolean})],ie.prototype,"disabled");ue([h({type:Boolean})],ie.prototype,"showValue");function Rs(r,e,t){return Math.min(t,Math.max(e,r))}customElements.get("govee-slider-control")||customElements.define("govee-slider-control",ie);function Z(r){return r.map(e=>[...e])}function w(r){return`#${r.map(e=>e.toString(16).padStart(2,"0")).join("")}`}function ti(r){return[Number.parseInt(r.slice(1,3),16),Number.parseInt(r.slice(3,5),16),Number.parseInt(r.slice(5,7),16)]}function Ie(r,e){return r.localeCompare(e,"en-AU",{sensitivity:"base"})}function We(r,e,t){return r===void 0||e===t?r:r===e?t:e<t&&r>e&&r<=t?r-1:t<e&&r>=t&&r<e?r+1:r}function L(r){return r instanceof Error||typeof r=="object"&&r!==null&&"message"in r&&typeof r.message=="string"?r.message:"An unexpected error occurred."}function vt(r){if(typeof r=="object"&&r!==null&&"code"in r&&typeof r.code=="string")return r.code}var Bs=Object.defineProperty,pe=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Bs(e,t,s),s};const me=5,ii=8,si=15,Ni=[1,2,0,3],Ri=[0,1,2,3],Os={0:"Segment",1:"Continuous",2:"Random",3:"Custom"},Fs={0:"Brightest to darkest",1:"Brightest, darkest, brightest",2:"Darkest to brightest",3:"Darkest, brightest, darkest"},ri={0:"Forward",1:"Backward",2:"Forward and back",3:"Back and forward"};class se extends I{constructor(){super(...arguments),this.disabled=!1,this.segmentCount=si,this.activeLayerIndex=0,this.activePatternIndex=0,this.movementAnnouncement=""}willUpdate(e){if(!(!e.has("content")||!this.content)){if(this.content.layers.length===0){this.activeLayerIndex=0,this.activePatternIndex=0;return}if(this.activeLayerIndex=R(this.activeLayerIndex,0,this.content.layers.length-1),this.activeLayer.brightness_patterns.length===0){this.activePatternIndex=0;return}this.activePatternIndex=R(this.activePatternIndex,0,this.activeLayer.brightness_patterns.length-1)}}render(){if(!this.content)return d;if(this.content.layers.length===0)return this.renderEmptyLayers();const e=this.activeLayer,t=this.content.layers.map((i,s)=>({key:`layer-${s}`,label:`Layer ${s+1}`,ariaLabel:`Layer ${s+1}. Drag to reorder or use arrow keys.`,id:`advanced-layer-tab-${s}`,ariaControls:"advanced-layer-panel"}));return o`
    ...
    `}get activeLayer(){return this.content.layers[this.activeLayerIndex]}renderAppliedArea(e){const t=e.area.start_tenths>=0&&e.area.start_tenths<=9&&e.area.width_tenths>=1&&e.area.width_tenths<=10-e.area.start_tenths,i=R(e.area.start_tenths,0,9),s=i+e.area.width_tenths,n=Number.isInteger(this.segmentCount)&&this.segmentCount>0?this.segmentCount:si,a=w(e.palette[0]??[47,111,237]);return o`
    ...
    `}areaPointerStarted(e,t,i,s){if(this.disabled)return;const n=this.shadowRoot?.querySelector(".area-track");if(!n)return;const a=n.getBoundingClientRect();if(a.width<=0)return;const l=s.currentTarget,c=e==="start"?t:e==="end"?i:t;s.preventDefault(),s.stopPropagation(),l.focus(),l.setPointerCapture(s.pointerId),this.areaDrag={pointerId:s.pointerId,mode:e,initialStart:t,initialEnd:i,currentStart:t,currentEnd:i,originX:s.clientX,pointerOffsetX:e==="move"?0:s.clientX-(a.left+c/10*a.width),trackLeft:a.left,trackWidth:a.width,captureTarget:l}}areaPointerMoved(e){const t=this.areaDrag;if(!t||t.pointerId!==e.pointerId)return;e.preventDefault();let i=t.initialStart,s=t.initialEnd;if(t.mode==="move"){const n=t.initialEnd-t.initialStart,a=Math.round((e.clientX-t.originX)/t.trackWidth*10);i=R(t.initialStart+a,0,10-n),s=i+n}else{const n=Math.round((e.clientX-t.pointerOffsetX-t.trackLeft)/t.trackWidth*10);t.mode==="start"?i=R(n,0,t.initialEnd-1):s=R(n,t.initialStart+1,10)}i===t.currentStart&&s===t.currentEnd||(t.currentStart=i,t.currentEnd=s,this.setAppliedArea(i,s))}areaPointerFinished(e){const t=this.areaDrag;!t||t.pointerId!==e.pointerId||(t.captureTarget.hasPointerCapture(e.pointerId)&&t.captureTarget.releasePointerCapture(e.pointerId),this.areaDrag=void 0)}areaBoundaryKeyDown(e,t,i,s){const n=e==="start"?0:t+1,a=e==="start"?i-1:10,l=e==="start"?t:i,c=ai(s.key,l,n,a);c!==void 0&&(s.preventDefault(),this.setAppliedArea(e==="start"?c:t,e==="end"?c:i))}areaPositionKeyDown(e,t,i){const s=t-e,n=ai(i.key,e,0,10-s);n!==void 0&&(i.preventDefault(),this.setAppliedArea(n,n+s))}setAppliedArea(e,t){this.updateLayer({area:{start_tenths:e,width_tenths:t-e}})}renderSelectionControls(e){const t=e.selection,i=Us(t.type);return o`
    ...
    `}renderBrightness(e){if(e.brightness_patterns.length===0)return o`
      ...
      `;const t=R(this.activePatternIndex,0,e.brightness_patterns.length-1),i=e.brightness_patterns[t],s=Hs(i.order);return o`
      <section class="card wide-card">
        ...
        ${s.enabled?o`
              ...
              <label class="field">
                ...
                <select
                  ...
                  ?disabled=${this.disabled}
                  @change=${n=>{const a=Number(n.target.value);this.updateMovement(t,{direction:a},`${i} direction ${ri[a]}.`)}}
                >
                  ${Object.entries(ri).map(([n,a])=>o`<option value=${n}>${a}</option>`)}
                </select>
              </label>
              ${this.rangeField("Speed",s.speed,0,255,n=>this.updateMovement(t,{speed:n},`${i} speed ${qs(n)} per cent.`))}
    ...
    `}byteNumberField(e,t,i){return this.numberField(e,t,0,255,i)}numberField(e,t,i,s,n){return o`
      <label class="field">
        ...
        <input
          ...
          .value=${String(t)}
          ?disabled=${this.disabled}
          @change=${a=>n(R(Number(a.target.value),i,s))}
        />
      </label>
  ...
  `]}}pe([h({attribute:!1})],se.prototype,"content");pe([h({type:Boolean})],se.prototype,"disabled");pe([h({type:Number})],se.prototype,"segmentCount");pe([m()],se.prototype,"activeLayerIndex");pe([m()],se.prototype,"activePatternIndex");pe([m()],se.prototype,"movementAnnouncement");pe([m()],se.prototype,"layerActionsIndex");function lt(){return{kind:"advanced",layers:[Bi()]}}function Je(r){return{kind:"advanced",layers:r.layers.map(X)}}function st(r){return{...r,template:{...r.template},effect:{layers:Je({layers:r.effect.layers}).layers}}}function Bi(){return{area:{start_tenths:0,width_tenths:10},selection:{type:0,param_1:0,param_2:1},brightness_gradient:!1,brightness_patterns:[Oi()],distribution:{method:1,backwards:!1},colour_speed:128,colour_retention:20,palette:[[255,0,0],[0,0,255]],selected_movement:ni(),overall_movement:ni(),priority:0,unknown_flags:0,excess:""}}function Oi(){return{scope_high:255,scope_low:0,order:0,change_speed:128,brightest_retention:20,darkest_retention:20}}function ni(){return{enabled:!1,enter_exit:!1,direction:0,distance:1,speed:128,unknown_flags:0}}function X(r){return{...r,area:{...r.area},selection:{...r.selection},brightness_patterns:r.brightness_patterns.map(e=>({...e})),distribution:{...r.distribution},palette:r.palette.map(e=>[...e]),selected_movement:{...r.selected_movement},overall_movement:{...r.overall_movement}}}function Us(r){return Ni.includes(r)}function Hs(r){return Ri.includes(r)}function qs(r){return Math.round(R(r,0,255)/255*100)}function qe(r){return r.toString(16).padStart(2,"0").toUpperCase()}function Vs(r){const e=r.trim().replace(/^0x/i,"");if(/^[0-9a-f]{1,2}$/i.test(e))return Number.parseInt(e,16)}function Ks(r,e,t,i){const s=r*10/e;return(r+1)*10/e>t&&s<i}function ai(r,e,t,i){if(r==="Home")return t;if(r==="End")return i;if(r==="ArrowLeft"||r==="ArrowDown")return R(e-1,t,i);if(r==="ArrowRight"||r==="ArrowUp")return R(e+1,t,i)}function R(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}customElements.get("govee-advanced-effect-editor")||customElements.define("govee-advanced-effect-editor",se);const js=["compiling","pending","uploading","activating","verifying","confirmed","uncertain","recovering","failed","interrupted","unknown"],dt=["compiling","pending","uploading","activating","verifying","recovering"],Gs=2,Fi=1,zs=2,oi=4,D=128,we=65536,Ui=512,Hi=256,qi=32,Vi=128,Ki=512,x=255,Xs=64,ji=262144,li=16,Ys=4096,Gi=16384,q=1024,ct=16384,Nt=Number.MAX_SAFE_INTEGER,Ws=4335,Js=232,Zs=253,_e=["H617A","H6199"],ut="H617A",zi=["movie","game"],di=["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","video","palette_diy","advanced","workshop","special_diy"],Qs=["studio","home_assistant","planned"],er=["exact_session","activation_match","unknown"],tr={H617A:["native_scenes","edited_palette_scenes","layered_scenes","painted","single","multi","native_music","advanced","workshop","special_diy"],H6199:["native_scenes","edited_palette_scenes","layered_scenes","palette_diy","native_music","video","advanced","workshop","special_diy"]};function ir(r){const e=f(r,"editor info"),t=f(e.limits,"editor limits");return{api_version:u(e.api_version,"API version",1),effect_schema_version:u(e.effect_schema_version,"effect schema version",1),compiler_version:u(e.compiler_version,"compiler version",1),limits:{effect_name:H(t.effect_name,D,"effect-name limit"),effect_document_bytes:H(t.effect_document_bytes,we,"effect-document limit"),devices:H(t.devices,Ui,"device limit"),library_items:H(t.library_items,Hi,"library-item limit"),drafts_per_owner:H(t.drafts_per_owner,qi,"draft limit"),deployment_records:H(t.deployment_records,Vi,"deployment limit"),scene_catalogue_entries:H(t.scene_catalogue_entries,Ki,"scene catalogue limit")}}}function sr(r){const e=E(r,"devices",Ui).map((t,i)=>{const s=f(t,`devices[${i}]`),n=f(s.custom_effects,`devices[${i}].custom_effects`);return{config_entry_id:b(s.config_entry_id,`devices[${i}].config_entry_id`,x),model:b(s.model,`devices[${i}].model`,x),display_name:b(s.display_name,`devices[${i}].display_name`,x),segment_count:u(s.segment_count,`devices[${i}].segment_count`,0,65535),custom_effects:{painted:B(n.painted,"painted capability"),single:B(n.single,"single capability"),multi:B(n.multi,"multi capability"),palette_diy:B(n.palette_diy,"palette DIY capability"),advanced:B(n.advanced,"advanced capability")},readback:b(s.readback,`devices[${i}].readback`,x)}});return V(e,t=>t.config_entry_id,"device IDs"),e}function rr(r){he(r,"custom-effect catalogue",ji,Gi);const e=f(r,"custom-effect catalogue"),t=nr(e.models),i=yt(e,"custom-effect catalogue",ut);if(JSON.stringify(i)!==JSON.stringify(t[ut]))throw new Error("Malformed Effect Studio server payload: legacy custom-effect catalogue view does not match models.H617A.");return H(e.schema_version,oi,"catalogue schema"),{...i,schema_version:oi,sku:ut,models:t}}function nr(r){const e=f(r,"custom-effect catalogue models"),i=Object.keys(e).filter(s=>!_e.includes(s));if(i.length>0)throw new Error(`Malformed Effect Studio server payload: unexpected catalogue models ${i.join(", ")}.`);for(const s of _e)if(!(s in e))throw new Error(`Malformed Effect Studio server payload: missing catalogue model ${s}.`);return{H617A:yt(e.H617A,"catalogue model H617A","H617A"),H6199:yt(e.H6199,"catalogue model H6199","H6199")}}function yt(r,e,t){const i=f(r,e),s=f(i.limits,`${e} limits`),n=f(i.supports,`${e} support capabilities`),a=f(i.apply,`${e} Apply capabilities`),l=T(i.sku,_e,`${e} SKU`);if(l!==t)throw new Error(`Malformed Effect Studio server payload: ${e} is keyed as ${t} but declares ${l}.`);const c=u(s.music_sensitivity_min,`${e} minimum music sensitivity`,0,100),p=u(s.music_sensitivity_max,`${e} maximum music sensitivity`,0,100);return c>p&&v(`${e} music sensitivity limits are inverted`),{sku:l,painted_effects:or(i.painted_effects,`${e} painted-effect templates`),effects:lr(i.effects,`${e} custom-effect templates`),music_modes:ci(i.music_modes,`${e} music modes`),video_modes:ci(i.video_modes,`${e} video modes`,zi),workflows:ar(i.workflows,`${e} release workflows`,t),supports:{multi:B(n.multi,`${e} Multi support`),advanced:B(n.advanced,`${e} advanced support`)},limits:{palette_min:u(s.palette_min,`${e} minimum palette`,1,255),palette_max:u(s.palette_max,`${e} maximum palette`,1,255),multi_max:u(s.multi_max,`${e} maximum Multi effects`,1,255),music_sensitivity_min:c,music_sensitivity_max:p},apply:{painted:B(a.painted,`${e} Painted Apply capability`),single:B(a.single,`${e} Single Apply capability`),multi:B(a.multi,`${e} Multi Apply capability`),palette_diy:B(a.palette_diy,`${e} palette DIY Apply capability`)}}}function ar(r,e,t){const i=E(r,e,di.length).map((c,p)=>{const g=f(c,`${e}[${p}]`);return{id:T(g.id,di,`${e}[${p}] ID`),label:b(g.label,`${e}[${p}] label`,D),content_kind:b(g.content_kind,`${e}[${p}] content kind`,x),application:T(g.application,Qs,`${e}[${p}] application`)}});V(i,c=>c.id,`${e} IDs`);const s=tr[t],n=new Set(i.map(c=>c.id)),a=s.filter(c=>!n.has(c)),l=i.map(c=>c.id).filter(c=>!s.includes(c));if(a.length>0||l.length>0)throw new Error(`Malformed Effect Studio server payload: ${e} does not match ${t}.`);return i}function or(r,e){const t=E(r,e,q).map((i,s)=>{const n=f(i,`${e}[${s}]`);return{id:T(n.id,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],`${e} ID`),label:b(n.label,`${e} label`,D)}});return V(t,i=>i.id,`${e} IDs`),t}function lr(r,e){const t=E(r,e,q).map((i,s)=>{const n=f(i,`${e}[${s}]`),a=E(n.variations,`${e}[${s}].variations`,q);if(a.length===0)throw new Error("Malformed Effect Studio server payload: custom-effect template has no variations.");const l={id:b(n.id,`${e}[${s}] ID`,x),label:b(n.label,`${e}[${s}] label`,D),family:u(n.family,`${e}[${s}] family`,0,255),variations:a.map((c,p)=>{const g=f(c,`${e}[${s}].variations[${p}]`);return{id:b(g.id,`${e}[${s}].variations[${p}] ID`,x),label:b(g.label,`${e}[${s}].variations[${p}] label`,D),variant:u(g.variant,`${e}[${s}].variations[${p}] variant`,0,255)}}),supports_multi:O(n.supports_multi,`${e}[${s}] Multi support`),rate:T(n.rate,["speed","sensitivity"],`${e}[${s}] rate parameter`)};return V(l.variations,c=>c.id,`${e}[${s}] variation IDs`),l});return V(t,i=>i.id,`${e} IDs`),t}function ci(r,e,t){const i=E(r,e,q).map((s,n)=>{const a=f(s,`${e}[${n}]`);return{id:t?T(a.id,t,`${e}[${n}] ID`):b(a.id,`${e}[${n}] ID`,x),label:b(a.label,`${e}[${n}] label`,D)}});return V(i,s=>s.id,`${e} IDs`),i}function ui(r){const e=f(r,"library snapshot"),t={library_revision:Q(e.library_revision,"library revision",0),items:E(e.items,"library items",Hi).map((i,s)=>{const n=f(i,`library items[${s}]`),a=n.template===void 0?void 0:Ze(n.template,`library items[${s}].template`),l=n.model===void 0?void 0:yr(n.model);return{id:b(n.id,"library item ID",x),revision:Q(n.revision,"library item revision",1),name:b(n.name,"library item name",D),kind:b(n.kind,"library item kind",x),...l?{model:l}:{},...a?{template:a}:{}}})};return V(t.items,i=>i.id,"library item IDs"),t}function Ge(r){he(r,"library item",we);const e=f(r,"library item"),t=e.target_hint===void 0?void 0:f(e.target_hint,"target hint");return{schema_version:H(e.schema_version,Fi,"effect schema version"),id:b(e.id,"effect ID",x),revision:Q(e.revision,"effect revision",1),name:b(e.name,"effect name",D),content:Xi(e.content),provenance:_t(e.provenance,"effect provenance"),extensions:_t(e.extensions,"effect extensions"),...t?{target_hint:{model:t.model===null?null:b(t.model,"target model",x),segment_count:t.segment_count===null?null:u(t.segment_count,"target segment count",1,65535)}}:{}}}function dr(r){const e=E(r,"draft summaries",qi).map((t,i)=>{const s=f(t,`draft summaries[${i}]`);return{id:b(s.id,"draft ID",x),revision:Q(s.revision,"draft revision",1),name:b(s.name,"draft name",D),updated_at:Bt(s.updated_at,"draft timestamp"),selected_config_entry_id:Me(s.selected_config_entry_id,"draft config entry ID")}});return V(e,t=>t.id,"draft IDs"),e}function pt(r){const e=f(r,"effect draft");return{id:b(e.id,"draft ID",x),owner_id:b(e.owner_id,"draft owner",x),revision:Q(e.revision,"draft revision",1),item:Ge(e.item),updated_at:Bt(e.updated_at,"draft timestamp"),selected_config_entry_id:Me(e.selected_config_entry_id,"draft config entry ID"),base_item_id:Me(e.base_item_id,"draft base item ID"),base_item_revision:e.base_item_revision===null?null:Q(e.base_item_revision,"draft base item revision",1)}}function $t(r){const e=f(r,"deployment"),t=T(e.phase,js,"deployment phase"),i={operation_id:b(e.operation_id,"deployment operation ID",x),config_entry_id:b(e.config_entry_id,"deployment config entry ID",x),diy_code:u(e.diy_code,"deployment DIY code",0,65535),phase:t,updated_at:Bt(e.updated_at,"deployment timestamp"),item_id:Me(e.item_id,"deployment item ID"),item_revision:e.item_revision===null?null:Q(e.item_revision,"deployment item revision",1),error_code:Me(e.error_code,"deployment error code"),progress_current:u(e.progress_current,"deployment progress",0,1024),progress_total:u(e.progress_total,"deployment progress total",0,1024),verification_confidence:T(e.verification_confidence,er,"deployment verification confidence")};return i.progress_current>i.progress_total&&v("deployment progress exceeds its total"),i}function cr(r){const e=f(r,"deployment snapshot"),t={revision:Q(e.revision,"deployment revision",0),deployments:E(e.deployments,"deployments",Vi).map($t)};return V(t.deployments,i=>i.operation_id,"deployment operation IDs"),t}function ur(r){he(r,"scene catalogue",ji,Gi);const e=f(r,"scene catalogue");return{schema_version:u(e.schema_version,"scene catalogue schema",1),sku:b(e.sku,"scene catalogue SKU",x),enabled:O(e.enabled,"scene catalogue enabled"),categories:E(e.categories,"scene categories",q).map((t,i)=>{const s=f(t,`scene categories[${i}]`);return{id:u(s.id,"scene category ID",0,65535),name:b(s.name,"scene category name",D)}}),scenes:E(e.scenes,"scenes",Ki).map(Rt)}}function pr(r){const e=f(r,"scene detail");he({scene:e.scene,content:e.content},"scene detail",we);const t=Xi(e.content);return t.kind!=="scene_builtin"&&t.kind!=="scene_palette"&&t.kind!=="scene_layered"&&v("scene detail content is unsupported"),{scene:Rt(e.scene),content:t}}function Xi(r){he(r,"effect content",we);const e=f(r,"effect content"),t=b(e.kind,"effect content kind",x);switch(t){case"h617a_painted":return{kind:t,effect:T(e.effect,["cycle","clockwise","counter_clockwise","twinkle","gradient","breathe"],"painted effect"),speed:u(e.speed,"painted speed",0,100),brightness:u(e.brightness,"painted brightness",0,100),background:xe(e.background,"painted background"),groups:E(e.groups,"paint groups",15).map((i,s)=>{const n=f(i,`paint groups[${s}]`);return{fill:xe(n.fill,"paint-group fill"),segments:E(n.segments,"painted segments",15).map(a=>u(a,"painted segment",0,14))}})};case"h617a_single":return{kind:t,family:u(e.family,"Single family",0,254),variant:u(e.variant,"Single variant",0,255),speed:u(e.speed,"Single speed",0,100),palette:Pe(e.palette,"Single palette",8)};case"h617a_multi":return{kind:t,effects:E(e.effects,"Multi effects",4).map((i,s)=>{const n=f(i,`Multi effects[${s}]`);return{family:u(n.family,"Multi family",0,254),variant:u(n.variant,"Multi variant",0,255)}}),speed:u(e.speed,"Multi speed",0,100),palette:Pe(e.palette,"Multi palette",8)};case"palette_diy":return{kind:t,model:T(e.model,_e,"palette DIY model"),family:u(e.family,"palette DIY family",0,255),variant:u(e.variant,"palette DIY variant",0,255),speed:u(e.speed,"palette DIY speed",0,100),palette:Pe(e.palette,"palette DIY palette",8)};case"music_profile":return{kind:t,model:T(e.model,_e,"music profile model"),mode:b(e.mode,"music profile mode",x),sensitivity:u(e.sensitivity,"music profile sensitivity",0,100),colour:fr(e.colour,"music profile colour"),calm:gr(e.calm,"music profile calm"),parameters:_t(e.parameters,"music profile parameters")};case"video_profile":return{kind:t,model:T(e.model,["H6199"],"video profile model"),mode:T(e.mode,zi,"video profile mode"),full_screen:O(e.full_screen,"video profile full-screen flag"),saturation:u(e.saturation,"video profile saturation",0,100),sound_effects:O(e.sound_effects,"video profile sound-effects flag"),sound_effects_softness:u(e.sound_effects_softness,"video profile sound-effects softness",1,100),white_balance_position:u(e.white_balance_position,"video profile white-balance position",1,20),relative_brightness:br(e.relative_brightness,"video profile relative brightness"),blank_screen:O(e.blank_screen,"video profile blank-screen flag")};case"advanced":return{kind:t,layers:pi(e.layers,"Advanced layers")};case"scene_builtin":return{kind:t,template:Ze(e.template,"scene template"),speed_index:xt(e.speed_index,"scene speed index",0,255)};case"scene_palette":return hr(e);case"scene_layered":{const i=f(e.effect,"layered scene effect"),s=Yi(e.trailing_padding,"layered scene trailing padding");return{kind:t,template:Ze(e.template,"layered scene template"),effect:{layers:pi(i.layers,"layered scene layers")},speed_index:xt(e.speed_index,"layered scene speed index",0,255),raw_param:Wi(e.raw_param,"layered scene raw parameter"),...s===void 0?{}:{trailing_padding:s}}}default:{const{kind:i,...s}=e;return{kind:"opaque",source_kind:t,body:s}}}}function Yi(r,e){if(r!==void 0)return u(r,e,0,Ws)}function hr(r){const t=u(r.layout,"palette scene layout",0,1)===0?0:1,i=E(r.steps,"palette scene steps",255).map((l,c)=>{const p=f(l,`palette scene steps[${c}]`),g=t===0?(p.inline_colour!==null&&v(`palette scene steps[${c}].inline_colour must be null for layout 0`),null):xe(p.inline_colour,`palette scene steps[${c}].inline_colour`);return{value:u(p.value,`palette scene steps[${c}].value`,0,65535),colour:xe(p.colour,`palette scene steps[${c}].colour`),inline_colour:g}}),s=Pe(r.palette,"palette scene shared palette",255,!0);t===1&&s.length!==0&&v("palette scene layout 1 must not have a shared palette");let n;r.config_flags!==void 0&&(n=u(r.config_flags,"palette scene config flags",0,255),n&-9&&v("palette scene config flags must only set reserved config bits"));const a=Yi(r.trailing_padding,"palette scene trailing padding");return{kind:"scene_palette",template:Ze(r.template,"palette scene template"),layout:t,brightness_flag:O(r.brightness_flag,"palette scene brightness flag"),steps:i,palette:s,speed_index:xt(r.speed_index,"palette scene speed index",0,255),...n===void 0?{}:{config_flags:n},...a===void 0?{}:{trailing_padding:a}}}function Ee(r){return r.kind!=="opaque"?r:(he(r.body,"opaque content",we),{...r.body,kind:b(r.source_kind,"opaque source kind",x)})}function Rt(r){const e=f(r,"scene"),t=Oe(e.parameter_kind,"scene parameter kind");t!=="none"&&t!=="palette"&&t!=="layers"&&t!=="opaque"&&v("scene parameter kind is invalid");const i=e.speed===null?null:(()=>{const s=f(e.speed,"scene speed");return{option_count:u(s.option_count,"scene speed option count",1,256),default_index:u(s.default_index,"scene default speed",0,255)}})();return{scene_id:u(e.scene_id,"scene ID",0,65535),effect_id:u(e.effect_id,"scene effect ID",0,65535),category_id:u(e.category_id,"scene category ID",0,65535),category:b(e.category,"scene category",D),name:b(e.name,"scene name",D),variant:vr(e.variant,"scene variant",x),display_name:b(e.display_name,"scene display name",D),scene_type:u(e.scene_type,"scene type",0,255),parameter_kind:t,speed:i}}function pi(r,e){return E(r,e,255).map((t,i)=>mr(t,`${e}[${i}]`))}function mr(r,e){const t=f(r,e),i=f(t.area,`${e}.area`),s=f(t.selection,`${e}.selection`),n=f(t.distribution,`${e}.distribution`);return{area:{start_tenths:u(i.start_tenths,`${e}.area.start_tenths`,0,15),width_tenths:u(i.width_tenths,`${e}.area.width_tenths`,0,15)},selection:{type:P(s.type,`${e}.selection.type`),param_1:P(s.param_1,`${e}.selection.param_1`),param_2:P(s.param_2,`${e}.selection.param_2`)},brightness_gradient:O(t.brightness_gradient,`${e}.brightness_gradient`),brightness_patterns:E(t.brightness_patterns,`${e}.brightness_patterns`,255).map((a,l)=>{const c=f(a,`${e}.brightness_patterns[${l}]`);return{scope_high:P(c.scope_high,"brightness scope high"),scope_low:P(c.scope_low,"brightness scope low"),order:P(c.order,"brightness order"),change_speed:P(c.change_speed,"brightness change speed"),brightest_retention:P(c.brightest_retention,"brightest retention"),darkest_retention:P(c.darkest_retention,"darkest retention")}}),distribution:{method:u(n.method,`${e}.distribution.method`,0,127),backwards:O(n.backwards,`${e}.distribution.backwards`)},colour_speed:P(t.colour_speed,`${e}.colour_speed`),colour_retention:P(t.colour_retention,`${e}.colour_retention`),palette:Pe(t.palette,`${e}.palette`,255,!0),selected_movement:hi(t.selected_movement,`${e}.selected_movement`),overall_movement:hi(t.overall_movement,`${e}.overall_movement`),priority:P(t.priority,`${e}.priority`),unknown_flags:Ji(t.unknown_flags,Zs,`${e}.unknown_flags`),excess:Wi(t.excess,`${e}.excess`)}}function hi(r,e){const t=f(r,e);return{enabled:O(t.enabled,`${e}.enabled`),enter_exit:O(t.enter_exit,`${e}.enter_exit`),direction:u(t.direction,`${e}.direction`,0,3),distance:P(t.distance,`${e}.distance`),speed:P(t.speed,`${e}.speed`),unknown_flags:Ji(t.unknown_flags,Js,`${e}.unknown_flags`)}}function Ze(r,e){const t=f(r,e);return{sku:b(t.sku,`${e}.sku`,x),scene_id:u(t.scene_id,`${e}.scene_id`,0,65535),effect_id:u(t.effect_id,`${e}.effect_id`,0,65535),catalogue_schema_version:u(t.catalogue_schema_version,`${e}.catalogue_schema_version`,1,Nt)}}function Pe(r,e,t,i=!1){const s=E(r,e,t);return!i&&s.length===0&&v(`${e} must not be empty`),s.map((n,a)=>xe(n,`${e}[${a}]`))}function xe(r,e){const t=E(r,e,3);return t.length!==3&&v(`${e} must contain three channels`),t.map(i=>u(i,`${e} channel`,0,255))}function fr(r,e){return r===null?null:xe(r,e)}function gr(r,e){return r===null?null:O(r,e)}function br(r,e){const t=f(r,e);return{left:u(t.left,`${e}.left`,1,100),top:u(t.top,`${e}.top`,1,100),right:u(t.right,`${e}.right`,1,100),bottom:u(t.bottom,`${e}.bottom`,1,100)}}function B(r,e){return r!=="supported"&&r!=="unsupported"&&r!=="evidence_gap"&&v(`${e} is invalid`),r}function _t(r,e){return he(r,e,we),f(r,e)}function Me(r,e){return r===null?null:b(r,e,x)}function Bt(r,e){const t=b(r,e,Xs);return(!/T.*(?:Z|[+-]\d{2}:\d{2})$/.test(t)||Number.isNaN(Date.parse(t)))&&v(`${e} must be an ISO 8601 timestamp with a UTC offset`),t}function b(r,e,t){const i=Oe(r,e);return(i.length===0||i.length>t)&&v(`${e} must contain 1 to ${t} characters`),i}function vr(r,e,t){const i=Oe(r,e);return i.length>t&&v(`${e} must not exceed ${t} characters`),i}function Wi(r,e){const t=Oe(r,e);return(t.length%2!==0||!/^[0-9a-f]*$/i.test(t))&&v(`${e} must be hexadecimal`),t}function Oe(r,e){return typeof r!="string"&&v(`${e} must be a string`),r}function yr(r){return typeof r=="string"&&_e.includes(r)?r:void 0}function O(r,e){return typeof r!="boolean"&&v(`${e} must be a boolean`),r}function u(r,e,t,i=Nt){return(typeof r!="number"||!Number.isSafeInteger(r)||r<t||r>i)&&v(`${e} must be an integer from ${t} to ${i}`),r}function Q(r,e,t){return u(r,e,t,Nt)}function H(r,e,t){const i=u(r,t,1);return i!==e&&v(`${t} is incompatible with this editor`),i}function xt(r,e,t,i){return r===null?null:u(r,e,t,i)}function P(r,e){return u(r,e,0,255)}function Ji(r,e,t){const i=P(r,t);return i&~e&&v(`${t} must only set reserved bits, not bits explicit fields carry`),i}function T(r,e,t){const i=Oe(r,t);return e.includes(i)||v(`${t} is invalid`),i}function f(r,e){return(typeof r!="object"||r===null||Array.isArray(r))&&v(`${e} must be an object`),r}function E(r,e,t){return Array.isArray(r)||v(`${e} must be an array`),r.length>t&&v(`${e} must not exceed ${t} items`),r}function V(r,e,t){const i=r.map(e);new Set(i).size!==i.length&&v(`${t} must be unique`)}function he(r,e,t,i=Ys){let s=0;const n=(l,c,p)=>{if(s+=1,s>i&&v(`${e} must not exceed ${i} JSON values`),p>li&&v(`${e} must not exceed ${li} nested levels`),!(l===null||typeof l=="boolean")){if(typeof l=="number"){(!Number.isFinite(l)||Number.isInteger(l)&&!Number.isSafeInteger(l))&&v(`${c} must be a finite JSON number`);return}if(typeof l=="string"){l.length>ct&&v(`${c} must not exceed ${ct} characters`);return}if(Array.isArray(l)){l.length>q&&v(`${c} must not exceed ${q} items`),l.forEach((g,y)=>n(g,`${c}[${y}]`,p+1));return}if(typeof l=="object"&&l!==null){const g=Object.entries(l);g.length>q&&v(`${c} must not exceed ${q} fields`),g.forEach(([y,N])=>{y.length>ct&&v(`${c} contains an oversized key`),n(N,`${c}.${y}`,p+1)});return}v(`${c} contains a non-JSON value`)}};n(r,e,0);const a=JSON.stringify(r);a===void 0&&v(`${e} must contain JSON values`),new TextEncoder().encode(a).byteLength>t&&v(`${e} must not exceed ${t} bytes`)}function v(r){throw new Error(`Malformed Effect Studio server payload: ${r}.`)}function $r(r){return r.api_version===Gs&&r.effect_schema_version===Fi&&r.compiler_version===zs}const ht="ha_govee_led_ble/editor";class _r{constructor(e){this.hass=e}async info(){return ir(await this.call("info"))}async devices(){const e=await this.call("devices");return sr(A(e,"devices"))}async customCatalogue(){const e=await this.call("custom/catalogue");return rr(A(e,"catalogue"))}async library(){return ui(await this.call("library/list"))}async item(e){const t=await this.call("library/get",{item_id:e});return Ge(A(t,"item"))}async createItem(e,t,i){const s=await this.call("library/create",{name:e,content:Ee(t),expected_library_revision:i});return{item:Ge(A(s,"item")),library_revision:mt(s)}}async updateItem(e,t,i,s){const n=await this.call("library/update",{item_id:e.id,name:t,content:Ee(i),expected_revision:e.revision,expected_library_revision:s});return{item:Ge(A(n,"item")),library_revision:mt(n)}}async deleteItem(e,t){const i=await this.call("library/delete",{item_id:e.id,expected_revision:e.revision,expected_library_revision:t});return mt(i)}async drafts(){const e=await this.call("draft/list");return dr(A(e,"drafts"))}async draft(e){const t=await this.call("draft/get",{draft_id:e});return pt(A(t,"draft"))}async createDraft(e,t,i,s){const n=await this.call("draft/create",{name:e,content:Ee(t),updated_at:new Date().toISOString(),selected_config_entry_id:i,...s?{base_item_id:s.id,base_item_revision:s.revision}:{}});return pt(A(n,"draft"))}async updateDraft(e,t,i,s){const n=await this.call("draft/update",{draft_id:e.id,expected_revision:e.revision,name:t,content:Ee(i),updated_at:new Date().toISOString(),selected_config_entry_id:s});return pt(A(n,"draft"))}async deleteDraft(e){await this.call("draft/delete",{draft_id:e.id,expected_revision:e.revision})}async applySaved(e,t){const i=await this.call("apply",{config_entry_id:e,item_id:t.id,revision:t.revision,updated_at:new Date().toISOString()});return $t(A(i,"deployment"))}async applySnapshot(e,t,i){const s=await this.call("apply_snapshot",{config_entry_id:e,name:t,content:Ee(i),updated_at:new Date().toISOString()});return $t(A(s,"deployment"))}async sceneCatalogue(e){const t=await this.call("scene/catalogue/list",{config_entry_id:e});return ur(A(t,"catalogue"))}sceneDetail(e,t,i){return this.call("scene/catalogue/get",{config_entry_id:e,scene_id:t,effect_id:i}).then(pr)}async applyScene(e,t,i){const s=await this.call("scene/apply",{config_entry_id:e,scene_id:t.scene_id,effect_id:t.effect_id,...i===null?{}:{speed_index:i}}),n=Rt(A(s,"scene")),a=A(s,"readback");if(a!=="scene_identity_only")throw new Error("Malformed Effect Studio server payload: scene Apply readback is invalid.");const l=A(s,"speed_index");if(l!==null&&(typeof l!="number"||!Number.isSafeInteger(l)||l<0||l>255))throw new Error("Malformed Effect Studio server payload: scene Apply speed is invalid.");return{scene:n,speed_index:l,readback:a}}subscribeLibrary(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(ui(i))}catch(s){t?.(mi(s))}},{type:`${ht}/library/subscribe`})}subscribeDeployments(e,t){return this.hass.connection.subscribeMessage(i=>{try{e(cr(i))}catch(s){t?.(mi(s))}},{type:`${ht}/deployment/subscribe`})}call(e,t={}){return this.hass.callWS({type:`${ht}/${e}`,...t})}}function A(r,e){if(typeof r!="object"||r===null||Array.isArray(r))throw new Error("Malformed Effect Studio server payload: response must be an object.");if(!(e in r))throw new Error(`Malformed Effect Studio server payload: response is missing ${e}.`);return r[e]}function mt(r){const e=A(r,"library_revision");if(typeof e!="number"||!Number.isSafeInteger(e)||e<0)throw new Error("Malformed Effect Studio server payload: library revision is invalid.");return e}function mi(r){return r instanceof Error?r:new Error("Malformed Effect Studio server payload.")}var xr=Object.defineProperty,Zi=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&xr(e,t,s),s};const wt=17,Qi="ha_govee_led_ble/effect_studio/recent_colours",ze=[[255,69,58],[255,159,10],[255,214,10],[48,209,88],[99,230,226],[100,210,255],[10,132,255],[94,92,230],[191,90,242],[255,45,85],[172,142,104],[255,255,255],[174,174,178],[99,99,102],[28,28,30],[255,127,0],[139,0,255]];let ye=wr();class Ot extends I{constructor(){super(...arguments),this.colour=[255,255,255],this.disabled=!1}render(){return o`
      <div class="preset-grid">
        ...
        >
          <input
            ...
            .value=${w(this.colour)}
            ?disabled=${this.disabled}
            @input=${e=>this.emit("colour-changing",ti(e.target.value))}
            @change=${e=>this.commit(ti(e.target.value))}
          />
        </label>
      </div>
    `}commit(e){kr(e),this.emit("colour-changed",e)}emit(e,t){this.colour=[...t],this.dispatchEvent(new CustomEvent(e,{detail:{colour:[...t]},bubbles:!0,composed:!0}))}static{this.styles=[M,k`
    :host {
      display: block;
    }
  ...
  `]}}Zi([h({attribute:!1})],Ot.prototype,"colour");Zi([h({type:Boolean})],Ot.prototype,"disabled");function kt(r){return[...ye[r%ye.length]]}function wr(){const r=localStorage.getItem(Qi);if(!r)return Z(ze);let e;try{e=JSON.parse(r)}catch(i){if(i instanceof SyntaxError)return Z(ze);throw i}if(!Array.isArray(e))return Z(ze);const t=e.filter(Er).map(i=>[...i]).slice(0,wt);return es(t)}function kr(r){const e=w(r);ye=es([[...r],...ye.filter(t=>w(t)!==e)]),localStorage.setItem(Qi,JSON.stringify(ye))}function es(r){const e=Z(r);for(const t of ze)e.length>=wt||e.some(i=>w(i)===w(t))||e.push([...t]);return e.slice(0,wt)}function Er(r){return Array.isArray(r)&&r.length===3&&r.every(e=>Number.isInteger(e)&&e>=0&&e<=255)}customElements.get("govee-colour-picker")||customElements.define("govee-colour-picker",Ot);var Cr=Object.defineProperty,K=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Cr(e,t,s),s};class U extends I{constructor(){super(...arguments),this.palette=[],this.minColours=1,this.maxColours=8,this.disabled=!1,this.persistentPicker=!1,this.ariaLabel="Colours",this.itemName="colour",this.windowPointerDown=e=>{this.editingIndex!==void 0&&!e.composedPath().includes(this)&&(this.editingIndex=void 0)}}connectedCallback(){super.connectedCallback(),window.addEventListener("pointerdown",this.windowPointerDown)}disconnectedCallback(){window.removeEventListener("pointerdown",this.windowPointerDown),super.disconnectedCallback()}willUpdate(e){e.has("palette")&&this.editingIndex!==void 0&&this.editingIndex>=this.palette.length&&(this.editingIndex=void 0)}render(){const e=this.persistentPicker?this.selectedIndex:this.editingIndex,t=this.palette.map((i,s)=>({key:`${s}-${w(i)}`,label:`${fi(this.itemName)} ${s+1}`,ariaLabel:this.itemAriaLabel(i,s),colour:w(i),removeReady:!this.persistentPicker&&this.editingIndex===s&&this.palette.length>this.minColours,disabled:this.disabled}));return o`
      <govee-reorderable-strip
        .items=${t}
        .activeIndex=${e}
      ...
      ${this.persistentPicker&&e!==void 0?o`
          ...
          `:d}
    `}itemAriaLabel(e,t){const i=`${fi(this.itemName)} ${t+1}`;return this.persistentPicker?`${i}, ${w(e)}${t===this.selectedIndex?", selected":""}`:this.editingIndex===t&&this.palette.length>this.minColours?`Remove colour ${t+1}`:`Edit colour ${t+1}, ${w(e)}. Drag to reorder or use arrow keys.`}renderPicker(e,t){return o`
      <govee-colour-picker
        .colour=${t}
        .disabled=${this.disabled}
  ...
  `]}}K([h({attribute:!1})],U.prototype,"palette");K([h({type:Number})],U.prototype,"minColours");K([h({type:Number})],U.prototype,"maxColours");K([h({type:Boolean})],U.prototype,"disabled");K([h({type:Boolean})],U.prototype,"persistentPicker");K([h({type:Number})],U.prototype,"selectedIndex");K([h()],U.prototype,"ariaLabel");K([h()],U.prototype,"itemName");K([m()],U.prototype,"editingIndex");function fi(r){return r.charAt(0).toUpperCase()+r.slice(1)}customElements.get("govee-palette-editor")||customElements.define("govee-palette-editor",U);var Sr=Object.defineProperty,Ft=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Sr(e,t,s),s};class rt extends I{constructor(){super(...arguments),this.disabled=!1}updated(){if(this.content){if(this.content.kind==="h617a_single"||this.content.kind==="palette_diy"){const e=this.shadowRoot?.querySelector("select[data-single-variation]");e&&(e.value=String(this.content.variant));return}this.content.effects.forEach((e,t)=>{const i=this.effectFamily(e,!0),s=this.shadowRoot?.querySelector(`select[data-effect-index="${t}"]`),n=this.shadowRoot?.querySelector(`select[data-variation-index="${t}"]`);s&&(s.value=i?.id??`unknown:${e.family}`),n&&(n.value=String(e.variant))})}}render(){if(!this.content||!this.catalogue)return d;const e=(this.content.kind==="h617a_single"||this.content.kind==="palette_diy")&&this.effectFamily(this.content)?.rate==="sensitivity"?"Sensitivity":"Speed";return o`
    ...
    `}renderSingleVariation(){if(!this.content||this.content.kind!=="h617a_single"&&this.content.kind!=="palette_diy")return d;const e=this.content,i=this.effectFamily(e)?.variations??[],s=i.some(n=>n.variant===e.variant);return s&&i.length<=1?d:o`
  ...
  `]}}Ft([h({attribute:!1})],rt.prototype,"content");Ft([h({attribute:!1})],rt.prototype,"catalogue");Ft([h({type:Boolean})],rt.prototype,"disabled");customElements.get("govee-custom-effect-editor")||customElements.define("govee-custom-effect-editor",rt);const fe={ATTRIBUTE:1,PROPERTY:3,BOOLEAN_ATTRIBUTE:4},Ar=r=>(...e)=>({_$litDirective$:r,values:e});class Ir{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,i){this._$Ct=e,this._$AM=t,this._$Ci=i}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}}const Pr=r=>r.strings===void 0,Tr={},Dr=(r,e=Tr)=>r._$AH=e;const gi=Ar(class extends Ir{constructor(r){if(super(r),r.type!==fe.PROPERTY&&r.type!==fe.ATTRIBUTE&&r.type!==fe.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Pr(r))throw Error("`live` bindings can only contain a single expression")}render(r){return r}update(r,[e]){if(e===F||e===d)return e;const t=r.element,i=r.name;if(r.type===fe.PROPERTY){if(e===t[i])return F}else if(r.type===fe.BOOLEAN_ATTRIBUTE){if(!!e===t.hasAttribute(i))return F}else if(r.type===fe.ATTRIBUTE&&t.getAttribute(i)===e+"")return F;return Dr(r),e}});var Lr=Object.defineProperty,nt=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Lr(e,t,s),s};const Mr=new Set(["rhythm","bloom","shiny"]),Nr=new Set(["point","gradient","relative_brightness","key_count","direction","segment_count","speed"]),ts=[{id:"clockwise",label:"Clockwise"},{id:"two_way",label:"Two-way"},{id:"counterclockwise",label:"Counterclockwise"}];class Fe extends I{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0,this.modeChanged=e=>{const t=e.target.value;this.updateContent(i=>(i.mode=t,i.parameters=Br(i.parameters),i.calm=ft(t)?i.calm??!1:null,i))}}willUpdate(e){e.has("content")&&this.content?.colour!=null&&(this.lastFixedColour=ae(this.content.colour))}render(){if(!this.content)return d;const e=Rr(this.content.mode,this.catalogue),t=this.catalogue?.limits.music_sensitivity_min??0,i=this.catalogue?.limits.music_sensitivity_max??100,s=is(this.content.sensitivity,t,i),n=this.content.colour===null?"automatic":"fixed",a=this.content.colour??this.lastFixedColour??kt(0);return o`
      <section class="card">
        <div class="parameter-stack">
    ...
    `}renderHoppingParameters(e){const t=Ce(e,"relative_brightness",50,0,100);return o`
      ${this.renderRangeField("Relative brightness",t,0,100,i=>this.updateParameter("relative_brightness",i))}
    `}renderPianoKeysParameters(e){const t=Ce(e,"key_count",15,1,15);return o`
      ${this.renderRangeField("Key count",t,1,15,i=>this.updateParameter("key_count",i))}
    `}renderFountainParameters(e){const t=Or(e,"direction","clockwise");return o`
      <label class="field">
    ...
    `}renderDayAndNightParameters(e){const t=Ce(e,"segment_count",1,1,15),i=Ce(e,"speed",10,0,100),s=bi(e,"gradient",!1);return o`
      ${this.renderRangeField("Segment count",t,1,15,n=>this.updateParameter("segment_count",n),!0)}
      ${this.renderRangeField("Speed",i,0,100,n=>this.updateParameter("speed",n))}
    ...
    `}colourModeChanged(e){this.updateContent(t=>{if(!e)return this.lastFixedColour=t.colour===null?this.lastFixedColour:ae(t.colour),t.colour=null,t;const i=t.colour??this.lastFixedColour??kt(0);return this.lastFixedColour=ae(i),t.colour=ae(i),t})}fixedColourChanged(e){this.lastFixedColour=ae(e),this.updateContent(t=>(t.colour=ae(e),t))}styleChanged(e){this.updateContent(t=>(ft(t.mode)&&(t.calm=e),t))}updateParameter(e,t){this.updateContent(i=>{const s=Ut(i.parameters);return s[e]=t,i.parameters=s,i})}updateContent(e){if(!this.content)return;const t=gt(e(gt(this.content)));this.content=t,this.dispatchEvent(new CustomEvent("content-changed",{detail:{content:gt(t)},bubbles:!0,composed:!0}))}static{this.styles=[M,de,ee,k`
      :host {
        display: block;
      }

    `]}}nt([h({attribute:!1})],Fe.prototype,"content");nt([h({attribute:!1})],Fe.prototype,"catalogue");nt([h({type:Boolean})],Fe.prototype,"disabled");nt([h({type:Boolean})],Fe.prototype,"showModeSelector");function Rr(r,e){const t=e?.music_modes.map(i=>({...i}))??[];return t.some(i=>i.id===r)?t:[{id:r,label:`Unknown mode ${r}`},...t]}function Br(r){const e=Ut(r);for(const t of Nr)delete e[t];return e}function ft(r){return Mr.has(r)}function Ce(r,e,t,i,s){const n=r[e];return typeof n!="number"||!Number.isFinite(n)?t:is(n,i,s)}function bi(r,e,t){return typeof r[e]=="boolean"?r[e]:t}function Or(r,e,t){const i=r[e];return ts.some(s=>s.id===i)?i:t}function is(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}function gt(r){return{...r,colour:Fr(r.colour),parameters:Ut(r.parameters)}}function Ut(r){return structuredClone(r)}function Fr(r){return r===null?null:ae(r)}function ae(r){return[...r]}customElements.get("govee-music-profile-editor")||customElements.define("govee-music-profile-editor",Fe);var Ur=Object.defineProperty,ss=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Ur(e,t,s),s};class Ht extends I{constructor(){super(...arguments),this.colours=[],this.disabled=!1}render(){return o`
  ...
  `]}}ss([h({attribute:!1})],Ht.prototype,"colours");ss([h({type:Boolean})],Ht.prototype,"disabled");customElements.get("govee-painted-segment-editor")||customElements.define("govee-painted-segment-editor",Ht);var Hr=Object.defineProperty,S=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Hr(e,t,s),s};class C extends I{constructor(){super(...arguments),this.library={library_revision:0,items:[]},this.isAdmin=!1,this.category="all",this.search="",this.name="",this.speedIndex=null,this.loading=!1,this.saving=!1,this.applying=!1,this.editingCopy=!1,this.requestGeneration=0}willUpdate(e){(e.has("device")||e.has("api"))&&(this.invalidateRequests(),this.catalogue=void 0,this.category="all",this.search="",this.selectedScene=void 0,this.selectedItem=void 0,this.content=void 0,this.editingCopy=!1,this.notice=void 0,this.error=void 0,this.loading=!!(this.api&&this.device))}updated(e){(e.has("device")||e.has("api"))&&this.api&&this.device&&this.loadCatalogue()}render(){return this.device?this.loading?o`<div class="status" role="status">Loading scenes...</div>`:this.error||!this.catalogue?o`
        ...
        <div class="parameter-list">
          ${e?o`
                <govee-segmented-control
                  .label=${"Speed"}
                  .value=${t}
                  .options=${qr(e.option_count,e.default_index)}
                  .disabled=${!this.isAdmin}
    ...
    `}async loadCatalogue(){if(!this.api||!this.device)return;const e=this.beginRequest();this.loading=!0,this.error=void 0,this.notice=void 0,this.selectedScene=void 0,this.selectedItem=void 0,this.content=void 0;try{const t=await e.api.sceneCatalogue(e.deviceId);if(!this.requestIsCurrent(e))return;this.catalogue=t,this.category="all"}catch(t){this.requestIsCurrent(e)&&(this.error=L(t))}finally{this.requestIsCurrent(e)&&(this.loading=!1)}}selectCategory(e){this.invalidateRequests(),this.category=e,this.selectedScene=void 0,this.selectedItem=void 0,this.content=void 0,this.editingCopy=!1,this.notice=void 0}async selectBuiltin(e){if(!this.api||!this.device)return;const t=ge(e),i=this.beginRequest(t);this.notice=void 0,this.selectedScene=e,this.selectedItem=void 0,this.editingCopy=!1,this.content=void 0,this.name=e.display_name,this.speedIndex=e.speed?.default_index??null;try{const s=await i.api.sceneDetail(i.deviceId,e.scene_id,e.effect_id);if(!this.requestIsCurrent(i)||ge(s.scene)!==t)return;this.selectedScene=s.scene,this.content=s.content,this.name=s.scene.display_name,this.speedIndex=s.content.speed_index}catch(s){this.requestIsCurrent(i)&&(this.notice=L(s))}}async selectCustom(e){if(!this.api||!this.device||!this.catalogue)return;const t=this.catalogue,i=this.beginRequest(`custom:${e.id}`);this.notice=void 0,this.selectedScene=void 0,this.selectedItem=void 0,this.editingCopy=!1,this.content=void 0,this.name=e.name;try{const s=await i.api.item(e.id);if(!this.requestIsCurrent(i))return;if(s.content.kind!=="scene_builtin"&&s.content.kind!=="scene_palette")throw new Error("This custom scene uses an unsupported definition.");const n=s.content;if(n.template.sku!==t.sku)throw new Error(`This custom scene targets ${n.template.sku}, not ${t.sku}.`);const a=t.scenes.find(c=>c.scene_id===n.template.scene_id&&c.effect_id===n.template.effect_id);if(!a)throw new Error("The source scene is not in this device catalogue.");const l=await i.api.sceneDetail(i.deviceId,n.template.scene_id,n.template.effect_id);if(!this.requestIsCurrent(i)||ge(l.scene)!==ge(a))return;this.selectedScene=a,this.selectedItem=s,this.editingCopy=!1,this.content=n,this.name=s.name,this.speedIndex=n.speed_index??a.speed?.default_index??null}catch(s){this.requestIsCurrent(i)&&(this.notice=L(s))}}async save(){if(!this.api||!this.device||!this.catalogue||!this.selectedScene||!this.content||!this.hasCurrentSceneContent()||this.content.kind!=="scene_builtin"&&this.content.kind!=="scene_palette"||!this.isAdmin||this.saving)return;const e=(this.selectedItem?this.name.trim():this.name.trim()).trim();if(!e){this.notice="Give this custom scene a name before saving.";return}const t=this.content.kind==="scene_palette"?Kr({...this.content,speed_index:this.speedIndex}):{...this.content,speed_index:this.speedIndex},i=this.captureRequest();this.saving=!0,this.notice=void 0;try{const s=this.selectedItem?await this.api.updateItem(this.selectedItem,e,t,this.library.library_revision):await this.api.createItem(e,t,this.library.library_revision);if(s.item.content.kind!=="scene_builtin"&&s.item.content.kind!=="scene_palette")throw new Error("The saved scene returned an unsupported definition.");if(this.dispatchEvent(new CustomEvent("library-item-saved",{detail:{item:s.item,library_revision:s.library_revision},bubbles:!0,composed:!0})),!this.requestIsCurrent(i))return;this.requestGeneration+=1,this.activeSelectionIdentity=`custom:${s.item.id}`,this.selectedItem=s.item,this.editingCopy=!1,this.content=s.item.content,this.name=s.item.name,this.category="custom",this.notice="Custom scene saved."}catch(s){this.requestIsCurrent(i)&&(this.notice=vt(s)==="conflict"?"The library changed elsewhere. Reload the scene before saving.":`Save failed: ${L(s)}`)}finally{this.saving=!1}}edit(){if(!(!this.isAdmin||!this.selectedScene||!this.hasCurrentSceneContent())){if(this.selectedScene.scene_type===2&&this.content?.kind==="scene_layered"){this.dispatchSceneEdit();return}this.editingCopy=!0,this.name=`${this.selectedScene.display_name} copy`,this.notice=void 0}}dispatchSceneEdit(){!this.selectedScene||this.content?.kind!=="scene_layered"||this.dispatchEvent(new CustomEvent("scene-edit-selected",{detail:{content:st({...this.content,speed_index:this.speedIndex}),config_entry_id:this.device.config_entry_id,name:`${this.selectedScene.display_name} copy`},bubbles:!0,composed:!0}))}async apply(){if(!this.api||!this.device||!this.selectedScene||!this.hasCurrentSceneContent()||!this.isAdmin||!this.catalogue?.enabled||this.selectedItem!==void 0&&this.content?.kind!=="scene_builtin"||this.applying)return;const e=this.captureRequest(),t=this.device,i=this.selectedScene,s=this.speedIndex;this.applying=!0,this.notice=void 0;try{await e.api.applyScene(e.deviceId,i,s),this.requestIsCurrent(e)&&(this.notice=`Applied to ${t.display_name}. Scene identity can be read back; the selected speed remains optimistic.`)}catch(n){this.requestIsCurrent(e)&&(this.notice=`Apply failed: ${L(n)}`)}finally{this.applying=!1}}beginRequest(e){return this.requestGeneration+=1,this.activeSelectionIdentity=e,this.captureRequest()}captureRequest(){return{generation:this.requestGeneration,api:this.api,deviceId:this.device.config_entry_id,category:this.category,selectionIdentity:this.activeSelectionIdentity}}invalidateRequests(){this.requestGeneration+=1,this.activeSelectionIdentity=void 0}requestIsCurrent(e){return e.generation===this.requestGeneration&&e.api===this.api&&e.deviceId===this.device?.config_entry_id&&e.category===this.category&&e.selectionIdentity===this.activeSelectionIdentity}hasCurrentSceneContent(){return!this.catalogue||!this.selectedScene||!this.content||this.content.template.sku!==this.catalogue.sku||this.content.template.scene_id!==this.selectedScene.scene_id||this.content.template.effect_id!==this.selectedScene.effect_id?!1:this.activeSelectionIdentity===this.selectionKey}static{this.styles=[M,de,Lt,Ti,Di,Mi,ee,Mt,Li,k`
    :host {
      display: contents;
    }
  ...
  `]}}S([h({attribute:!1})],C.prototype,"api");S([h({attribute:!1})],C.prototype,"device");S([h({attribute:!1})],C.prototype,"library");S([h({type:Boolean})],C.prototype,"isAdmin");S([m()],C.prototype,"catalogue");S([m()],C.prototype,"category");S([m()],C.prototype,"search");S([m()],C.prototype,"selectedScene");S([m()],C.prototype,"selectedItem");S([m()],C.prototype,"content");S([m()],C.prototype,"name");S([m()],C.prototype,"speedIndex");S([m()],C.prototype,"loading");S([m()],C.prototype,"saving");S([m()],C.prototype,"applying");S([m()],C.prototype,"editingCopy");S([m()],C.prototype,"notice");S([m()],C.prototype,"error");function ge(r){return`builtin:${r.scene_id}:${r.effect_id}`}function qr(r,e){return Array.from({length:r},(t,i)=>({value:i,label:Vr(i,e)}))}function Vr(r,e){const t=r-e;if(t===0)return"Default";const i=Math.abs(t);return`${i} ${i===1?"step":"steps"} ${t<0?"lower":"higher"}`}function Kr(r){return{...r,template:{...r.template},steps:r.steps.map(e=>({...e,colour:[...e.colour],inline_colour:e.inline_colour===null?null:[...e.inline_colour]})),palette:r.palette.map(e=>[...e])}}customElements.get("govee-scene-browser")||customElements.define("govee-scene-browser",C);var jr=Object.defineProperty,qt=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&jr(e,t,s),s};const Gr=[{value:"movie",label:"Movie"},{value:"game",label:"Game"}],zr=[{value:!0,label:"Full screen"},{value:!1,label:"Part screen"}],Xr=[{key:"left",label:"Left"},{key:"top",label:"Top"},{key:"right",label:"Right"},{key:"bottom",label:"Bottom"}];function W(r,e,t){return Math.min(t,Math.max(e,Math.round(r)))}function Yr(r){return{...r}}function vi(r){return{...r,relative_brightness:Yr(r.relative_brightness)}}function rs(r){const e=[r.left,r.top,r.right,r.bottom];return e.every(t=>t===e[0])?e[0]:void 0}function Wr(r){const e=rs(r);return e!==void 0?e:W((r.left+r.top+r.right+r.bottom)/4,1,100)}function Jr(r){const e=W(r,1,100);return{left:e,top:e,right:e,bottom:e}}class at extends I{constructor(){super(...arguments),this.disabled=!1,this.showModeSelector=!0}render(){if(!this.content)return o`
        <section class="card empty-state" role="status">
      ...
      `;const e=this.content.relative_brightness,t=rs(e)===void 0,i=Wr(e);return o`
      <div class="editor-grid">
        <section class="card">
          <div class="parameter-stack">
            ${this.showModeSelector?this.renderSegmentedField("Mode",this.content.mode,Gr,s=>this.updateContent(n=>{n.mode=s})):d}
            ${this.renderSegmentedField("Capture area",this.content.full_screen,zr,s=>this.updateContent(n=>{n.full_screen=s}))}
        ...
        <section class="card brightness-card">
          ...
          <div class="parameter-stack">
            ${this.renderRangeField("Uniform brightness",i,1,100,`${i}%`,s=>this.updateContent(n=>{n.relative_brightness=Jr(s)}),t?"relative-brightness-note":void 0)}
            ${t?o`
    ...
    `}updateRelativeBrightnessEdge(e,t){this.updateContent(i=>{i.relative_brightness[e]=W(t,1,100)})}updateContent(e){if(!this.content)return;const t=vi(this.content);e(t),this.emitContent(t)}emitContent(e){this.dispatchEvent(new CustomEvent("content-changed",{detail:{content:vi(e)},bubbles:!0,composed:!0}))}static{this.styles=[M,de,ee,k`
      :host {
        display: block;
        color: var(--primary-text-color);
      }
    ...
    `]}}qt([h({attribute:!1})],at.prototype,"content");qt([h({type:Boolean})],at.prototype,"disabled");qt([h({type:Boolean})],at.prototype,"showModeSelector");customElements.get("govee-video-profile-editor")||customElements.define("govee-video-profile-editor",at);var Zr=Object.defineProperty,_=(r,e,t,i)=>{for(var s=void 0,n=r.length-1,a;n>=0;n--)(a=r[n])&&(s=a(e,t,s)||s);return s&&Zr(e,t,s),s};const Et=15;class $ extends I{constructor(){super(...arguments),this.showDevicePicker=!1,this.loading=!0,this.devices=[],this.section="custom",this.customEffectCategory="all",this.customCopyStarted=!1,this.library={library_revision:0,items:[]},this.name="",this.content=ve(),this.paintBrushes=Ne(),this.selectedPaintBrush=0,this.brushUsesBackground=!1,this.saving=!1,this.applying=!1,this.deployments=[],this.editorTransitionEpoch=0,this.loadEpoch=0,this.deploymentRevision=-1}get isAdmin(){return this.hass?.user?.is_admin===!0}get selectedDevice(){return this.devices.find(e=>e.config_entry_id===this.selectedDeviceId)}get selectedModel(){const e=this.selectedDevice?.model??this.devices[0]?.model;return e==="H617A"||e==="H6199"?e:void 0}get modelCatalogue(){const e=this.selectedModel;return e?this.customCatalogue?.models[e]:void 0}get videoAvailable(){return!!this.modelCatalogue?.video_modes.length}get customEffectsAvailable(){const e=this.modelCatalogue;return!!(e&&(e.painted_effects.length||e.effects.length||e.music_modes.length||e.supports.advanced!=="unsupported"))}get dirty(){return z(this.content)?this.savedBaseline!==ne(this.name,this.content):!1}get applyCapability(){if(!Y(this.content)&&this.content.kind!=="palette_diy")return;const e=this.selectedDevice?.custom_effects;if(e)switch(this.content.kind){case"h617a_painted":return e.painted;case"h617a_single":return e.single;case"h617a_multi":return e.multi;case"palette_diy":return e.palette_diy}}get canApply(){return(Y(this.content)||this.content.kind==="palette_diy")&&this.isAdmin&&!this.applying&&!this.deletingCurrentItem&&this.name.trim().length>0&&this.applyCapability==="supported"}get deletingCurrentItem(){return this.deletingItemId!==void 0&&this.currentItem?.id===this.deletingItemId}get activeDeployment(){const e=this.deployments.find(t=>t.operation_id===this.activeOperationId);return e||!this.applying?e:this.latestDeployment(dt)}connectedCallback(){super.connectedCallback(),this.hass&&!this.api&&this.load()}disconnectedCallback(){super.disconnectedCallback(),this.loadEpoch+=1,this.beginEditorTransition(),this.stopSubscriptions(),this.api=void 0}updated(e){e.has("hass")&&this.hass&&!this.api&&this.load(),this.syncSingleEffectSelects()}render(){return this.loading?o`<div class="centred" role="status">Loading effect studio...</div>`:this.error?this.renderFatalError():o`
    ...
    `}renderCurrentCustomEditor(){return Y(this.content)?this.content.kind==="h617a_painted"?this.renderPaintedEditor():this.renderPaletteEffectEditor():this.content.kind==="palette_diy"?this.renderPaletteEffectEditor():this.content.kind==="music_profile"?this.renderMusicProfileEditor():Se(this.content)?this.renderAdvancedEditor():this.content.kind==="opaque"?this.renderOpaqueEditor(this.content):d}renderVideo(){const e=this.modelCatalogue;if(!e||!this.videoAvailable)return d;const t=this.library.items.filter(i=>i.kind==="video_profile"&&this.libraryItemAvailable(i)).sort((i,s)=>Ie(i.name,s.name));return o`
    ...
    `}openVideoTemplate(e,t){this.selectedModel==="H6199"&&this.openEditableTemplate(t,Qr(e),`template:video:${e}`)}renderVideoProfileEditor(){return this.content.kind!=="video_profile"?d:o`
      ${this.renderProfileHeading()}
      <govee-video-profile-editor
        .content=${this.content}
        .disabled=${!this.isAdmin}
        .showModeSelector=${!this.templateSourceLabel}
        @content-changed=${e=>{this.content=ls(e.detail.content)}}
      ></govee-video-profile-editor>
    ...
    `}selectCustomEffectEntry(e){if(e.kind==="saved"){this.selectItem(e.item.id);return}if(e.kind==="advanced"){this.newEffect("advanced",void 0,{name:e.label,content:lt(),selectionIdentity:e.key,templateLabel:e.label}),this.customTemplateSelection=e.key;return}const t=this.modelCatalogue;if(t){if(e.kind==="music"){if(e.mode){this.openMusicTemplate(e.mode,e.label);return}if(e.family===void 0||e.variant===void 0)return;const i=this.selectedModel==="H617A"?{...G("h617a_single",t),family:e.family,variant:e.variant}:Ve(t,this.selectedModel,e.family,e.variant);this.openEditableTemplate(e.label,i,e.key);return}if(e.kind==="paint"){this.newEffect("h617a_painted",void 0,{name:e.label,content:ve(),selectionIdentity:e.key,templateLabel:e.label});return}if(e.kind==="single"){if(this.selectedModel==="H617A"){const i=G("h617a_single",t);this.newEffect("h617a_single",void 0,{name:e.label,content:{...i,family:e.family,variant:e.variant},selectionIdentity:e.key,templateLabel:e.label})}else this.openEditableTemplate(e.label,Ve(t,this.selectedModel,e.family,e.variant),e.key);return}this.newEffect("h617a_multi",void 0,{name:e.label,content:G("h617a_multi",t),selectionIdentity:e.key,templateLabel:e.label})}}openEditableTemplate(e,t,i){this.beginEditorTransition(),this.currentItem=void 0,this.templateSourceLabel=e,this.customCopyStarted=!0,this.customTemplateSelection=i,this.name=e,this.content=Ke(t),this.savedBaseline=void 0,this.notice=void 0}openMusicTemplate(e,t){const i=this.selectedModel;i!=="H617A"&&i!=="H6199"||this.openEditableTemplate(t,{kind:"music_profile",model:i,mode:e,sensitivity:i==="H6199"?100:99,colour:null,calm:["rhythm","bloom","shiny"].includes(e)?!1:null,parameters:{}},`template:music:${e}`)}renderAdvancedEditor(){if(!Se(this.content))return d;const e=this.content.kind==="scene_layered";return o`
      ...
      <govee-advanced-effect-editor
        .content=${sn(this.content)}
        .disabled=${!this.isAdmin}
        .segmentCount=${this.selectedDevice?.segment_count??15}
        @content-changed=${t=>{Se(this.content)&&(this.content=rn(this.content,t.detail.content))}}
      ></govee-advanced-effect-editor>
    ...
    `}sliderField(e,t,i){return o`
      ...
      ></govee-slider-control>
    `}renderNewEffectTypeTabs(){return this.currentItem||this.templateSourceLabel||this.customCopyStarted||!z(this.content)?d:o`
    ...
    `}newEffectTypeAvailable(e){return e==="single"?this.customEffectKindAvailable("h617a_painted")||this.customEffectKindAvailable("h617a_single")||this.customEffectKindAvailable("palette_diy"):this.customEffectKindAvailable(e==="multi"?"h617a_multi":"advanced")}newEffectTypeButton(e,t){const i=$i(this.content)===e,s=e==="single"&&this.content.kind==="h617a_multi"&&this.content.effects.length>1;return o`
      <button
        type="button"
        role="tab"
        aria-selected=${i}
    ...
    `}renderDeployment(e){const t=this.devices.find(s=>s.config_entry_id===e.config_entry_id)?.display_name??"device";let i;switch(e.phase){case"compiling":case"pending":i=`Preparing to apply to ${t}.`;break;case"uploading":i=`Applying to ${t}: ${e.progress_current} of ${e.progress_total}.`;break;case"activating":i=`Activating the selected effect on ${t}.`;break;case"verifying":i=`Checking the selected effect on ${t}.`;break;case"confirmed":i=`Applied to ${t}. The selected custom-effect code was confirmed, but exact effect contents cannot be read back.`;break;case"uncertain":i=e.error_code==="effect_content_readback_unproven"?`${t} reported the selected H6199 user-effect slot, but the uploaded effect content cannot be read back. The result remains uncertain.`:e.error_code==="activation_readback_unproven"?`The H6199 effect upload was sent to ${t}, but activation and readback remain unproven. The result is uncertain.`:`The final state of ${t} is uncertain. The selected effect could not be confirmed.`;break;case"recovering":i=`Restoring the previous state on ${t} after the apply failed.`;break;case"unknown":i=`Applied to ${t}, but the selected effect could not be confirmed.`;break;case"interrupted":i=`Apply to ${t} was interrupted by a Home Assistant restart.`;break;case"failed":i=`Apply to ${t} failed.`;break}return o`
      <div
  ...
  `]}}_([h({attribute:!1})],$.prototype,"hass");_([h({attribute:!1})],$.prototype,"panel");_([h({type:Boolean})],$.prototype,"showDevicePicker");_([m()],$.prototype,"loading");_([m()],$.prototype,"error");_([m()],$.prototype,"notice");_([m()],$.prototype,"devices");_([m()],$.prototype,"selectedDeviceId");_([m()],$.prototype,"section");_([m()],$.prototype,"customEffectCategory");_([m()],$.prototype,"customTemplateSelection");_([m()],$.prototype,"templateSourceLabel");_([m()],$.prototype,"customCopyStarted");_([m()],$.prototype,"library");_([m()],$.prototype,"customCatalogue");_([m()],$.prototype,"currentItem");_([m()],$.prototype,"name");_([m()],$.prototype,"content");_([m()],$.prototype,"paintBrushes");_([m()],$.prototype,"selectedPaintBrush");_([m()],$.prototype,"brushUsesBackground");_([m()],$.prototype,"saving");_([m()],$.prototype,"applying");_([m()],$.prototype,"deleteCandidate");_([m()],$.prototype,"deletingItemId");_([m()],$.prototype,"deployments");_([m()],$.prototype,"activeOperationId");function ve(){return{kind:"h617a_painted",effect:"clockwise",speed:50,brightness:100,background:[0,0,0],groups:[]}}function G(r,e){if(r==="h617a_painted")return ve();const t=r==="h617a_multi"?e.effects.find(n=>n.supports_multi):e.effects[0];if(!t)throw new Error("The custom-effect catalogue has no compatible effects.");const i=t.variations[0],s={family:t.family,variant:i.variant};return r==="h617a_single"?{kind:r,...s,speed:50,palette:Ne()}:{kind:r,effects:[s],speed:50,palette:Ne()}}function Ve(r,e,t,i){if(e!=="H617A"&&e!=="H6199")throw new Error(`Unsupported custom-effect model ${e}.`);const s=r.effects.find(n=>n.family===t)??r.effects[0];if(!s)throw new Error("The custom-effect catalogue has no compatible effects.");return{kind:"palette_diy",model:e,family:t??s.family,variant:i??s.variations[0].variant,speed:50,palette:Ne()}}function Qr(r){return{kind:"video_profile",model:"H6199",mode:r==="game"?"game":"movie",full_screen:!0,saturation:50,sound_effects:!1,sound_effects_softness:50,white_balance_position:17,relative_brightness:{left:100,top:100,right:100,bottom:100},blank_screen:!1}}function en(r){return{...r,background:[...r.background],groups:r.groups.map(e=>({fill:[...e.fill],segments:[...e.segments]}))}}function ns(r){return r.kind==="h617a_painted"?en(r):r.kind==="h617a_single"?{...r,palette:r.palette.map(e=>[...e])}:{...r,effects:r.effects.map(e=>({...e})),palette:r.palette.map(e=>[...e])}}function as(r){return{...r,palette:r.palette.map(e=>[...e])}}function os(r){return{...r,colour:r.colour?[...r.colour]:null,parameters:structuredClone(r.parameters)}}function ls(r){return{...r,relative_brightness:{...r.relative_brightness}}}function Ke(r){return r.kind==="advanced"?Je(r):r.kind==="scene_layered"?st(r):r.kind==="palette_diy"?as(r):r.kind==="music_profile"?os(r):r.kind==="video_profile"?ls(r):ns(r)}function tn(r){return{...r,body:structuredClone(r.body)}}function sn(r){return r.kind==="advanced"?r:{kind:"advanced",layers:r.effect.layers}}function rn(r,e){return r.kind==="advanced"?Je(e):{...st(r),effect:{layers:Je(e).layers}}}function Ne(){return[[255,0,0],[255,127,0],[255,255,0],[0,255,0],[0,0,255],[0,255,255],[139,0,255]]}function nn(r){const e=[];for(const t of[...r,...Ne()])if(e.some(i=>Qe(i,t))||e.push([...t]),e.length===8)break;return e}function Ct(r){const e=Array.from({length:Et},()=>[...r.background]);for(const t of r.groups)for(const i of t.segments)e[i]=[...t.fill];return e}function yi(r,e){const t=new Map;return r.forEach((i,s)=>{if(Qe(i,e))return;const n=i.join(","),a=t.get(n);a?a.segments.push(s):t.set(n,{fill:[...i],segments:[s]})}),[...t.values()]}function an(r){const e=[];for(const t of Ct(r))if(!Qe(t,r.background)&&!e.some(i=>Qe(i,t))&&e.push([...t]),e.length===8)break;return e}function Qe(r,e){return r[0]===e[0]&&r[1]===e[1]&&r[2]===e[2]}function ne(r,e){return JSON.stringify({name:r.trim(),content:e})}function Vt(r){return r==="h617a_painted"||r==="h617a_single"||r==="h617a_multi"}function Y(r){return typeof r=="object"&&r!==null&&"kind"in r&&Vt(r.kind)}function z(r){return Y(r)||typeof r=="object"&&r!==null&&"kind"in r&&(Ue(r.kind)||r.kind==="palette_diy"||r.kind==="music_profile"||r.kind==="video_profile")}function $i(r){return r.kind==="h617a_multi"?"multi":Ue(r.kind)?"advanced":r.kind==="h617a_painted"||r.kind==="h617a_single"||r.kind==="palette_diy"?"single":void 0}function Ue(r){return r==="advanced"||r==="scene_layered"}function Se(r){return Ue(r.kind)}function on(r){return Vt(r)||Ue(r)||r==="palette_diy"||r==="music_profile"||r==="video_profile"||r==="scene_builtin"||r==="scene_palette"}function _i(r){switch(r){case"h617a_painted":return"Paint";case"h617a_single":return"Single";case"h617a_multi":return"Multi";case"advanced":return"Layered";case"palette_diy":return"Single";default:return"Custom"}}function bt(r){return Vt(r)||Ue(r)||r==="palette_diy"||r==="music_profile"||!on(r)}function xi(r,e){const t=e==="H6199"?["palette_diy","music_profile","advanced","scene_layered"]:["h617a_painted","h617a_single","h617a_multi","music_profile","advanced","scene_layered"],i=t.indexOf(r);return i===-1?t.length:i}function ln(r){return r==="h617a_multi"?"multi-layer":r==="music_profile"?"music":r==="h617a_painted"||r==="h617a_single"||r==="palette_diy"?"single-layer":"advanced"}function wi(r,e){return r?.id===e?.id&&r?.revision===e?.revision}function ki(r,e){const t=dn(e);return[...r.filter(i=>i.id!==e.id),{id:e.id,revision:e.revision,name:e.name,kind:e.content.kind==="opaque"?e.content.source_kind:e.content.kind,...t?{model:t}:{},..."template"in e.content?{template:e.content.template}:{}}].sort((i,s)=>i.name.localeCompare(s.name))}function dn(r){const e=r.content;return e.kind==="palette_diy"||e.kind==="music_profile"||e.kind==="video_profile"?e.model:e.kind==="h617a_painted"||e.kind==="h617a_single"||e.kind==="h617a_multi"?"H617A":e.kind==="scene_builtin"||e.kind==="scene_palette"||e.kind==="scene_layered"?Ei(e.template.sku):Ei(r.target_hint?.model)}function Ei(r){return r==="H617A"||r==="H6199"?r:void 0}customElements.get("ha-govee-led-ble-editor")||customElements.define("ha-govee-led-ble-editor",$);
