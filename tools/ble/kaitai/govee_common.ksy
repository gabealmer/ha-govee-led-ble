...
types:
  ...
  a3_header:
    doc: |
      ...
      invites the wrong conclusion that the grammar is broken. Diagnosed 2026-07-26
      ...
      to VERIFY the result. This was implemented as a slice on 2026-07-26 and reverted
      the same day.
    ...
    seq:
      ...
      - id: linecount
        ...
        valid:
          min: 2
        doc: '[CONFIRMED_LIVE] 17-byte A3 chunk count as the sender wrote it, counting the appended empty frame in the terminator form. Equals reassembled_body_len // 17 exactly, in all 46 A3 transactions in the capture corpus, when every frame of ONE transaction is concatenated in arrival order (measured 2026-07-26). Use it to verify a reassembly, never to slice one; see this type''s reassembly rule. Never observed below 0x02: the app never emits a lone frame.'
  sleep_timer:
    doc: |
      ...
      ALL FOUR FIELDS ISOLATED LIVE [drive2-timer 2026-07-27]. The app surface is
    ...
    seq:
      - id: enabled
        type: u1
        doc: '[CONFIRMED_LIVE] 0x00 off / 0x01 on; toggled 01<->00 live 2026-07-23 (res-timer-sleep-on/off) and again in drive2-timer 2026-07-27'
      - id: start_brightness
        type: u1
        doc: '[CONFIRMED_LIVE] the app''s "Initial brightness" slider on More > Timer > Sleeping, 0..100, the level the fade starts from. Isolated over two transitions in drive2-timer 2026-07-27: 50 -> 0x0b=11 -> 0x32=50, each matching the slider. It tracks THAT CONTROL, not device brightness: device brightness was 5% throughout while this byte read 11. Supersedes the earlier note that the value was "not app-shown, not varied"; it is both shown and now varied.'
      - id: close_minutes
        type: u1
        doc: '[CONFIRMED_LIVE] total fade-to-off duration in minutes, the app''s "Set countdown"; 0x10=16 matches "Turn off in 16 minutes" (res-timer-sleep-on). Held at 0x10 across the whole of drive2-timer while current_minutes moved independently, which is what separates the two.'
      - id: current_minutes
        type: u1
        doc: '[CONFIRMED_LIVE] countdown minutes REMAINING, a live register rather than a copy of close_minutes. Isolated in drive2-timer 2026-07-27: armed at 0x10=16, read 0x0c=12 about 4.5 minutes later with close_minutes still 0x10, and the app independently showed "Turn off in 12 minutes" above a description still reading "within 16 minutes". Resets to close_minutes when the timer is disarmed (33 11 00 0b 10 10).'
      - id: padding
        type: u1
        valid: 0
        repeat: eos
  ...
  wake_timer:
    doc: |
      ...
      THE ACK DOES NOT MIRROR THE WRITE. [CONFIRMED_LIVE 2026-07-28] A crafted 33 12
    ...
    seq:
      ...
      - id: repeat
        type: u1
        doc: |
          [CONFIRMED_LIVE] Weekday repeat byte. Its OFFSET is pinned by its neighbours,
          ...
          [CONFIRMED_LIVE 2026-07-28] Settled by the FIRST 33 12 write in the corpus:
          ...
          [CONFIRMED_LIVE 2026-07-30] Measured by driving the vendor app's own Repeat
          ...
          2026-07-28 crafted write actually established.
  ...
  timer_slot:
    doc: |
      ...
      THE WHOLE RECORD IS DEVICE-STORED. [CONFIRMED_LIVE 2026-07-27] Three
    ...
    seq:
      - id: enable_and_type
        type: u1
        doc: |
          [CONFIRMED_LIVE] bit 0x80 = slot enabled, bit 0x01 = on-action. Live enabling
          slot 0 read/wrote 0x81 (enabled|on) vs 0x01 disabled (2026-07-22 and
          res-timer-sched-on/off 2026-07-23).

          The two bits were separated on 2026-07-27 (capture h617a-timer-2026-07-27) by
      ...
      - id: repeat
        type: u1
        doc: |
          [CONFIRMED_LIVE] Weekday repeat bits, Mon=bit0 .. Sun=bit6. Selecting Mon, Wed
          and Fri in the app wrote 0x95, whose low seven bits are exactly bits 0, 2 and 4,
          which pins the weekday order on this command (capture h617a-timer-2026-07-27,
          re-observed as 33 23 02 81 00 00 95 in h617a-timer-readback-2026-07-27).
          ...
          (files/timer-storage.log, 2026-07-27).
  diy_selector:
    doc: |
      ...
      2026-07-26] Activating each of the seven saved "My DIY" entries showed the app
      ...
      Color > Vibrant tab always writes 0x84, each re-confirmed live 2026-07-26 across
      several different bodies in one session. Share Space is a THIRD such surface:
      0xfe carried four distinct shared bodies across two sessions (two on 2026-07-27
    ...
    seq:
      ...
      - id: type_byte
        ...
        doc: |
          ...
          THE SURVIVING READINGS. Reading (b) below was FALSIFIED on 2026-07-27 (capture
          ...
          surface. Random Color was tested for exactly that on 2026-07-27 and does not
          ...
          CRAFTED-FRAME RESULT [CONFIRMED_LIVE 2026-07-27c]. That test was run. Slot 0xf0
  ...
  brightness_block:
    doc: |
      ...
      WHAT THE CATALOGUE'S brightPage SELECTS. [CONFIRMED 2026-07-26] brightPage is the
      ...
      THE REPEAT CARRIES INDEPENDENT PER-BLOCK DATA [2026-07-31]. A repeated block is not
    ...
    seq:
      ...
      - id: brightness_order
        ...
        doc: |
          [CONFIRMED_LIVE] r9, the editor's "Brightness Order" selector, position-indexed
          into its four-option list. Isolated 2026-07-26 in the Effects Lab editor: with
          ...
          LABEL COLLISION, DO NOT BE CAUGHT BY IT. [CONFIRMED_LIVE 2026-07-27] The editor
      ...
      - id: brightness_speed
        ...
        type: u1
        doc: |
          [CONFIRMED_LIVE] r10 Brightness Changing Speed (7f/80 ~= 50%, ff = 100%).
          ...
          position. Confirmed live 2026-07-26: Forest 2163 walked this byte
    ...
    seq:
      ...
      - id: speed
        ...
        doc: >
          ...
          2026-07-26 on Christmas 2189, Bloom 2228, Glacier 2175, Fire 2171,
  ...
  effect_layer:
    doc: |
      ...
      A THIRD, INDEPENDENT CONTROL SURFACE. [CONFIRMED_LIVE 2026-07-26] The Effects Lab
      ...
      THE CONTROL INVENTORY IS CLOSED. [CONFIRMED_LIVE 2026-07-27, capture
    ...
    seq:
      ...
      - id: select_type
        ...
        doc: >
          ...
          retired on 2026-07-28, so the fourth value now rests on the local parse above,
      ...
      - id: layer_flags
        ...
        type: u1
        doc: |
          [CONFIRMED_LIVE] r5, a bitfield. Two bits are attributed, each by its own
          ...
          Isolated 2026-07-27 (capture drive3-layer-editor) on the custom scene
          ...
          layer bucket. That archive was retired on 2026-07-28, so the proportion is
          ...
          Isolated 2026-07-25: the SAME crafted layer (1 layer, Select IC Continuously,
          ...
          by definition saved.
          THE EDITOR SURFACE ALONE DOES NOT SET IT [2026-07-28]. Applying an
          ...
          SAVING DOES NOT CLEAR IT [CONFIRMED_LIVE 2026-07-31, capture
      ...
      - id: brightness_block_count
        ...
        type: u1
        doc: >
          [CONFIRMED_LIVE] r6 = number of 6-byte brightness blocks that follow, and the
          ...
          repeat count. A 27-SKU third-party archive retired on 2026-07-28 also showed
      ...
      - id: brightness_blocks
        ...
        doc: '[CONFIRMED_LIVE] brightness_block_count blocks of r7..r12.'
      ...
      - id: colour_speed
        ...
        type: u1
        doc: >
          [CONFIRMED_LIVE] r14, Colour Changing Speed of the pair r14:r15 (8014 default;
          ...
          config block whose page names this record; re-confirmed 2026-07-26 with byte
      ...
      - id: colour_retention
        -orig-id: r15
        type: u1
        doc: '[CONFIRMED_LIVE] r15, Colour Retention of the pair r14:r15 (14 default; 6d seen). Raw units, not scaled: the Effects Lab editor showed "Retention Time 20" against this byte reading 0x14.'
      - id: colour_count
        -orig-id: r16
        type: u1
        doc: '[CONFIRMED_LIVE] r16 = M, number of RGB triplets in the palette. The record-length identity holds byte-exact for M = 1..6 across the whole H617A scene catalogue and every captured workshop layer. A 27-SKU third-party archive retired on 2026-07-28 once extended the tested range to 1..7, 9, 11, 12 and 16 with zero residue; that breadth is observed history, and the tag rests on the local catalogue and captures, which are still here.'
      - id: palette
        -orig-id: r17
        type: rgb
        repeat: expr
        repeat-expr: colour_count
        doc: '[CONFIRMED_LIVE] r17..: M ordered RGB triplets. Independently corroborated by decoding captured scene bodies, whose palettes are the colours the effect visibly shows (Aurora 00ff7f/007fff/2aff00, Forest greens plus white).'
      - id: selected_area_movement
        type: movement
        doc: >
          [CONFIRMED_LIVE] selected-area movement <packed> <interval> <speed>. Its speed
          byte is the value the scene catalogue calls moveIn, 5 bytes from the record end.
      - id: overall_movement
        type: movement
        doc: >
          [CONFIRMED_LIVE] overall movement <packed> <interval> <speed>. Same enable bit
      ...
      - id: priority
        type: u1
        doc: >
          [CONFIRMED_LIVE] last record byte: the editor's "Effect Layer Priority" toggle,
          00 off / 01..05 levels. Captures show 00/01/02/03. A 27-SKU third-party archive
          retired on 2026-07-28 showed the full 00..05 range in shipped content plus 0xff
          ...
          confirmed one.
          ISOLATED BYTE-EXACT 2026-07-31 (capture session-cupboard-20260731-144121). Two
      ...
      - id: excess
        size-eos: true
        doc: |
          [CONFIRMED_LIVE] Not a wire field: a structural assertion that the record ENDS
          ...
          third-party archive retired on 2026-07-28 once exercised this far wider,
    ...
    instances:
      ...
      brightness_is_gradient:
        ...
        doc: '[CONFIRMED_LIVE] r5 bit 0x02: the Brightness section is in Gradient mode rather than Unified.'
      applied_from_changed_editor:
        value: '(layer_flags & 0x10) != 0'
        doc: '[CONFIRMED_LIVE] r5 bit 0x10: this Apply came from an editor session in which something was CHANGED. Named applied_as_draft until 2026-07-31 and documented as "applied from the editor without being saved", which the same capture that renamed it falsified: a 5-layer item was SAVED and then applied from the editor, reading 0x12 on all five records, while the identical saved item applied from the list read 0x02. Saving does not clear the bit; leaving the editor is what clears it. See the layer_flags doc above for the full differential.'
enums:
  brightness_order:
    0: brightest_darkest
