...
doc: |
  ...
  APP SURFACES. [CONFIRMED_LIVE 2026-07-27] Three surfaces produce this body:
    ...
    * Share Space (the "Apply DIY effects shared by other users" gallery) REPLAYS
      this body. Both shared effects sampled 2026-07-27 uploaded TYPE 0x03 and
  ...
  VIBRANT'S BODY SHAPE. [CONFIRMED_LIVE 2026-07-26] Editing the Vibrant colour set
  ...
  SHARED BODIES USE THE FULL GRAMMAR. [CONFIRMED_LIVE 2026-07-27] Foreign bodies
  ...
  A two-chunk Finger Sketch capture on 2026-07-31 settled the framing and the explicit
  argument went away. Both were re-verified byte-exact against fresh captures on
  2026-07-26, build_vibrant including its gamma-2.2 gradient interpolation; captures
...
seq:
  - id: header
    ...
    doc: >
      ...
      [CONFIRMED_LIVE] linecount 0x02 in every captured Sketch body, 0x05 in the
...
enums:
  effect:
    ...
    # (2026-07-16) and protocol.py _SKETCH_MOTION_CODES (custom_effects.py).
    0x02: cycle
    0x09: clockwise
