...
export function isCustomEffectKind(
  kind: unknown,
...
export function isAdvancedEditableKind(
  kind: unknown,
...
export function sameLibraryItemRevision(
...
export function libraryItemModel(item: LibraryItem): ModelSku | undefined {
