...
def test_whole_strip_colour_temperature_and_brightness() -> None:
    ...
    assert color_temp_rgb(2700, "H6125") == (255, 174, 84)
    assert color_temp_rgb(6500, "H6125") == (255, 249, 253)
...
def test_static_write_semantics_round_trip(model: str) -> None:
    ...
    assert temperature.kelvin_companion_rgb == color_temp_rgb(3600, model)
